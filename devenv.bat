...
SET DD_PROFILER_PROCESSES=w3wp.exe;iisexpress.exe;dotnet.exe;Samples.AspNetCoreMvc2.exe;dotnet.exe;Samples.ConsoleFramework.exe;Samples.ConsoleCore.exe;Samples.SqlServer.exe;Samples.RedisCore.exe;Samples.Elasticsearch.exe
