...
SET DD_PROFILER_PROCESSES=ExpenseItDemo.exe;w3wp.exe;iisexpress.exe;Samples.AspNetCoreMvc2.exe;dotnet.exe;Samples.SqlServer.exe;Samples.RedisCore.exe;Samples.Elasticsearch.exe;Samples.MongoDB.exe;wcfsvchost.exe
