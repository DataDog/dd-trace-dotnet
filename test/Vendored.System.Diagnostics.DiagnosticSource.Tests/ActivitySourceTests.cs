...
namespace Vendored.System.Diagnostics.Tests
{
    using ActivityCreationOptionsString = ActivityCreationOptions<string>;
    using ActivityCreationOptionsContext = ActivityCreationOptions<ActivityContext>;
    ...
    public class ActivitySourceTests : IDisposable
    {
        ...
        public void TestActivityWithListenerNoActivityCreate()
        {
            RemoteExecutor.Invoke(() => {
                ...
                listener.SampleUsingParentId = (ref ActivityCreationOptionsString activityOptions) => ActivitySamplingResult.None;
                listener.Sample = (ref ActivityCreationOptionsContext activityOptions) => ActivitySamplingResult.None;
        ...
        public void TestActivityWithListenerActivityCreateAndAllDataRequested()
        {
            RemoteExecutor.Invoke(() => {
                using (ActivitySource aSource = new ActivitySource("SourceActivityListener"))
                {
                    ...
                    listener.ShouldListenTo = (activitySource) => object.ReferenceEquals(aSource, activitySource);
                    listener.SampleUsingParentId = (ref ActivityCreationOptionsString activityOptions) => ActivitySamplingResult.AllDataAndRecorded;
                    listener.Sample = (ref ActivityCreationOptionsContext activityOptions) => ActivitySamplingResult.AllDataAndRecorded;
        ...
        public void TestActivitySourceAttachedObject()
        {
            RemoteExecutor.Invoke(() => {
                ...
                listener.ActivityStopped = activity => Assert.NotNull(activity);
                listener.ShouldListenTo = (activitySource) => object.ReferenceEquals(aSource, activitySource);
                listener.SampleUsingParentId = (ref ActivityCreationOptionsString activityOptions) => ActivitySamplingResult.AllData;
                listener.Sample = (ref ActivityCreationOptionsContext activityOptions) => ActivitySamplingResult.AllData;
        ...
        public void TestExpectedListenersReturnValues()
        {
            RemoteExecutor.Invoke(() => {
                ...
                listeners[0] = new ActivityListener
                {
                    ...
                    SampleUsingParentId = (ref ActivityCreationOptionsString activityOptions) => ActivitySamplingResult.None,
                    Sample = (ref ActivityCreationOptionsContext activityOptions) => ActivitySamplingResult.None
                };
                ...
                listeners[1] = new ActivityListener
                {
                    ...
                    ActivityStopped = (activity) => { activityStopCount++; Assert.NotNull(activity); },
                    ShouldListenTo = (activitySource) => true,
                    SampleUsingParentId = (ref ActivityCreationOptionsString activityOptions) => ActivitySamplingResult.PropagationData,
                    Sample = (ref ActivityCreationOptionsContext activityOptions) => ActivitySamplingResult.PropagationData
                };
                ...
                listeners[2] = new ActivityListener
                {
                    ...
                    ActivityStopped = (activity) => { activityStopCount++; Assert.NotNull(activity); },
                    ShouldListenTo = (activitySource) => true,
                    SampleUsingParentId = (ref ActivityCreationOptionsString activityOptions) => ActivitySamplingResult.AllData,
                    Sample = (ref ActivityCreationOptionsContext activityOptions) => ActivitySamplingResult.AllData
                };
                ...
                listeners[3] = new ActivityListener
                {
                    ...
                    ActivityStopped = (activity) => { activityStopCount++; Assert.NotNull(activity); },
                    ShouldListenTo = (activitySource) => true,
                    SampleUsingParentId = (ref ActivityCreationOptionsString activityOptions) => ActivitySamplingResult.AllDataAndRecorded,
                    Sample = (ref ActivityCreationOptionsContext activityOptions) => ActivitySamplingResult.AllDataAndRecorded
                };
        ...
        public void TestDefaultParentContext()
        {
            RemoteExecutor.Invoke(() => {
                ...
                listener.Sample = (ref ActivityCreationOptionsContext activityOptions) =>
                {
        ...
        public void TestCreatingActivityUsingDifferentParentIds()
        {
            RemoteExecutor.Invoke(() => {
                ...
                listener1.Sample = listener3.Sample = (ref ActivityCreationOptionsContext activityOptions) =>
                {
                    callingByContext++;
                ...
                listener2.SampleUsingParentId = listener3.SampleUsingParentId = (ref ActivityCreationOptionsString activityOptions) =>
                {
                    callingByParentId++;
                    return ActivitySamplingResult.AllData;
                };
        ...
        public void TestAddingSamplerTagsUsingParentId()
        {
            RemoteExecutor.Invoke(() => {
                ...
                listener.SampleUsingParentId = (ref ActivityCreationOptionsString activityOptions) =>
                {
                    activityOptions.SamplingTags.Add("tag1", "value1");
                    activityOptions.SamplingTags.Add("tag2", "value2");
                    return ActivitySamplingResult.AllData;
        ...
        public void TestAddingSamplerTagsFromMultipleListeners()
        {
            RemoteExecutor.Invoke(() => {
                ...
                listener1.Sample = listener2.Sample = (ref ActivityCreationOptionsContext activityOptions) =>
                {
        ...
        public void TestSamplerTagsWithMixedListenerModels()
        {
            RemoteExecutor.Invoke(() => {
                ...
                listener1.SampleUsingParentId = (ref ActivityCreationOptionsString activityOptions) =>
                {
                    activityOptions.SamplingTags.Add("tag1", "value1");
                    return ActivitySamplingResult.AllData;
                };
                ...
                listener2.Sample = (ref ActivityCreationOptionsContext activityOptions) =>
                {
                    activityOptions.SamplingTags.Add("tag2", "value2");
                    return ActivitySamplingResult.AllData;
                };
