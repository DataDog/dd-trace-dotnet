...
namespace CallTargetNativeTest
{
    class Program
    {
        ...
        private static void Argument4()
        {
            ...
            RunMethod(() => w4.VoidMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4Arguments).FullName}.ReturnValueMethod");
            RunMethod(() => w4.ReturnValueMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4Arguments).FullName}.ReturnReferenceMethod");
            RunMethod(() => w4.ReturnReferenceMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4Arguments).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w4.ReturnGenericMethod<string, string, Tuple<int, int>>("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4Arguments).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w4.ReturnGenericMethod<int, int, Tuple<int, int>>(42, 99, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine();
            //
            var w4g1 = new With4ArgumentsGeneric<string>();
            Console.WriteLine($"{typeof(With3ArgumentsGeneric<string>).FullName}.VoidMethod");
            RunMethod(() => w4g1.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With3ArgumentsGeneric<string>).FullName}.ReturnValueMethod");
            RunMethod(() => w4g1.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With3ArgumentsGeneric<string>).FullName}.ReturnReferenceMethod");
            RunMethod(() => w4g1.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With3ArgumentsGeneric<string>).FullName}.ReturnGenericMethod");
            RunMethod(() => w4g1.ReturnGenericMethod<string, Tuple<int, int>>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine();
            //
            var w4g2 = new With4ArgumentsGeneric<int>();
            Console.WriteLine($"{typeof(With4ArgumentsGeneric<int>).FullName}.VoidMethod");
            RunMethod(() => w4g2.VoidMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsGeneric<int>).FullName}.ReturnValueMethod");
            RunMethod(() => w4g2.ReturnValueMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsGeneric<int>).FullName}.ReturnReferenceMethod");
            RunMethod(() => w4g2.ReturnReferenceMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsGeneric<int>).FullName}.ReturnGenericMethod");
            RunMethod(() => w4g2.ReturnGenericMethod<int, Tuple<int, int>>(42, 99, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine();
            //
            var w4in = new With4ArgumentsInherits();
            Console.WriteLine($"{typeof(With4ArgumentsInherits).FullName}.VoidMethod");
            RunMethod(() => w4in.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsInherits).FullName}.ReturnValueMethod");
            RunMethod(() => w4in.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsInherits).FullName}.ReturnReferenceMethod");
            RunMethod(() => w4in.ReturnReferenceMethod("Hello Wolrd", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsInherits).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w4in.ReturnGenericMethod<string, int, Tuple<int, int>>(42, 99, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsInherits).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w4in.ReturnGenericMethod<int, string, Tuple<int, int>>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine();
            //
            var w4inGen = new With4ArgumentsInheritsGeneric();
            Console.WriteLine($"{typeof(With4ArgumentsInheritsGeneric).FullName}.VoidMethod");
            RunMethod(() => w4inGen.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsInheritsGeneric).FullName}.ReturnValueMethod");
            RunMethod(() => w4inGen.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsInheritsGeneric).FullName}.ReturnReferenceMethod");
            RunMethod(() => w4inGen.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsInheritsGeneric).FullName}.ReturnGenericMethod");
            RunMethod(() => w4inGen.ReturnGenericMethod<int, Tuple<int, int>>(42, 99, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine();
            //
            var w4Struct = new With4ArgumentsStruct();
            Console.WriteLine($"{typeof(With4ArgumentsStruct).FullName}.VoidMethod");
            RunMethod(() => w4Struct.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsStruct).FullName}.ReturnValueMethod");
            RunMethod(() => w4Struct.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsStruct).FullName}.ReturnReferenceMethod");
            RunMethod(() => w4Struct.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsStruct).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w4Struct.ReturnGenericMethod<string, int, Tuple<int, int>>(42, 99, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsStruct).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w4Struct.ReturnGenericMethod<int, string, Tuple<int, int>>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine();
            //
            Console.WriteLine($"{typeof(With4ArgumentsStatic).FullName}.VoidMethod");
            RunMethod(() => With4ArgumentsStatic.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsStatic).FullName}.ReturnValueMethod");
            RunMethod(() => With4ArgumentsStatic.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsStatic).FullName}.ReturnReferenceMethod");
            RunMethod(() => With4ArgumentsStatic.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask));
            Console.WriteLine($"{typeof(With4ArgumentsStatic).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => With4ArgumentsStatic.ReturnGenericMethod<string, int, Tuple<int, int>>(42, 99, Tuple.Create(1, 2), Program.CompletedTask));
        ...
        private static void Argument5()
        {
            ...
            RunMethod(() => w5.VoidMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5Arguments).FullName}.ReturnValueMethod");
            RunMethod(() => w5.ReturnValueMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5Arguments).FullName}.ReturnReferenceMethod");
            RunMethod(() => w5.ReturnReferenceMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5Arguments).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w5.ReturnGenericMethod<string, string, Tuple<int, int>>("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5Arguments).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w5.ReturnGenericMethod<int, int, Tuple<int, int>>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine();
            //
            var w5g1 = new With5ArgumentsGeneric<string>();
            Console.WriteLine($"{typeof(With5ArgumentsGeneric<string>).FullName}.VoidMethod");
            RunMethod(() => w5g1.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsGeneric<string>).FullName}.ReturnValueMethod");
            RunMethod(() => w5g1.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsGeneric<string>).FullName}.ReturnReferenceMethod");
            RunMethod(() => w5g1.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsGeneric<string>).FullName}.ReturnGenericMethod");
            RunMethod(() => w5g1.ReturnGenericMethod<string, Tuple<int, int>>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine();
            //
            var w5g2 = new With5ArgumentsGeneric<int>();
            Console.WriteLine($"{typeof(With5ArgumentsGeneric<int>).FullName}.VoidMethod");
            RunMethod(() => w5g2.VoidMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsGeneric<int>).FullName}.ReturnValueMethod");
            RunMethod(() => w5g2.ReturnValueMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsGeneric<int>).FullName}.ReturnReferenceMethod");
            RunMethod(() => w5g2.ReturnReferenceMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsGeneric<int>).FullName}.ReturnGenericMethod");
            RunMethod(() => w5g2.ReturnGenericMethod<int, Tuple<int, int>>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine();
            //
            var w5in = new With5ArgumentsInherits();
            Console.WriteLine($"{typeof(With5ArgumentsInherits).FullName}.VoidMethod");
            RunMethod(() => w5in.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsInherits).FullName}.ReturnValueMethod");
            RunMethod(() => w5in.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsInherits).FullName}.ReturnReferenceMethod");
            RunMethod(() => w5in.ReturnReferenceMethod("Hello Wolrd", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsInherits).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w5in.ReturnGenericMethod<string, int, Tuple<int, int>>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsInherits).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w5in.ReturnGenericMethod<int, string, Tuple<int, int>>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine();
            //
            var w5inGen = new With5ArgumentsInheritsGeneric();
            Console.WriteLine($"{typeof(With5ArgumentsInheritsGeneric).FullName}.VoidMethod");
            RunMethod(() => w5inGen.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsInheritsGeneric).FullName}.ReturnValueMethod");
            RunMethod(() => w5inGen.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsInheritsGeneric).FullName}.ReturnReferenceMethod");
            RunMethod(() => w5inGen.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsInheritsGeneric).FullName}.ReturnGenericMethod");
            RunMethod(() => w5inGen.ReturnGenericMethod<int, Tuple<int, int>>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine();
            //
            var w5Struct = new With5ArgumentsStruct();
            Console.WriteLine($"{typeof(With5ArgumentsStruct).FullName}.VoidMethod");
            RunMethod(() => w5Struct.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsStruct).FullName}.ReturnValueMethod");
            RunMethod(() => w5Struct.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsStruct).FullName}.ReturnReferenceMethod");
            RunMethod(() => w5Struct.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsStruct).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w5Struct.ReturnGenericMethod<string, int, Tuple<int, int>>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsStruct).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w5Struct.ReturnGenericMethod<int, string, Tuple<int, int>>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine();
            //
            Console.WriteLine($"{typeof(With5ArgumentsStatic).FullName}.VoidMethod");
            RunMethod(() => With5ArgumentsStatic.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsStatic).FullName}.ReturnValueMethod");
            RunMethod(() => With5ArgumentsStatic.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsStatic).FullName}.ReturnReferenceMethod");
            RunMethod(() => With5ArgumentsStatic.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
            Console.WriteLine($"{typeof(With5ArgumentsStatic).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => With5ArgumentsStatic.ReturnGenericMethod<string, int, Tuple<int, int>>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None));
        ...
        private static void Argument6()
        {
            ...
            RunMethod(() => w6.VoidMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            ...
            RunMethod(() => w6.ReturnGenericMethod<Task<int>, int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine();
            //
            var w6g1 = new With6ArgumentsGeneric<string>();
            Console.WriteLine($"{typeof(With6ArgumentsGeneric<string>).FullName}.VoidMethod");
            RunMethod(() => w6g1.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsGeneric<string>).FullName}.ReturnValueMethod");
            RunMethod(() => w6g1.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsGeneric<string>).FullName}.ReturnReferenceMethod");
            RunMethod(() => w6g1.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsGeneric<string>).FullName}.ReturnGenericMethod");
            RunMethod(() => w6g1.ReturnGenericMethod<string, Tuple<int, int>, ulong>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine();
            //
            var w6g2 = new With6ArgumentsGeneric<int>();
            Console.WriteLine($"{typeof(With6ArgumentsGeneric<int>).FullName}.VoidMethod");
            RunMethod(() => w6g2.VoidMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsGeneric<int>).FullName}.ReturnValueMethod");
            RunMethod(() => w6g2.ReturnValueMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsGeneric<int>).FullName}.ReturnReferenceMethod");
            RunMethod(() => w6g2.ReturnReferenceMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsGeneric<int>).FullName}.ReturnGenericMethod");
            RunMethod(() => w6g2.ReturnGenericMethod<int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine();
            //
            var w6in = new With6ArgumentsInherits();
            Console.WriteLine($"{typeof(With6ArgumentsInherits).FullName}.VoidMethod");
            RunMethod(() => w6in.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsInherits).FullName}.ReturnValueMethod");
            RunMethod(() => w6in.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsInherits).FullName}.ReturnReferenceMethod");
            RunMethod(() => w6in.ReturnReferenceMethod("Hello Wolrd", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsInherits).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w6in.ReturnGenericMethod<string, int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsInherits).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w6in.ReturnGenericMethod<int, string, Tuple<int, int>, ulong>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine();
            //
            var w6inGen = new With6ArgumentsInheritsGeneric();
            Console.WriteLine($"{typeof(With6ArgumentsInheritsGeneric).FullName}.VoidMethod");
            RunMethod(() => w6inGen.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsInheritsGeneric).FullName}.ReturnValueMethod");
            RunMethod(() => w6inGen.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsInheritsGeneric).FullName}.ReturnReferenceMethod");
            RunMethod(() => w6inGen.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsInheritsGeneric).FullName}.ReturnGenericMethod");
            RunMethod(() => w6inGen.ReturnGenericMethod<int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine();
            //
            var w6Struct = new With6ArgumentsStruct();
            Console.WriteLine($"{typeof(With6ArgumentsStruct).FullName}.VoidMethod");
            RunMethod(() => w6Struct.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsStruct).FullName}.ReturnValueMethod");
            RunMethod(() => w6Struct.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsStruct).FullName}.ReturnReferenceMethod");
            RunMethod(() => w6Struct.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsStruct).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w6Struct.ReturnGenericMethod<string, int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsStruct).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w6Struct.ReturnGenericMethod<int, string, Tuple<int, int>, ulong>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine();
            //
            Console.WriteLine($"{typeof(With6ArgumentsStatic).FullName}.VoidMethod");
            RunMethod(() => With6ArgumentsStatic.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsStatic).FullName}.ReturnValueMethod");
            RunMethod(() => With6ArgumentsStatic.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsStatic).FullName}.ReturnReferenceMethod");
            RunMethod(() => With6ArgumentsStatic.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
            Console.WriteLine($"{typeof(With6ArgumentsStatic).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => With6ArgumentsStatic.ReturnGenericMethod<string, int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987));
        ...
        private static void Argument7()
        {
            ...
            RunMethod(() => w7.VoidMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7Arguments).FullName}.ReturnValueMethod");
            RunMethod(() => w7.ReturnValueMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7Arguments).FullName}.ReturnReferenceMethod");
            RunMethod(() => w7.ReturnReferenceMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7Arguments).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w7.ReturnGenericMethod<string, string, Tuple<int, int>, ulong>("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7Arguments).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w7.ReturnGenericMethod<int, int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine();
            //
            var w7g1 = new With7ArgumentsGeneric<string>();
            Console.WriteLine($"{typeof(With7ArgumentsGeneric<string>).FullName}.VoidMethod");
            RunMethod(() => w7g1.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsGeneric<string>).FullName}.ReturnValueMethod");
            RunMethod(() => w7g1.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsGeneric<string>).FullName}.ReturnReferenceMethod");
            RunMethod(() => w7g1.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsGeneric<string>).FullName}.ReturnGenericMethod");
            RunMethod(() => w7g1.ReturnGenericMethod<string, Tuple<int, int>, ulong>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine();
            //
            var w7g2 = new With7ArgumentsGeneric<int>();
            Console.WriteLine($"{typeof(With7ArgumentsGeneric<int>).FullName}.VoidMethod");
            RunMethod(() => w7g2.VoidMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsGeneric<int>).FullName}.ReturnValueMethod");
            RunMethod(() => w7g2.ReturnValueMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsGeneric<int>).FullName}.ReturnReferenceMethod");
            RunMethod(() => w7g2.ReturnReferenceMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsGeneric<int>).FullName}.ReturnGenericMethod");
            RunMethod(() => w7g2.ReturnGenericMethod<int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine();
            //
            var w7in = new With7ArgumentsInherits();
            Console.WriteLine($"{typeof(With7ArgumentsInherits).FullName}.VoidMethod");
            RunMethod(() => w7in.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsInherits).FullName}.ReturnValueMethod");
            RunMethod(() => w7in.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsInherits).FullName}.ReturnReferenceMethod");
            RunMethod(() => w7in.ReturnReferenceMethod("Hello Wolrd", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsInherits).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w7in.ReturnGenericMethod<string, int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsInherits).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w7in.ReturnGenericMethod<int, string, Tuple<int, int>, ulong>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine();
            //
            var w7inGen = new With7ArgumentsInheritsGeneric();
            Console.WriteLine($"{typeof(With7ArgumentsInheritsGeneric).FullName}.VoidMethod");
            RunMethod(() => w7inGen.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsInheritsGeneric).FullName}.ReturnValueMethod");
            RunMethod(() => w7inGen.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsInheritsGeneric).FullName}.ReturnReferenceMethod");
            RunMethod(() => w7inGen.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsInheritsGeneric).FullName}.ReturnGenericMethod");
            RunMethod(() => w7inGen.ReturnGenericMethod<int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine();
            //
            var w7Struct = new With7ArgumentsStruct();
            Console.WriteLine($"{typeof(With7ArgumentsStruct).FullName}.VoidMethod");
            RunMethod(() => w7Struct.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsStruct).FullName}.ReturnValueMethod");
            RunMethod(() => w7Struct.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsStruct).FullName}.ReturnReferenceMethod");
            RunMethod(() => w7Struct.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsStruct).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w7Struct.ReturnGenericMethod<string, int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsStruct).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w7Struct.ReturnGenericMethod<int, string, Tuple<int, int>, ulong>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine();
            //
            Console.WriteLine($"{typeof(With7ArgumentsStatic).FullName}.VoidMethod");
            RunMethod(() => With7ArgumentsStatic.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsStatic).FullName}.ReturnValueMethod");
            RunMethod(() => With7ArgumentsStatic.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsStatic).FullName}.ReturnReferenceMethod");
            RunMethod(() => With7ArgumentsStatic.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
            Console.WriteLine($"{typeof(With7ArgumentsStatic).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => With7ArgumentsStatic.ReturnGenericMethod<string, int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value"));
        ...
        private static void Argument8()
        {
            ...
            RunMethod(() => w8.VoidMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8Arguments).FullName}.ReturnValueMethod");
            RunMethod(() => w8.ReturnValueMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8Arguments).FullName}.ReturnReferenceMethod");
            RunMethod(() => w8.ReturnReferenceMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8Arguments).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w8.ReturnGenericMethod<string, string, Tuple<int, int>, ulong>("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8Arguments).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w8.ReturnGenericMethod<int, int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine();
            //
            ...
            RunMethod(() => w8g1.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsGeneric<string>).FullName}.ReturnValueMethod");
            RunMethod(() => w8g1.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsGeneric<string>).FullName}.ReturnReferenceMethod");
            RunMethod(() => w8g1.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsGeneric<string>).FullName}.ReturnGenericMethod");
            RunMethod(() => w8g1.ReturnGenericMethod<string, Tuple<int, int>, ulong>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine();
            //
            var w8g2 = new With8ArgumentsGeneric<int>();
            Console.WriteLine($"{typeof(With8ArgumentsGeneric<int>).FullName}.VoidMethod");
            RunMethod(() => w8g2.VoidMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsGeneric<int>).FullName}.ReturnValueMethod");
            RunMethod(() => w8g2.ReturnValueMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsGeneric<int>).FullName}.ReturnReferenceMethod");
            RunMethod(() => w8g2.ReturnReferenceMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsGeneric<int>).FullName}.ReturnGenericMethod");
            RunMethod(() => w8g2.ReturnGenericMethod<int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine();
            //
            var w8in = new With8ArgumentsInherits();
            Console.WriteLine($"{typeof(With8ArgumentsInherits).FullName}.VoidMethod");
            RunMethod(() => w8in.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsInherits).FullName}.ReturnValueMethod");
            RunMethod(() => w8in.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsInherits).FullName}.ReturnReferenceMethod");
            RunMethod(() => w8in.ReturnReferenceMethod("Hello Wolrd", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsInherits).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w8in.ReturnGenericMethod<string, int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsInherits).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w8in.ReturnGenericMethod<int, string, Tuple<int, int>, ulong>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine();
            //
            var w8inGen = new With8ArgumentsInheritsGeneric();
            Console.WriteLine($"{typeof(With8ArgumentsInheritsGeneric).FullName}.VoidMethod");
            RunMethod(() => w8inGen.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsInheritsGeneric).FullName}.ReturnValueMethod");
            RunMethod(() => w8inGen.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsInheritsGeneric).FullName}.ReturnReferenceMethod");
            RunMethod(() => w8inGen.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsInheritsGeneric).FullName}.ReturnGenericMethod");
            RunMethod(() => w8inGen.ReturnGenericMethod<int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine();
            //
            var w8Struct = new With8ArgumentsStruct();
            Console.WriteLine($"{typeof(With8ArgumentsStruct).FullName}.VoidMethod");
            RunMethod(() => w8Struct.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsStruct).FullName}.ReturnValueMethod");
            RunMethod(() => w8Struct.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsStruct).FullName}.ReturnReferenceMethod");
            RunMethod(() => w8Struct.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsStruct).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w8Struct.ReturnGenericMethod<string, int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsStruct).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w8Struct.ReturnGenericMethod<int, string, Tuple<int, int>, ulong>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine();
            //
            Console.WriteLine($"{typeof(With8ArgumentsStatic).FullName}.VoidMethod");
            RunMethod(() => With8ArgumentsStatic.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsStatic).FullName}.ReturnValueMethod");
            RunMethod(() => With8ArgumentsStatic.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsStatic).FullName}.ReturnReferenceMethod");
            RunMethod(() => With8ArgumentsStatic.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
            Console.WriteLine($"{typeof(With8ArgumentsStatic).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => With8ArgumentsStatic.ReturnGenericMethod<string, int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly()));
        ...
        private static void Argument9()
        {
            ...
            RunMethod(() => w9.VoidMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9Arguments).FullName}.ReturnValueMethod");
            RunMethod(() => w9.ReturnValueMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9Arguments).FullName}.ReturnReferenceMethod");
            RunMethod(() => w9.ReturnReferenceMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9Arguments).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w9.ReturnGenericMethod<string, string, Tuple<int, int>, ulong>("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9Arguments).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w9.ReturnGenericMethod<int, int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine();
            //
            ...
            RunMethod(() => w9g1.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsGeneric<string>).FullName}.ReturnValueMethod");
            RunMethod(() => w9g1.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsGeneric<string>).FullName}.ReturnReferenceMethod");
            RunMethod(() => w9g1.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsGeneric<string>).FullName}.ReturnGenericMethod");
            RunMethod(() => w9g1.ReturnGenericMethod<string, Tuple<int, int>, ulong>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine();
            //
            var w9g2 = new With9ArgumentsGeneric<int>();
            Console.WriteLine($"{typeof(With9ArgumentsGeneric<int>).FullName}.VoidMethod");
            RunMethod(() => w9g2.VoidMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsGeneric<int>).FullName}.ReturnValueMethod");
            RunMethod(() => w9g2.ReturnValueMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsGeneric<int>).FullName}.ReturnReferenceMethod");
            RunMethod(() => w9g2.ReturnReferenceMethod("Hello world", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsGeneric<int>).FullName}.ReturnGenericMethod");
            RunMethod(() => w9g2.ReturnGenericMethod<int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine();
            //
            var w9in = new With9ArgumentsInherits();
            Console.WriteLine($"{typeof(With9ArgumentsInherits).FullName}.VoidMethod");
            RunMethod(() => w9in.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsInherits).FullName}.ReturnValueMethod");
            RunMethod(() => w9in.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsInherits).FullName}.ReturnReferenceMethod");
            RunMethod(() => w9in.ReturnReferenceMethod("Hello Wolrd", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsInherits).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w9in.ReturnGenericMethod<string, int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsInherits).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w9in.ReturnGenericMethod<int, string, Tuple<int, int>, ulong>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine();
            //
            var w9inGen = new With9ArgumentsInheritsGeneric();
            Console.WriteLine($"{typeof(With9ArgumentsInheritsGeneric).FullName}.VoidMethod");
            RunMethod(() => w9inGen.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsInheritsGeneric).FullName}.ReturnValueMethod");
            RunMethod(() => w9inGen.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsInheritsGeneric).FullName}.ReturnReferenceMethod");
            RunMethod(() => w9inGen.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsInheritsGeneric).FullName}.ReturnGenericMethod");
            RunMethod(() => w9inGen.ReturnGenericMethod<int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine();
            //
            var w9Struct = new With9ArgumentsStruct();
            Console.WriteLine($"{typeof(With9ArgumentsStruct).FullName}.VoidMethod");
            RunMethod(() => w9Struct.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsStruct).FullName}.ReturnValueMethod");
            RunMethod(() => w9Struct.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsStruct).FullName}.ReturnReferenceMethod");
            RunMethod(() => w9Struct.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsStruct).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => w9Struct.ReturnGenericMethod<string, int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsStruct).FullName}.ReturnGenericMethod<int>");
            RunMethod(() => w9Struct.ReturnGenericMethod<int, string, Tuple<int, int>, ulong>("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine();
            //
            Console.WriteLine($"{typeof(With9ArgumentsStatic).FullName}.VoidMethod");
            RunMethod(() => With9ArgumentsStatic.VoidMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsStatic).FullName}.ReturnValueMethod");
            RunMethod(() => With9ArgumentsStatic.ReturnValueMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsStatic).FullName}.ReturnReferenceMethod");
            RunMethod(() => With9ArgumentsStatic.ReturnReferenceMethod("Hello World", 42, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
            Console.WriteLine($"{typeof(With9ArgumentsStatic).FullName}.ReturnGenericMethod<string>");
            RunMethod(() => With9ArgumentsStatic.ReturnGenericMethod<string, int, Tuple<int, int>, ulong>(42, 99, Tuple.Create(1, 2), Program.CompletedTask, CancellationToken.None, 987, "Arg7-Value", Assembly.GetExecutingAssembly(), null));
