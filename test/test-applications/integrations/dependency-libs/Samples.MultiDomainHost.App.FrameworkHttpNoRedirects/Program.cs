...
namespace Samples.MultiDomainHost.App.FrameworkHttpNoRedirects
{
    public class Program
    {
        ...
        static void InnerMethodToAllowProfilerInjection()
        {
            ...
            using (StartHttpListenerWithPortResilience("http://localhost:{0}/Samples.FrameworkHttpNoRedirects/", out var url))
            {
