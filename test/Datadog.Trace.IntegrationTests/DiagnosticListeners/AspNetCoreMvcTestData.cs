...
namespace Datadog.Trace.IntegrationTests.DiagnosticListeners
{
    public static class AspNetCoreMvcTestData
    {
        ...
        public static TheoryData<string, int, bool, string, SerializableDictionary> WithoutFeatureFlag => new()
        {
            ...
            { "/Api/Value/3", 400, false, "GET api/Value/{value}", EmptyTags() },
            { "/Api/Value/200", 200, false, "GET api/Value/{value}", EmptyTags() },
            { "/Api/Value/201", 201, false, "GET api/Value/{value}", EmptyTags() },
            { "/Api/Value/401", 401, false, "GET api/Value/{value}", EmptyTags() },
