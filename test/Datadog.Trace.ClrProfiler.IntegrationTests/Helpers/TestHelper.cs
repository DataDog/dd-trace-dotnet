...
namespace Datadog.Trace.ClrProfiler.IntegrationTests
{
    ...
    {
        protected TestHelper(string sampleAppName, string samplePathOverrides, ITestOutputHelper output, List<string> environmentVariablesToUnset = null)
            : this(new EnvironmentHelper(sampleAppName, typeof(TestHelper), output, samplePathOverrides, environmentVariablesToUnset: environmentVariablesToUnset), output)
        {
        }

        protected TestHelper(string sampleAppName, ITestOutputHelper output, List<string> environmentVariablesToUnset = null)
            : this(new EnvironmentHelper(sampleAppName, typeof(TestHelper), output, environmentVariablesToUnset: environmentVariablesToUnset), output)
        {
        }
