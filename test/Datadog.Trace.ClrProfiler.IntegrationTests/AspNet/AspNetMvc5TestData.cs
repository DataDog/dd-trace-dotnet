// <copyright file="AspNetMvc5TestData.cs" company="Datadog">
...
namespace Datadog.Trace.ClrProfiler.IntegrationTests
{
    public class AspNetMvc5TestData
    {
        ...
        {
            { "/DataDog", "GET /datadog", "GET /datadog", 200, false, null, null, DatadogAreaTags },
            { "/DataDog/DogHouse", "GET /datadog/doghouse", "GET /datadog/doghouse", 200, false, null, null, DatadogAreaTags },
            { "/DataDog/DogHouse/Woof", "GET /datadog/doghouse/woof", "GET /datadog/doghouse/woof", 200, false, null, null, DatadogAreaWoofTags },
            ...
            { "/Home/Get", "GET /home/get", "GET /home/get", 500, true, "System.ArgumentException", MissingParameterError, HomeGetTags },
            { "/Home/Get/3", "GET /home/get/?", "GET /home/get/?", 200, false, null, null, HomeGetTags },
            { "/delay/0", "GET /delay/?", "GET /delay/{seconds}", 200, false, null, null, DelayTags },
            { "/delay-async/0", "GET /delay-async/?", "GET /delay-async/{seconds}", 200, false, null, null, DelayAsyncTags },
            { "/delay-optional", "GET /delay-optional", "GET /delay-optional/{seconds}", 200, false, null, null, DelayOptionalTags },
            { "/delay-optional/1", "GET /delay-optional/?", "GET /delay-optional/{seconds}", 200, false, null, null, DelayOptionalTags },
            { "/badrequest", "GET /badrequest", "GET /badrequest", 500, true, "System.Exception", "Oops, it broke.", BadRequestTags },
            { "/statuscode/201", "GET /statuscode/?", "GET /statuscode/{value}", 201, false, null, null, StatusCodeTags },
            { "/statuscode/503", "GET /statuscode/?", "GET /statuscode/{value}", 503, true, null, "The HTTP response has status code 503.", StatusCodeTags },
        };
