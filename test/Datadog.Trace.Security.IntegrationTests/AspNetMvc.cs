// <copyright file="AspNetMvc.cs" company="Datadog">
...
{
    public class AspNetMvc : AspNetCoreBase
    {
        public AspNetMvc(ITestOutputHelper outputHelper)
           : base("AspNetMvc", outputHelper, "test\\test-applications\\security\\aspnet")
        {
        }
