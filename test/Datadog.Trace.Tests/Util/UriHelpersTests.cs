...
namespace Datadog.Trace.Tests.Util
{
    public class UriHelpersTests
    {
        ...
        public void GetCleanUriPath_WithNewIdCleaning_ShouldRemoveIdsFromPaths(string url, string expected)
        {
            Assert.Equal(expected, Trace.Util.UriHelpers.GetCleanUriPath(url, useLegacyIdCleaning: false));
        }
        ...
        [InlineData("/controller/action/12345678901234567890123456789012345678901234567890", "/controller/action/12345678901234567890123456789012345678901234567890")]
        [InlineData("/controller/action/eeeee123", "/controller/action/eeeee123")]
        [InlineData("/controller/action/0123456789ABCDE", "/controller/action/0123456789ABCDE")]
        [InlineData("/controller/action/0123456789ABCDEF", "/controller/action/0123456789ABCDEF")]
        [InlineData("/controller/action/0123456789ABCDEF0", "/controller/action/0123456789ABCDEF0")]
        [InlineData("/controller/action/eeeeeeeeeeeeeeeee", "/controller/action/eeeeeeeeeeeeeeeee")]
