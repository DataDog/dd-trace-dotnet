...
namespace Datadog.Trace.Tests.Configuration
{
    public class ConfigurationSourceTests
    {
        ...
        public static IEnumerable<object[]> GetTestData()
        {
            ...
            yield return new object[] { ConfigurationKeys.AdoNetExcludeTypes, "System.Data.SqlClient.SqlCommand;SYSTEM.DATA.SQLCLIENT.SQLCOMMAND;;System.Data.SqlClient.SqlConnection", CreateFunc(s => s.AdoNetExcludedTypes.Count), 2 };
