...
namespace Datadog.Logging.Composition
{
    ...
    ///   1) Logger type:               "Datadog.Profiler.Log"
    ///      Logging component moniker: "Datadog.ProfilerEngine"
    ///
    /// TOTAL: 1 loggers.
    /// </summary>
    internal static class LogComposer
    {
        ...
        public static bool IsDebugLoggingEnabled
        {
            ...
            set
            {
                ...
                {
                    global::Datadog.Profiler.Log.Configure.DebugLoggingEnabled(s_isDebugLoggingEnabled);
                }
            }
        }
        ...
        public static void RedirectLogs(ILogSink logSink, out IReadOnlyDictionary<Type, LogSourceNameCompositionLogSink> redirectionLogSinks)
        {
            ...
            {
                Type loggerType = typeof(global::Datadog.Profiler.Log);
                const string logComponentGroupMoniker = "Datadog.ProfilerEngine";

                if (logSink == null)
                {
                    redirectionSinks[loggerType] = null;
                    global::Datadog.Profiler.Log.Configure.EventHandlers.Error(null);
                    global::Datadog.Profiler.Log.Configure.EventHandlers.Info(null);
                    global::Datadog.Profiler.Log.Configure.EventHandlers.Debug(null);
                }
                else
                {
                    ...
                    global::Datadog.Profiler.Log.Configure.EventHandlers.Error(logToSinkAdapter.Error);
                    global::Datadog.Profiler.Log.Configure.EventHandlers.Info(logToSinkAdapter.Info);
                    global::Datadog.Profiler.Log.Configure.EventHandlers.Debug(logToSinkAdapter.Debug);
                }

                Datadog.Profiler.Log.Configure.DebugLoggingEnabled(IsDebugLoggingEnabled);
            }
