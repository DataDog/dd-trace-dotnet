...
$env:COR_PROFILER_PATH_64=$env:DD_DOTNET_PROFILER_HOME + '\Datadog.Profiler.Native.x64.dll'
$env:COR_PROFILER_PATH_32=$env:DD_DOTNET_PROFILER_HOME + '\Datadog.Profiler.Native.x86.dll'

$env:CORECLR_ENABLE_PROFILING=1
$env:CORECLR_PROFILER='{BD1A650D-AC5D-4896-B64F-D6FA25D6B26A}'
$env:CORECLR_PROFILER_PATH=''
$env:CORECLR_PROFILER_PATH_64=$env:DD_DOTNET_PROFILER_HOME + '\Datadog.Profiler.Native.x64.dll'
$env:CORECLR_PROFILER_PATH_32=$env:DD_DOTNET_PROFILER_HOME + '\Datadog.Profiler.Native.x86.dll'
