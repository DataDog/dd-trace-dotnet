...
SET COR_PROFILER_PATH_64=%DD_DOTNET_PROFILER_HOME%Datadog.AutoInstrumentation.Profiler.Native.x64.dll
SET COR_PROFILER_PATH_32=%DD_DOTNET_PROFILER_HOME%Datadog.AutoInstrumentation.Profiler.Native.x86.dll

SET CORECLR_ENABLE_PROFILING=1
SET CORECLR_PROFILER={BD1A650D-AC5D-4896-B64F-D6FA25D6B26A}
SET CORECLR_PROFILER_PATH_64=%DD_DOTNET_PROFILER_HOME%Datadog.AutoInstrumentation.Profiler.Native.x64.dll
SET CORECLR_PROFILER_PATH_32=%DD_DOTNET_PROFILER_HOME%Datadog.AutoInstrumentation.Profiler.Native.x86.dll

IF DEFINED DD_DOTNET_CONTINUOUS_PROFILER_BITNESS (
    SET COR_PROFILER_PATH=%DD_DOTNET_PROFILER_HOME%Datadog.AutoInstrumentation.Profiler.Native.%DD_DOTNET_CONTINUOUS_PROFILER_BITNESS%.dll
    SET CORECLR_PROFILER_PATH=%DD_DOTNET_PROFILER_HOME%Datadog.AutoInstrumentation.Profiler.Native.%DD_DOTNET_CONTINUOUS_PROFILER_BITNESS%.dll
) ELSE (
