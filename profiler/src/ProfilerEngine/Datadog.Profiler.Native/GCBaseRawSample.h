...
private:
    ...
    static const inline InternedString Gen2Frame = "|lm: |ns: |ct: |cg: |fn:gen2 |fg: |sg:";
    static const inline InternedString UnknownGenerationFrame = "|lm: |ns: |ct: |cg: |fn:unknown |fg: |sg:";
};