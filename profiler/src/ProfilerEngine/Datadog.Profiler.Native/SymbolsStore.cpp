...
namespace libdatadog
{
    ...
    struct KnownSymbols
    {
        ddog_prof_FunctionId2 NotResolvedFrameId;
        ddog_prof_MappingId2 NotResolvedModuleId;
        ddog_prof_MappingId2 UnloadedModuleId;
        ddog_prof_MappingId2 UnknownNativeModuleId;

        ddog_prof_MappingId2 FakeModuleId;

        ddog_prof_FunctionId2 FakeContentionFrameId;
        ddog_prof_FunctionId2 FakeAllocationFrameId;

        ddog_prof_FunctionId2 FakeFunctionId;
        ddog_prof_FunctionId2 UnknownNativeFrameId;
        ddog_prof_FunctionId2 UnknownManagedFrameId;
        ddog_prof_StringId2 UnknownManagedTypeId;
        ddog_prof_MappingId2 UnknownManagedAssemblyId;
        ddog_prof_MappingId2 ClrModuleId;
        ddog_prof_FunctionId2 Gen0FrameId;
        ddog_prof_FunctionId2 Gen1FrameId;
        ddog_prof_FunctionId2 Gen2FrameId;
        ddog_prof_FunctionId2 GCRootFrameId; 
        ddog_prof_FunctionId2 DotNetRootFrameId;

        ddog_prof_StringId2 ThreadId;
        ddog_prof_StringId2 ThreadName;
        ddog_prof_StringId2 ProcessId;
        ddog_prof_StringId2 AppDomainName;
        ddog_prof_StringId2 LocalRootSpanId;
        ddog_prof_StringId2 SpanId;
        ddog_prof_StringId2 ExceptionType;
        ddog_prof_StringId2 ExceptionMessage;
        ddog_prof_StringId2 AllocationClass;
        ddog_prof_StringId2 GarbageCollectionGeneration;
        ddog_prof_StringId2 GarbageCollectionNumber;
        ddog_prof_StringId2 TimelineEventType;
        ddog_prof_StringId2 TimelineEventTypeStopTheWorld;
        ddog_prof_StringId2 TimelineEventTypeGarbageCollection;
        ddog_prof_StringId2 TimelineEventTypeThreadStart;
        ddog_prof_StringId2 TimelineEventTypeThreadStop;
        ddog_prof_StringId2 GarbageCollectionReason;
        ddog_prof_StringId2 GarbageCollectionType;
        ddog_prof_StringId2 GarbageCollectionCompacting;
        ddog_prof_StringId2 ObjectLifetime;
        ddog_prof_StringId2 ObjectId;
        ddog_prof_StringId2 ObjectGeneration;
        ddog_prof_StringId2 RequestUrl;
        ddog_prof_StringId2 RequestStatusCode;
        ddog_prof_StringId2 RequestError;
        ddog_prof_StringId2 RequestRedirectUrl;
        ddog_prof_StringId2 RequestDnsWait;
        ddog_prof_StringId2 RequestDnsDuration;
        ddog_prof_StringId2 RequestDnsSuccess;
        ddog_prof_StringId2 RequestHandshakeWait;
        ddog_prof_StringId2 RequestHandshakeDuration;
        ddog_prof_StringId2 RequestHandshakeError;
        ddog_prof_StringId2 RequestSocketDuration;
        ddog_prof_StringId2 RequestDuration;
        ddog_prof_StringId2 ResponseContentDuration;
        ddog_prof_StringId2 RequestResponseThreadId;
        ddog_prof_StringId2 RequestResponseThreadName;
        ddog_prof_StringId2 GcCpuThread;
        ddog_prof_StringId2 BucketLabelName;
        ddog_prof_StringId2 WaitBucketLabelName;
        ddog_prof_StringId2 RawCountLabelName;
        ddog_prof_StringId2 RawDurationLabelName;
        ddog_prof_StringId2 BlockingThreadIdLabelName;
        ddog_prof_StringId2 BlockingThreadNameLabelName;
        ddog_prof_StringId2 ContentionTypeLabelName;
        ddog_prof_FunctionId2 ThreadStartFrame;
        ddog_prof_FunctionId2 ThreadStopFrame;
        ddog_prof_MappingId2 NativeGcModuleId;
        ddog_prof_MappingId2 NativeClrModuleId;
    };
...
{\
    ...
    std::optional<ddog_prof_StringId2> SymbolsStore::InternString(std::string_view str)
    {
    ...
    std::optional<ddog_prof_FunctionId2> SymbolsStore::InternFunction(std::string const& functionName, std::string_view fileName)
    {
    ...
    std::optional<ddog_prof_MappingId2> SymbolsStore::InternMapping(std::string const& moduleName)
    {
    ...
    ddog_prof_FunctionId2 SymbolsStore::GetNotResolvedFrameId()
    {
        return _impl->knownSymbols.NotResolvedFrameId;
    }

    ddog_prof_MappingId2 SymbolsStore::GetNotResolvedModuleId()
    {
        return _impl->knownSymbols.NotResolvedModuleId;
    }

    ddog_prof_MappingId2 SymbolsStore::GetUnloadedModuleId()
    {
        return _impl->knownSymbols.UnloadedModuleId;
    }

    ddog_prof_MappingId2 SymbolsStore::GetFakeModuleId()
    {
        return _impl->knownSymbols.FakeModuleId;
    }

    ddog_prof_FunctionId2 SymbolsStore::GetFakeFunctionId()
    {
        return _impl->knownSymbols.FakeFunctionId;
    }

    ddog_prof_FunctionId2 SymbolsStore::GetFakeContentionFrameId()
    {
        return _impl->knownSymbols.FakeContentionFrameId;
    }

    ddog_prof_FunctionId2 SymbolsStore::GetFakeAllocationFrameId()
    {
        return _impl->knownSymbols.FakeAllocationFrameId;
    }

    ddog_prof_MappingId2 SymbolsStore::GetUnknownNativeModuleId()
    {
        return _impl->knownSymbols.UnknownNativeModuleId;
    }

    ddog_prof_FunctionId2 SymbolsStore::GetUnknownNativeFrameId()
    {
    ...
    ddog_prof_FunctionId2 SymbolsStore::GetUnknownManagedFrameId()
    {
        return _impl->knownSymbols.UnknownManagedFrameId;
    }

    ddog_prof_StringId2 SymbolsStore::GetUnknownManagedTypeId()
    {
        return _impl->knownSymbols.UnknownManagedTypeId;
    }

    ddog_prof_MappingId2 SymbolsStore::GetUnknownManagedAssemblyId()
    {
        return _impl->knownSymbols.UnknownManagedAssemblyId;
    }

    ddog_prof_MappingId2 SymbolsStore::GetClrModuleId()
    {
        return _impl->knownSymbols.ClrModuleId;
    }

    ddog_prof_FunctionId2 SymbolsStore::GetGen0FrameId()
    {
        return _impl->knownSymbols.Gen0FrameId;
    }

    ddog_prof_FunctionId2 SymbolsStore::GetGen1FrameId()
    {
        return _impl->knownSymbols.Gen1FrameId;
    }

    ddog_prof_FunctionId2 SymbolsStore::GetGen2FrameId()
    {
        return _impl->knownSymbols.Gen2FrameId;
    }

    ddog_prof_FunctionId2 SymbolsStore::GetGCRootFrameId()
    {
        return _impl->knownSymbols.GCRootFrameId;
    }

    ddog_prof_FunctionId2 SymbolsStore::GetDotNetRootFrameId()
    {
        return _impl->knownSymbols.DotNetRootFrameId;
    }

    ddog_prof_FunctionId2 SymbolsStore::GetThreadStartFrame()
    {
        return _impl->knownSymbols.ThreadStartFrame;
    }

    ddog_prof_FunctionId2 SymbolsStore::GetThreadStopFrame()
    {
    ...
    ddog_prof_MappingId2 SymbolsStore::GetNativeGcModuleId()
    {
        return _impl->knownSymbols.NativeGcModuleId;
    }

    ddog_prof_MappingId2 SymbolsStore::GetNativeClrModuleId()
    {
        return _impl->knownSymbols.NativeClrModuleId;
    }

#define GET_KNOWN_SYMBOL(fieldName) \
    ddog_prof_StringId2 SymbolsStore::Get##fieldName() const \
    {\
