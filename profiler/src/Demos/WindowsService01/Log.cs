...
namespace Datadog.Demos.WindowsService01
{
    ...
    /// For example:
    ///
    /// Library "Datadog.Profiler.Managed.dll" gets a copy of this file with the adjusted namespace:
    ///
    /// <code>
    ...
    /// </code>
    ///
    /// Library "Datadog.Tracer.Managed.dll" also gets a copy of this file with the adjusted namespace:
    ///
    /// <code>
    ///   namespace Datadog.Tracer.Managed
    ///   {
    ///       public static class Log
    ///       {
    ///       . . .
    ...
    /// <para>
    /// To continue the above example, assume that the entrypoint of the application is another library "Datadog.TracerAndProfilerLoader.dll".
    ...
    ///
    /// <code>
    ///   namespace Datadog.TracerAndProfilerLoader
    ///   {
    ///       using ComposerLogAdapter = Datadog.ProductComposer.LogAdapter;
    ///       using ProfilerLog = Datadog.Profiler.Log;
    ///       using TracerLog = Datadog.Tracer.Managed.Log;
    ///
