...
namespace Datadog.Logging.Composition
{
    ...
    ///   1) Logger type:               "Datadog.Demos.WindowsService01.Log"
    ///      Logging component moniker: "Datadog.Demos.WindowsService01"
    ///
    /// TOTAL: 1 loggers.
    /// </summary>
    internal static class LogComposer
    {
        ...
        public static bool IsDebugLoggingEnabled
        {
            ...
            set
            {
                ...
                {
                    global::Datadog.Demos.WindowsService01.Log.Configure.DebugLoggingEnabled(s_isDebugLoggingEnabled);
                }
            }
        }
        ...
        public static void RedirectLogs(ILogSink logSink, out IReadOnlyDictionary<Type, LogSourceNameCompositionLogSink> redirectionLogSinks)
        {
            ...
            {
                Type loggerType = typeof(global::Datadog.Demos.WindowsService01.Log);
                const string logComponentGroupMoniker = "Datadog.Demos.WindowsService01";

                if (logSink == null)
                {
                    redirectionSinks[loggerType] = null;
                    global::Datadog.Demos.WindowsService01.Log.Configure.EventHandlers.Error(null);
                    global::Datadog.Demos.WindowsService01.Log.Configure.EventHandlers.Info(null);
                    global::Datadog.Demos.WindowsService01.Log.Configure.EventHandlers.Debug(null);
                }
                else
                {
                    ...
                    global::Datadog.Demos.WindowsService01.Log.Configure.EventHandlers.Error(logToSinkAdapter.Error);
                    global::Datadog.Demos.WindowsService01.Log.Configure.EventHandlers.Info(logToSinkAdapter.Info);
                    global::Datadog.Demos.WindowsService01.Log.Configure.EventHandlers.Debug(logToSinkAdapter.Debug);
                }

                Datadog.Demos.WindowsService01.Log.Configure.DebugLoggingEnabled(IsDebugLoggingEnabled);
            }
