...
std::pair<bool, MyFrameInfo> FrameStoreHelper::GetFrame(uintptr_t instructionPointer)
{
    ...
    return {true, {_symbolsStore->GetUnknownManagedFrameId(), _symbolsStore->GetUnknownManagedAssemblyId(), 0}};
}
