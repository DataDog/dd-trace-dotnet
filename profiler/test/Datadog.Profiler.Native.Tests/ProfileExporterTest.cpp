...
TEST(ProfileExporterTest, CheckProfileIsWrittenToDisk)
{
    ...
    auto callstack1 = std::vector<std::pair<ddog_prof_FunctionId, ddog_prof_MappingId>>({{frame1Id.value(), moduleId.value()}, {frame2Id.value(), moduleId.value()}, {frame3Id.value(), moduleId.value()}});
    auto labels1 = std::vector<std::pair<ddog_prof_StringId, std::string>>{{symbolsStore->InternString("label1").value(), "value1"}, {symbolsStore->InternString("label2").value(), "value2"}};
    ...
    auto callstack2 = std::vector<std::pair<ddog_prof_FunctionId, ddog_prof_MappingId>>({{frame1Id.value(), moduleId.value()}, {frame2Id.value(), moduleId.value()}, {frame3Id.value(), moduleId.value()}, {frame4Id.value(), moduleId.value()}});
    auto labels2 = std::vector<std::pair<ddog_prof_StringId, std::string>>{{symbolsStore->InternString("label1").value(), "value1"}, {symbolsStore->InternString("label2").value(), "value2"}, {symbolsStore->InternString("label3").value(), "value3"}};
    ...
    auto callstack3 = std::vector<std::pair<ddog_prof_FunctionId, ddog_prof_MappingId>>({{frame1Id.value(), moduleId.value()}, {frame2Id.value(), moduleId.value()}, {frame5Id.value(), moduleId.value()}});
    auto labels3 = std::vector<std::pair<ddog_prof_StringId, std::string>>{{symbolsStore->InternString("label1").value(), "value1"}};
...
TEST(ProfileExporterTest, EnsureOnlyProfileWithSamplesIsWrittenToDisk)
{
    ...
    auto callstack1 = std::vector<std::pair<ddog_prof_FunctionId, ddog_prof_MappingId>>({{symbolsStore->InternFunction("frame1", "").value(), symbolsStore->InternMapping("module").value()}, {symbolsStore->InternFunction("frame2", "").value(), symbolsStore->InternMapping("module").value()}, {symbolsStore->InternFunction("frame3", "").value(), symbolsStore->InternMapping("module").value()}});
    auto labels1 = std::vector<std::pair<ddog_prof_StringId, std::string>>{{symbolsStore->InternString("label1").value(), "value1"}, {symbolsStore->InternString("label2").value(), "value2"}};
    auto sample1 = CreateSample(symbolsStore, firstRid,
                                callstack1,
                                labels1,
    ...
    auto callstack2 = std::vector<std::pair<ddog_prof_FunctionId, ddog_prof_MappingId>>({{symbolsStore->InternFunction("frame1", "").value(), symbolsStore->InternMapping("module").value()}, {symbolsStore->InternFunction("frame2", "").value(), symbolsStore->InternMapping("module").value()}, {symbolsStore->InternFunction("frame3", "").value(), symbolsStore->InternMapping("module").value()}, {symbolsStore->InternFunction("frame4", "").value(), symbolsStore->InternMapping("module").value()}});
    auto labels2 = std::vector<std::pair<ddog_prof_StringId, std::string>>{{symbolsStore->InternString("label1").value(), "value1"}, {symbolsStore->InternString("label2").value(), "value2"}, {symbolsStore->InternString("label3").value(), "value3"}};
...
TEST(ProfileExporterTest, EnsureTwoPprofFilesAreWrittenToDiskForTwoApplications)
{
    ...
    auto callstack2 = std::vector<std::pair<ddog_prof_FunctionId, ddog_prof_MappingId>>({{symbolsStore->InternFunction("frame1", "").value(), symbolsStore->InternMapping("module").value()}, {symbolsStore->InternFunction("frame2", "").value(), symbolsStore->InternMapping("module").value()}, {symbolsStore->InternFunction("frame3", "").value(), symbolsStore->InternMapping("module").value()}});
    auto labels2 = std::vector<std::pair<ddog_prof_StringId, std::string>>{{symbolsStore->InternString("label1").value(), "value1"}, {symbolsStore->InternString("label2").value(), "value2"}};
    auto sample2 = CreateSample(symbolsStore, secondRid,
                                callstack2,
                                labels2,
                                42);
...
TEST(ProfileExporterTest, MakeSureNoCrashForReallyLongCallstack)
{
    ...
    auto labels = std::vector<std::pair<ddog_prof_StringId, std::string>>{{symbolsStore->InternString("label1").value(), "value1"}, {symbolsStore->InternString("label2").value(), "value2"}};
