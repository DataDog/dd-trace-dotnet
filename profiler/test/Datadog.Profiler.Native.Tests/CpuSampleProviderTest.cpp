...
TEST(CpuSampleProviderTest, WriteAndReadSample)
{
    ...
    RawSampleTransformer rawSampleTransformer{&frameStore, &appDomainStore, &runtimeIdStore, symbolsStore};
    ...
    std::vector<ddog_prof_FunctionId2> expectedFunctionIds =
        {
    ...
    std::vector<ddog_prof_MappingId2> expectedModulesIds =
    {
