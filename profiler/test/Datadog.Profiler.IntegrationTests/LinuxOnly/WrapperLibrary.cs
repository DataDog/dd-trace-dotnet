// <copyright file="WrapperLibrary.cs" company="Datadog">
...
namespace Datadog.Profiler.IntegrationTests.LinuxOnly
{
    ...
    public class WrapperLibrary
    {
        ...
        public WrapperLibrary(ITestOutputHelper output)
        {
            _output = output;
        }
        ...
        public void EnsureProfilerIsDeactivatedIfNoWrapperLibrary(string appName, string framework, string appAssembly)
        {
            ...
            lines.Should().Contain("It's not safe to start the profiler. See previous log messages for more info.");
        }
    }
}
