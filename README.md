...
Windows MSI and NuGet packages||[![Build Status](https://dev.azure.com/datadog-apm/dd-trace-dotnet/_apis/build/status/Windows/windows-packages?branchName=master)](https://dev.azure.com/datadog-apm/dd-trace-dotnet/_build/latest?definitionId=8)
