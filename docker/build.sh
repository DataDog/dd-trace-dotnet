...
for config in Debug Release ; do
    ...
    for sample in Samples.AspNetCoreMvc2 Samples.Elasticsearch Samples.RedisCore Samples.SqlServer Samples.MongoDB Samples.HttpMessageHandler Samples.Npgsql ; do
