...
Name | Required |
---------|----------------|
Name | `Message`; `ServiceBusProcessor.ProcessMessage`; `ServiceBusSessionProcessor.ProcessSessionMessage`
Type | `custom`
### Tags
Name | Required |
---------|----------------|
