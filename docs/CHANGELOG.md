...
## Changes
* IBM.Data.Db2 does not get loaded by tracer (#1494)
* CallTarget abstract methods support (#2120)
* Pass CallTargetState ByRef in OnMethodEnd and OnMethodEndAsync (#2169)
* code clean up in `SpanContextPropagator` (#2180)
...
* DuckType Best Practices in Readme.md (#2223)
...
* Add additional constructor to TracerSettings (#2266)
* Fix shared installer version (#2277)
...
* more clean up in `SpanContextPropagator.Extract()` (#2261)

## Build / Test
* Add Source Generator for TagsList (#2076)
* [Test Package Versions Bump] Updating package versions (#2145)
* Small pipeline reliability updates (#2149)
* Fix flaky test in AspNetVersionConflictTests (#2189)
* Fix Datadog.Trace.sln build issues (#2192)
* Exploration Tests on Linux (#2193)
* Add more tests around public API (#2202)
* Rewrite logs injection benchmarks (#2204)
* Stop using benchmark csv and support params (#2207)
* Update the version in the shared installer (#2209)
* [Test Package Versions Bump] Updating package versions (#2219)
* More retries in the build pipeline (#2226)
* Disable parallelization in runtime metrics tests (#2227)
* Remove ConcurrentDictionary in SpanStatisticalTests (#2229)
* [Test Package Versions Bump] Updating package versions (#2231)
* Add a Nuke target to update snapshots (#2232)
* Fix benchmark allocation comparison (#2236)
* [AppSec] Improve testing (#2239)
* Add regression tests for the tool command line arguments (#2243)
* [Test Package Versions Bump] Updating package versions (#2246)
* Add workaround to support VS2022 with Nuke (#2252)
* Run the CLI integration tests (#2253)
* Update auto-generated tags files (#2258)
* clean up SourceGenerators and Analyzers projects (#2262)
* Don't build CLI integration tests for net461 (#2263)
* Run GraphQL tests against latest package versions (#2264)
* [Test Package Versions Bump] Updating package versions (#2276)
