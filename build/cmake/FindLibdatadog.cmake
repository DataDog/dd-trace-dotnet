...
set(LIBDATADOG_VERSION "v1.0.0" CACHE STRING "libdatadog version")

if (CMAKE_SYSTEM_PROCESSOR STREQUAL aarch64 OR CMAKE_SYSTEM_PROCESSOR STREQUAL arm64)
    if (DEFINED ENV{IsAlpine} AND "$ENV{IsAlpine}" MATCHES "true")
        set(SHA256_LIBDATADOG "4b02d8d9a4c600ad6ffc2103873db253df84d5e8672d2c41e05fa0e27089cb84" CACHE STRING "libdatadog sha256")
        set(FILE_TO_DOWNLOAD libdatadog-aarch64-alpine-linux-musl.tar.gz)
    else()
        set(SHA256_LIBDATADOG "cb8bb4f631605542bda17b225195a85e20ea5aacd3179f13b8737f06194f82d8" CACHE STRING "libdatadog sha256")
        set(FILE_TO_DOWNLOAD libdatadog-aarch64-unknown-linux-gnu.tar.gz)
    endif()
else()
    if (DEFINED ENV{IsAlpine} AND "$ENV{IsAlpine}" MATCHES "true")
        set(SHA256_LIBDATADOG "0c0d92edd499b2cad16cd59616bcecaaa0f93dccbea01efaeef14b7fd6cbb91e" CACHE STRING "libdatadog sha256")
        set(FILE_TO_DOWNLOAD libdatadog-${CMAKE_SYSTEM_PROCESSOR}-alpine-linux-musl.tar.gz)
    else()
        set(SHA256_LIBDATADOG "573f494ca17ad0bd784ba23c4b53e9ee6f4d2b13855e986c5beb433a134784c6" CACHE STRING "libdatadog sha256")
