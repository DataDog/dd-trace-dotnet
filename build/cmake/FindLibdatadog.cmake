...
set(LIBDATADOG_VERSION "v7.0.0" CACHE STRING "libdatadog version")

if (CMAKE_SYSTEM_PROCESSOR STREQUAL aarch64 OR CMAKE_SYSTEM_PROCESSOR STREQUAL arm64)
    if (DEFINED ENV{IsAlpine} AND "$ENV{IsAlpine}" MATCHES "true")
        set(SHA256_LIBDATADOG "9e3e5adb45c3a36f22005c2ace34d5c0f23bbd7fe9c9de6025e2645955ee3ed9" CACHE STRING "libdatadog sha256")
        set(FILE_TO_DOWNLOAD libdatadog-aarch64-alpine-linux-musl.tar.gz)
    else()
        set(SHA256_LIBDATADOG "13e2f4ccfebcfef501c84cdbd12782c1b0e9065fa8a2f47b513fc246644851cf" CACHE STRING "libdatadog sha256")
        set(FILE_TO_DOWNLOAD libdatadog-aarch64-unknown-linux-gnu.tar.gz)
    endif()
else()
    if (DEFINED ENV{IsAlpine} AND "$ENV{IsAlpine}" MATCHES "true")
        set(SHA256_LIBDATADOG "c0d6457efec7e2f73b81ba837a06e07e675d099c3be727e58e2ae1f5416c13ab" CACHE STRING "libdatadog sha256")
        set(FILE_TO_DOWNLOAD libdatadog-${CMAKE_SYSTEM_PROCESSOR}-alpine-linux-musl.tar.gz)
    else()
        set(SHA256_LIBDATADOG "f94a36d8a0061486814a23a2bc710dc7c5312be6259d6dfb02b6489ba346f2e0" CACHE STRING "libdatadog sha256")
