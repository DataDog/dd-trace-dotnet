...
set(LIBDATADOG_VERSION "v1.2.23" CACHE STRING "libdatadog version")

if(CMAKE_SYSTEM_NAME STREQUAL "Darwin")
    # For Darwin, we'll download both architectures and combine them
    set(SHA256_LIBDATADOG_ARM64 "113d23295d5e46fee74a193935e3441688f5ddf68b231c6ff3de15602c3af5c0" CACHE STRING "libdatadog arm64 sha256")
    set(SHA256_LIBDATADOG_X86_64 "2b7f0689d57003fe382489f1bb140c4f5ae98789cd4b39fe2e6f6990e4e67d8d" CACHE STRING "libdatadog x86_64 sha256")
    ...
    if(CMAKE_SYSTEM_PROCESSOR STREQUAL "aarch64" OR CMAKE_SYSTEM_PROCESSOR STREQUAL "arm64")
        if(DEFINED ENV{IsAlpine} AND "$ENV{IsAlpine}" MATCHES "true")
            set(SHA256_LIBDATADOG "d688c756fc2853e06734e17dfa6ab663230ca74cf49af37b566c3ae2189805e6" CACHE STRING "libdatadog sha256")
            set(FILE_TO_DOWNLOAD libdatadog-aarch64-alpine-linux-musl.tar.gz)
        else()
            set(SHA256_LIBDATADOG "0fe23df5305b602d7362317cdcb459425cdc8a512b003fc1fc00b95177e1bf9c" CACHE STRING "libdatadog sha256")
            set(FILE_TO_DOWNLOAD libdatadog-aarch64-unknown-linux-gnu.tar.gz)
        endif()
    else()
        if(DEFINED ENV{IsAlpine} AND "$ENV{IsAlpine}" MATCHES "true")
            set(SHA256_LIBDATADOG "8c0162ec893f132d582c50a581b776ad9edf1fb374de7012c274069eb755bc05" CACHE STRING "libdatadog sha256")
            set(FILE_TO_DOWNLOAD libdatadog-${CMAKE_SYSTEM_PROCESSOR}-alpine-linux-musl.tar.gz)
        else()
            set(SHA256_LIBDATADOG "c5e08f47a3ba967fc03013063ef506448a5e709e0a67d6ba2e32ec95ce35a43c" CACHE STRING "libdatadog sha256")
