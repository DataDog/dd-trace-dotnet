...
//       Info(
//           "Profiler disabled: module name \"{}\" does not match {}
//           environment " "variable", process_name, kProcessesEnvironmentName);
//       return E_FAIL;
//     }
//   }
...
//       &this->info_);
//   if (FAILED(hr)) {
//     Warn("Profiler disabled: interface ICorProfilerInfo3 or higher not
//     found.");
//   }
...
//     // We cannot obtain writeable metadata interfaces on Windows Runtime
//     modules
//     // or instrument their IL. We must never try to add assembly references
//     to
...
// HRESULT STDMETHODCALLTYPE CorProfiler::ModuleUnloadFinished(ModuleID
// moduleId,
//                                                             HRESULT hrStatus)
//                                                             {
...
//   HRESULT hr = this->info_->GetFunctionInfo(function_id, &class_id,
//   &module_id,
//                                             &function_token);
//   RETURN_OK_IF_FAILED(hr);
...
//         wrapper_method_ref =
//             DefineMethodSpec(module_metadata->metadata_emit,
//             wrapper_method_ref,
//                              target.signature);
//       }
...
//       Info(
//           "JITCompilationStarted() replaced calls from {}.{}() to {}.{}()
//           {:x} " "with calls to {}.{}() {:x}.", caller.type.name,
//           caller.name, method_replacement.target_method.type_name,
