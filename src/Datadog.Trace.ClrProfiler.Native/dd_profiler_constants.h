...
namespace trace {
  ...
  inline WSTRING managed_profiler_full_assembly_version = "Datadog.Trace.ClrProfiler.Managed, Version=1.20.1.0, Culture=neutral, PublicKeyToken=def86d061d0d2eeb"_W;
