...
public:
    ...
    {
        Logger<TLoggerPolicy>::Instance()->Debug(LogToString(args...));
    }
    template <typename... Args>
    static void Info(const Args... args)
    {
        Logger<TLoggerPolicy>::Instance()->Info(LogToString(args...));
    }
    template <typename... Args>
    static void Warn(const Args... args)
    {
        Logger<TLoggerPolicy>::Instance()->Warn(LogToString(args...));
    }
    template <typename... Args>
    static void Error(const Args... args)
    {
        Logger<TLoggerPolicy>::Instance()->Error(LogToString(args...));
    }
    template <typename... Args>
    static void Critical(const Args... args)
    {
        Logger<TLoggerPolicy>::Instance()->Critical(LogToString(args...));
    }

    static void EnableDebug()
    {
        Logger<TLoggerPolicy>::Instance()->EnableDebugLog();
    }
    static bool IsDebugEnabled()
    {
        return Logger<TLoggerPolicy>::Instance()->IsDebugLogEnabled();
    }
