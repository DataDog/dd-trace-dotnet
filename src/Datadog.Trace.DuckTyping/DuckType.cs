            ...
            lock (_locker)
            {
                try
                {
                    ...
                    if (_moduleBuilder is null)
                    {
                        ...
                        _moduleBuilder = _assemblyBuilder.DefineDynamicModule("MainModule._" + id);
                    }
                    ...
                    string proxyTypeName = $"{assembly}.{proxyDefinitionType.FullName.Replace(".", "_").Replace("+", "__")}____{targetType.FullName.Replace(".", "_").Replace("+", "__")}_{Guid.NewGuid().ToString("N")}";
