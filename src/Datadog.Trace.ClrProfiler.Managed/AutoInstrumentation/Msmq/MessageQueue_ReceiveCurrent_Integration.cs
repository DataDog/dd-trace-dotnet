...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.Msmq
{
    ...
    public class MessageQueue_ReceiveCurrent_Integration
    {
        ...
        {
            var scope = MsmqCommon.CreateScope(Tracer.Instance, action != 0 ? CommandPeek : CommandConsume, SpanKinds.Producer, instance.QueueName, instance.FormatName, instance.Label, instance.LastModifyTime, messageQueueTransaction != null, string.Empty, instance.Transactional, out MsmqTags tags);
