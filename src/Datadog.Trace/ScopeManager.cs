...
namespace Datadog.Trace
{
    internal class ScopeManager : IScopeManager
    {
        ...
        public void Close(Scope scope)
        {
            ...
            if (current != null)
            {
                ScopeClosed?.Invoke(this, new SpanEventArgs(scope.Span));
