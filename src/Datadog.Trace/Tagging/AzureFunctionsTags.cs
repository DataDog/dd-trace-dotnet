...
namespace Datadog.Trace.Tagging
{
    internal class AzureFunctionsTags : InstrumentationTags
    {
        public static readonly IEnumerable<Property<AzureFunctionsTags, string>> AzureFunctionsExtraTags = new List<Property<AzureFunctionsTags, string>>()
        {
            ...
            new Property<AzureFunctionsTags, string>("az.triggertype", t => t.TriggerType, (t, v) => t.TriggerType = v),
            new Property<AzureFunctionsTags, string>("az.name", t => t.ShortName, (t, v) => t.ShortName = v),
            new Property<AzureFunctionsTags, string>("az.method", t => t.FullName, (t, v) => t.FullName = v),
            new Property<AzureFunctionsTags, string>("az.binding", t => t.BindingSource, (t, v) => t.BindingSource = v)
        };
