...
namespace Datadog.Trace.Agent.NamedPipes
{
    internal class NameValueHeaderValue : ICloneable
    {
        ...
        public static bool TryParse(string input, out NameValueHeaderValue parsedValue)
        {
            ...
            if (GenericHeaderParser.SingleValueNameValueParser.TryParseValue(input, null, ref index, out var output))
            {
        ...
        private static void CheckValueFormat(string value)
        {
            ...
            {
                throw new FormatException(string.Format(System.Globalization.CultureInfo.InvariantCulture, "Invalid header value {0}", value));
            }
        }
