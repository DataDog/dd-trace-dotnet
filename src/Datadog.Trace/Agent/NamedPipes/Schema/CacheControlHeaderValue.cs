...
{
    internal class CacheControlHeaderValue : ICloneable
    {
        ...
        public ICollection<string> NoCacheHeaders => _noCacheHeaders ??= new ICollection<string>(s_checkIsValidToken);
        ...
        public ICollection<string> PrivateHeaders => _privateHeaders ??= new ICollection<string>(s_checkIsValidToken);
        ...
        public ICollection<NameValueHeaderValue> Extensions => _extensions ??= new ICollection<NameValueHeaderValue>();
                                                    ...
                                                    ref ICollection<string>? destination)
        {
            ...
            while (current < maxLength)
            {
                ...
                destination ??= new ICollection<string>(s_checkIsValidToken);
        ...
        private static void AppendValues(StringBuilder sb, ICollection<string> values)
        {
            bool first = true;
