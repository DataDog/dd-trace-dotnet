...
{
    internal class MediaTypeHeaderValue : ICloneable
    {
                                               ...
                                               Func<MediaTypeHeaderValue> mediaTypeCreator, out MediaTypeHeaderValue parsedValue)
        {
            ...
            if ((current < input.Length) && (input[current] == ';'))
            {
                ...
                int parameterLength = NameValueHeaderValue.GetNameValueListLength(input, current, ';',
                                                                                  (ICollection<NameValueHeaderValue>)mediaTypeHeader.Parameters);
        ...
        private static void CheckMediaTypeFormat(string mediaType, string parameterName)
        {
            ...
            {
                throw new ArgumentException("Argument can not be empty", parameterName);
            }
            ...
            {
                throw new FormatException(string.Format(System.Globalization.CultureInfo.InvariantCulture, "Header has invalid value: {0}", mediaType));
            }
        }
