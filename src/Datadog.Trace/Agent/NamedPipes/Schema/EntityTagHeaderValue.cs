...
{
    internal class EntityTagHeaderValue : ICloneable
    {
        ...
        public EntityTagHeaderValue(string tag, bool isWeak)
        {
            ...
            {
                throw new ArgumentException("Http argument is empty", nameof(tag));
            }
        ...
        public static bool TryParse(string input, out EntityTagHeaderValue parsedValue)
        {
            ...
            if (GenericHeaderParser.SingleValueEntityTagParser.TryParseValue(input, null, ref index, out var output))
            {
