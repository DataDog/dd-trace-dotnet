...
namespace Datadog.Trace.Agent.NamedPipes
{
    internal static class HeaderUtilities
    {
        ...
        internal static void CheckValidToken(string value, string parameterName)
        {
            ...
            // }
            // if (DatadogHttpRuleParser.GetTokenLength(value, 0) != value.Length)
            // {
        ...
        internal static void CheckValidComment(string value, string parameterName)
        {
            ...
            // }
            // int length = 0;
            // if ((DatadogHttpRuleParser.GetCommentLength(value, 0, out length) != HttpParseResult.Parsed) || (length != value.Length))
            // {
            //     throw new FormatException(string.Format(System.Globalization.CultureInfo.InvariantCulture, "Headers are invalid: {0}", value));
            // }
        }
        ...
        internal static void CheckValidQuotedString(string value, string parameterName)
        {
            ...
            // if (string.IsNullOrEmpty(value))
            // {
            //     throw new ArgumentException("Parameter may not be empty", parameterName);
            // }
            // 
            // int length = 0;
            // if ((DatadogHttpRuleParser.GetQuotedStringLength(value, 0, out length) != HttpParseResult.Parsed) || (length != value.Length))
            // {
            //     throw new FormatException(string.Format(System.Globalization.CultureInfo.InvariantCulture, "Headers are invalid: {0}", value));
            // }
        }
