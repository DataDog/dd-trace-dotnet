...
{
    internal class ContentDispositionHeaderValue : ICloneable
    {
        #region Fields
        ...
        public ICollection<NameValueHeaderValue> Parameters => _parameters ?? new List<NameValueHeaderValue>();
        ...
        internal static int GetDispositionTypeLength(string input, int startIndex, out object parsedValue)
        {
            ...
            if ((current < input.Length) && (input[current] == ';'))
            {
                ...
                int parameterLength = NameValueHeaderValue.GetNameValueListLength(input, current, ';',
                                                                                  (ICollection<NameValueHeaderValue>)contentDispositionHeader.Parameters);
        ...
        private DateTimeOffset? GetDate(string parameter)
        {
            ...
            {
                byte[] dateString = dateParameter.Value;
        ...
        private static bool IsQuoted(ICollection<char> value)
        {
            return
                value.Length > 1 &&
                value[0] == '"' &&
