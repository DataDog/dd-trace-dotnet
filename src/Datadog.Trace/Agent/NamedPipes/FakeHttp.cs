//------------------------------------------------------------------------------
// <auto-generated />
// This file was automatically generated, kind of.
//------------------------------------------------------------------------------
...
namespace Datadog.Trace.Agent.NamedPipes
{
    internal static class FakeHttp
    {
        ...
        public static byte[] SerializeHeaders(TraceRequest request)
        {
...
";
            ...
            headersOnly = $@"{request.Method} {request.Path} HTTP/{request.Version}
Host: {request.Host}
{headers}
...
";
            ...
            // var httpEncoder = Encoding.GetEncoding("ISO-8859-1");
            // httpEncoder = Encoding.ASCII;
            // var headersOnlyBytes = SerializeHeaders(request);
            // var messageEndBytes = new byte[] { 0x0d, 0x0a, 0x30, 0x0d, 0x0a, 0x0d, 0x0a };

            // var length =
            //     // messageEndBytes.Length +
            //     headersOnlyBytes.Length +
            ...
            //     // This payload
            //     System.IO.File.WriteAllText(System.IO.Path.Combine(basePath, $"http-text.txt"), httpEncoder.GetString(messageBuffer));
            //     // An example payload
