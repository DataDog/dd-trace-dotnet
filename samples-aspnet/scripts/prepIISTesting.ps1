...
function installDotnetTracer
{
    ...
    Start-Process "msiexec.exe" -Wait -ArgumentList '/I deploy\Datadog.Trace.ClrProfiler.WindowsInstaller\bin\Release\x64\en-us\datadog-dotnet-apm-1.9.1-prerelease-x64.msi'
}
