...
public static class Helpers
{
    ...
    /// <summary>
    /// IDatadogLogger stub with [CallerLineNumber]/[CallerFilePath] attributes.
    /// This is needed because removing .ToString() from an int argument would otherwise
    /// be ambiguous with the int sourceLine parameter in overload resolution.
    /// </summary>
    public static string LoggerDefinitions { get; } =
        ...
        namespace Datadog.Trace.Logging
        {
            ...
            internal interface IDatadogLogger
            {
                ...
                void Warning<T0, T1, T2, T3>(string messageTemplate, T0 property0, T1 property1, T2 property2, T3 property3, [CallerLineNumber] int sourceLine = 0, [CallerFilePath] string sourceFile = "");
                void Warning<T0, T1, T2, T3, T4>(string messageTemplate, T0 property0, T1 property1, T2 property2, T3 property3, T4 property4, [CallerLineNumber] int sourceLine = 0, [CallerFilePath] string sourceFile = "");
                ...
                void Error<T0, T1, T2, T3>(string messageTemplate, T0 property0, T1 property1, T2 property2, T3 property3, [CallerLineNumber] int sourceLine = 0, [CallerFilePath] string sourceFile = "");
                void Error<T0, T1, T2, T3, T4>(string messageTemplate, T0 property0, T1 property1, T2 property2, T3 property3, T4 property4, [CallerLineNumber] int sourceLine = 0, [CallerFilePath] string sourceFile = "");
                ...
                void ErrorSkipTelemetry<T0, T1, T2, T3>(string messageTemplate, T0 property0, T1 property1, T2 property2, T3 property3, [CallerLineNumber] int sourceLine = 0, [CallerFilePath] string sourceFile = "");
                void ErrorSkipTelemetry<T0, T1, T2, T3, T4>(string messageTemplate, T0 property0, T1 property1, T2 property2, T3 property3, T4 property4, [CallerLineNumber] int sourceLine = 0, [CallerFilePath] string sourceFile = "");
