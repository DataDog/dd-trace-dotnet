...
public class HashBasedDeduplicationTests
{
    ...
    public void GivenTwoIdenticalVulnerabilities_WhenAddedToDeduplication_OnlyOneIsStored()
    {
        ...
        Assert.True(instance.Add(new Vulnerability(VulnerabilityType.WeakHash, new Location("path.cs", 23), new Evidence("MD5", ranges1))));
        Assert.False(instance.Add(new Vulnerability(VulnerabilityType.WeakHash, new Location("path.cs", 23), new Evidence("MD5", ranges2))));
    }
    ...
    {
        var instance = new HashBasedDeduplication();
        Assert.True(instance.Add(new Vulnerability(VulnerabilityType.WeakHash, new Location("path.cs", 23), new Evidence("MD5"))));
        Assert.True(instance.Add(new Vulnerability(VulnerabilityType.WeakCipher, new Location("path.cs", 23), new Evidence("MD5"))));
    }
    ...
    public void GivenTwoDifferentVulnerabilitiesByFile_WhenAddedToDeduplication_BothAreStored()
    {
        var instance = new HashBasedDeduplication();
        Assert.True(instance.Add(new Vulnerability(VulnerabilityType.WeakHash, new Location("path.cs", 23), new Evidence("MD5"))));
        Assert.True(instance.Add(new Vulnerability(VulnerabilityType.WeakHash, new Location("path2.cs", 23), new Evidence("MD5"))));
    }
    ...
    public void GivenTwoDifferentVulnerabilitiesByLine_WhenAddedToDeduplication_BothAreStored()
    {
        var instance = new HashBasedDeduplication();
        Assert.True(instance.Add(new Vulnerability(VulnerabilityType.WeakHash, new Location("path.cs", 23), new Evidence("MD5"))));
        Assert.True(instance.Add(new Vulnerability(VulnerabilityType.WeakHash, new Location("path.cs", 24), new Evidence("MD5"))));
    }
    ...
    public void GivenTwoDifferentVulnerabilitiesByEvidence_WhenAddedToDeduplication_BothAreStored()
    {
        var instance = new HashBasedDeduplication();
        Assert.True(instance.Add(new Vulnerability(VulnerabilityType.WeakHash, new Location("path.cs", 23), new Evidence("MD5"))));
        Assert.True(instance.Add(new Vulnerability(VulnerabilityType.WeakHash, new Location("path.cs", 23), new Evidence("DES"))));
    }
    ...
    public void GivenTwoDifferentVulnerabilitiesByEvidenceRangeStart_WhenAddedToDeduplication_BothAreStored()
    {
        ...
        Assert.True(instance.Add(new Vulnerability(VulnerabilityType.WeakHash, new Location("path.cs", 23), new Evidence("MD5", ranges2))));
        Assert.True(instance.Add(new Vulnerability(VulnerabilityType.WeakHash, new Location("path.cs", 23), new Evidence("MD5", ranges1))));
    }
    ...
    public void GivenManyVulnerabilities_WhenAddedToDeduplication_CacheIsCleared()
    {
        ...
        {
            Assert.True(instance.Add(new Vulnerability(VulnerabilityType.WeakHash, new Location("pathNew.cs", i), new Evidence("MD5"))));
        }
