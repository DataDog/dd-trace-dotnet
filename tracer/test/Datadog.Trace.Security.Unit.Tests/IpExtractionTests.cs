...
namespace Datadog.Trace.Security.UnitTests
{
    public class IpExtractionTests
    {
        ...
        [InlineData("192.168.1.1", 80, new[] { "192.168.1.1", "172.16.32.41", "172.16.32.43" })]
        ...
        [InlineData("fe80::20e:cff:fe3b:883c", 80, new[] { "fe80::20e:cff:fe3b:883c", "fe80::5525:2a3f:6fa6:cd4e%14", "FE80::240:D0FF:FE48:4672" })]
