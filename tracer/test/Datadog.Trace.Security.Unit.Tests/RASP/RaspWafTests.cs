...
public class RaspWafTests : WafLibraryRequiredTest
{
    ...
    [InlineData("process.exe myparam", "process.exe myparam", "rasp-932-100", BlockingAction.BlockDefaultActionName, BlockingAction.BlockRequestType, AddressesConstants.ShellInjection)]
