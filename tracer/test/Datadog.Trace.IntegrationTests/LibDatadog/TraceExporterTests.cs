...
public class TraceExporterTests
{
    ...
    public async Task SendsTracesUsingDataPipeline(TestTransports transport)
    {
        ...
        var discovery = DiscoveryService.CreateUnmanaged(tracerSettings.Manager.InitialExporterSettings, new ContainerMetadata(containerId: null, entityId: null), new ServiceRemappingHash(null));
