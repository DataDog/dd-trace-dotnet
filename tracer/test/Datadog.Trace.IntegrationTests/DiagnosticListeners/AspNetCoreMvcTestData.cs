...
namespace Datadog.Trace.IntegrationTests.DiagnosticListeners
{
    public static class AspNetCoreMvcTestData
    {
        ...
        {
            { "/", 200, false, "GET /home/index", ConventionalChildTags(), 2, null, ConventionalChildTags(), null, null },
            { "/Home", 200, false, "GET /home/index", ConventionalChildTags(), 2, null, ConventionalChildTags(), null, null },
            { "/Home/Index", 200, false, "GET /home/index", ConventionalChildTags(), 2, null, ConventionalChildTags(), null, null },
            ...
            { "/MyTest", 200, false, "GET /mytest/index", ConventionalChildTags(controller: "mytest"), 2, null, ConventionalChildTags(controller: "mytest"), null, null },
            { "/MyTest/index", 200, false, "GET /mytest/index", ConventionalChildTags(controller: "mytest"), 2, null, ConventionalChildTags(controller: "mytest"), null, null },
            ...
            { "/Home/Error", 500, true, "GET /home/error", ConventionalChildTags(action: "error"), 2, null, ConventionalChildTags(action: "error"), null, null },
            { "/Home/UncaughtError", 500, true, "GET /home/uncaughterror", ConventionalChildTags(action: "uncaughterror"), 2, null, ConventionalChildTags(action: "uncaughterror"), null, null },
            { "/Home/BadHttpRequest", 400, true, "GET /home/badhttprequest", ConventionalChildTags(action: "badhttprequest"), 2, null, ConventionalChildTags(action: "badhttprequest"), null, null },
            { $"{CustomHandlerPrefix}/Home/Error", 500, true, $"GET {CustomHandlerPrefix}/home/error", ConventionalChildTags(), 2, null, ConventionalChildTags(action: "error"), null, null },
            { $"{CustomHandlerPrefix}/Home/UncaughtError", 500, true, $"GET {CustomHandlerPrefix}/home/uncaughterror", ConventionalChildTags(action: "uncaughterror"), 2, null, ConventionalChildTags(action: "uncaughterror"), null, null },
            { $"{CustomHandlerPrefix}/Home/BadHttpRequest", 500, true, $"GET {CustomHandlerPrefix}/home/badhttprequest", ConventionalChildTags(action: "badhttprequest"), 2, null, ConventionalChildTags(action: "badhttprequest"), null, null },
            { $"{CustomHandlerPrefix}/throws", 500, true, $"GET {CustomHandlerPrefix}/throws", EmptyTags(), 1, null, null, null, null },
            { $"{ExceptionPagePrefix}/Home/Error", 500, true, $"GET {ExceptionPagePrefix}/home/error", ConventionalChildTags(action: "error"), 2, null, ConventionalChildTags(action: "error"), null, null },
            { $"{ExceptionPagePrefix}/Home/BadHttpRequest", 400, true, $"GET {ExceptionPagePrefix}/home/badhttprequest", ConventionalChildTags(action: "badhttprequest"), 2, null, ConventionalChildTags(action: "badhttprequest"), null, null },
            { $"{ExceptionPagePrefix}/throws", 500, true, $"GET {ExceptionPagePrefix}/throws", EmptyTags(), 1, null, null, null, null },
            { $"{ReExecuteHandlerPrefix}/Home/Error", 500, true, $"GET {ReExecuteHandlerPrefix}/home/error", ConventionalChildTags(action: "error"), 3, null, ConventionalChildTags(action: "error"), $"GET {ReExecuteHandlerPrefix}/home/index", ConventionalChildTags() },
            { $"{ReExecuteHandlerPrefix}/Home/BadHttpRequest", 500, true, $"GET {ReExecuteHandlerPrefix}/home/badhttprequest", ConventionalChildTags(action: "badhttprequest"), 3, null, ConventionalChildTags(action: "badhttprequest"), $"GET {ReExecuteHandlerPrefix}/home/index", ConventionalChildTags() },
        ...
        public static TheoryData<string, int, bool, string, SerializableDictionary, int, string, SerializableDictionary, string, SerializableDictionary> WithExpandRouteTemplates => new()
        {
            ...
            { "/statuscode/201", 201, false, "GET /statuscode/{value}", StatusCodeParentTags(), 2, null, StatusCodeChildTags(), null, null },
            { "/I/dont/123/exist/", 404, false, "GET /i/dont/?/exist/", EmptyTags(), 1, null, null, null, null },
            { "/Home/Echo", 200, false, "GET /home/echo", ConventionalParentTags(action: "echo"), 2, null, ConventionalChildTags(action: "echo"), null, null },
            // ID-like parameters not expanded
            { "/Home/Echo/123", 200, false, "GET /home/echo/{id?}", ConventionalParentTags(action: "echo"), 2, null, ConventionalChildTags(action: "echo"), null, null },
            // non-ID-like parameters are expanded (oops)
            { "/Home/Echo/nope", 200, false, "GET /home/echo/nope", ConventionalParentTags(action: "echo"), 2, null, ConventionalChildTags(action: "echo"), null, null },
