...
namespace Datadog.Trace.IntegrationTests.DiagnosticListeners
{
    public static class AspNetCoreMvcTestData
    {
        ...
        {
            { "/", 200, false, "GET /", ConventionalParentTags(), 2, null, ConventionalChildTags(), null, null },
            { "/Home", 200, false, "GET /home", ConventionalParentTags(), 2, null, ConventionalChildTags(), null, null },
            { "/Home/Index", 200, false, "GET /home/index", ConventionalParentTags(), 2, null, ConventionalChildTags(), null, null },
            { "/Api/index", 200, false, "GET /api/index", ApiIndexParentTags(), 2, null, ApiIndexChildTags(), null, null },
            ...
            { "/MyTest", 200, false, "GET /mytest", ConventionalParentTags(), 2, null, ConventionalChildTags(controller: "mytest"), null, null },
            { "/MyTest/index", 200, false, "GET /mytest/index", ConventionalParentTags(), 2, null, ConventionalChildTags(controller: "mytest"), null, null },
            ...
            { "/Home/Echo/123", 200, false, "GET /home/echo/?", ConventionalParentTags(action: "echo"), 2, null, ConventionalChildTags(action: "echo"), null, null },
            ...
            { $"{ExceptionPagePrefix}/Home/BadHttpRequest", 400, true, $"GET {ExceptionPagePrefix}/home/badhttprequest", ConventionalParentTags(), 2, null, ConventionalChildTags(action: "badhttprequest"), null, null },
            { $"{ExceptionPagePrefix}/throws", 500, true, $"GET {ExceptionPagePrefix}/throws", EmptyTags(), 1, null, null, null, null },
            { $"{ReExecuteHandlerPrefix}/Home/Error", 500, true, $"GET {ReExecuteHandlerPrefix}/home/error", ConventionalParentTags(), 3, null, ConventionalChildTags(action: "error"), $"GET {ReExecuteHandlerPrefix}/", ConventionalChildTags() },
            { $"{ReExecuteHandlerPrefix}/Home/BadHttpRequest", 500, true, $"GET {ReExecuteHandlerPrefix}/home/badhttprequest", ConventionalParentTags(), 3, null, ConventionalChildTags(action: "badhttprequest"), $"GET {ReExecuteHandlerPrefix}/", ConventionalChildTags() },
            { $"{ReExecuteHandlerPrefix}/throws", 500, true, $"GET {ReExecuteHandlerPrefix}/throws", EmptyTags(), 2, $"GET {ReExecuteHandlerPrefix}/", ConventionalChildTags(), null, null },
