// <copyright file="SamplingPriorityTestsWithUpstreamService.cs" company="Datadog">
...
public class SamplingPriorityTestsWithUpstreamService
{
    ...
    public SamplingPriorityTestsWithUpstreamService()
    {
