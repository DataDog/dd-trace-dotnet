...
namespace Datadog.Trace.IntegrationTests
{
    public class SpanTagTests
    {
        ...
        public void SpanSampler_ShouldTag_OnSpanFinish()
        {
            ...
            {
                // drop it
                ((ISpanContextInternal)scope.Span.Context).TraceContext.SetSamplingPriority(SamplingPriorityValues.UserReject, SamplingMechanism.Manual);
            }
        ...
        public void SpanSampler_ShouldTagMultiple_OnSpanFinish()
        {
            ...
            {
                // drop it
                ((ISpanContextInternal)rootScope.Span.Context).TraceContext.SetSamplingPriority(SamplingPriorityValues.UserReject, SamplingMechanism.Manual);
        ...
        public void SpanSampler_ShouldTagMultiple_OnSpanFinish_WhenSamplingPriorityChanges()
        {
            ...
            using (var rootScope = _tracer.StartActive("root"))
            {
                ...
                ((ISpanContextInternal)rootScope.Span.Context).TraceContext.SetSamplingPriority(SamplingPriorityValues.UserKeep, SamplingMechanism.Manual);
        ...
        public void SpanSampler_ShouldNotTag_WhenSamplingPriority_IsNull()
        {
            ...
            var spanContext = Span.CreateSpanContext(4, 5, samplingPriority: null, serviceName: "serviceName");
