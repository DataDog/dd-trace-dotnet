...
set file=%solutionFolder%generated.windows.runsettings
...
echo ^<CORECLR_PROFILER_PATH_64^>%solutionFolder%\shared\bin\monitoring-home\win-x86\Datadog.Trace.ClrProfiler.Native.dll^</CORECLR_PROFILER_PATH_64^> >> %file%
...
echo ^<COR_PROFILER_PATH_64^>%solutionFolder%\shared\bin\monitoring-home\win-x86\Datadog.Trace.ClrProfiler.Native.dll^</COR_PROFILER_PATH_64^> >> %file%
