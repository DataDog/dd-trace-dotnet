...
namespace Datadog.Trace.Tests
{
    ...
    public class ActivityTests : IClassFixture<ActivityTests.ActivityFixture>
    {
        ...
        public void SimpleActivitiesAndSpansTest()
        {
            ...
            TracerInternal.Instance.ActiveScope.Should().BeNull();
            ...
            try
            {
                ...
                TracerInternal.Instance.ActiveScope.Should().NotBeNull();
                ...
                scopeFromActivity = TracerInternal.Instance.ActiveScope;
                ...
                using (var scope = TracerInternal.Instance.StartActive("New operation"))
                {
                    ...
                    try
                    {
                        ...
                        // Assert scope created from activity
                        scopeFromChildActivity = TracerInternal.Instance.ActiveScope;
                        ...
                        TracerInternal.Instance.ActiveScope.Should().NotBe(scope);
                    }
                    finally
                    {
                    ...
                    TracerInternal.Instance.ActiveScope.Should().Be(scope);
                }
            }
            finally
            {
        ...
        public void SimpleSpansAndActivitiesTest()
        {
            ...
            // Create datadog span as a child
            using (var scope = TracerInternal.Instance.StartActive("Root operation"))
            {
                TracerInternal.Instance.ActiveScope.Should().Be(scope);
                ...
                try
                {
                    ...
                    // Assert scope created from activity
                    var scopeFromChildActivity = TracerInternal.Instance.ActiveScope;
                    ...
                    // Create datadog span as a child
                    using (var childScope = TracerInternal.Instance.StartActive("New operation"))
                    {
                        // Assert TraceId and parent span id
