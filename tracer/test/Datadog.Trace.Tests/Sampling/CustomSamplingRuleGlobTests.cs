...
namespace Datadog.Trace.Tests.Sampling
{
    ...
    public class CustomSamplingRuleGlobTests
    {
        ...
        public void Constructs_With_Tags_Local()
        {
            ...
            var matchingSpan1 = TestSpanExtensions.CreateSpan(new SpanContext(1, 1, serviceName: "foo"), DateTimeOffset.Now);
            ...
            var matchingSpan2 = TestSpanExtensions.CreateSpan(new SpanContext(1, 1, serviceName: "foo"), DateTimeOffset.Now);
