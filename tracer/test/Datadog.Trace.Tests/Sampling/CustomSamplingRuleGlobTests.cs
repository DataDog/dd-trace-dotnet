...
namespace Datadog.Trace.Tests.Sampling
{
    ...
    public class CustomSamplingRuleGlobTests
    {
        ...
        public void Constructs_With_Tags_Local()
        {
            ...
            var matchingSpan1 = new Span(new SpanContextInternal(1, 1, serviceName: "foo"), DateTimeOffset.Now);
            ...
            var matchingSpan2 = new Span(new SpanContextInternal(1, 1, serviceName: "foo"), DateTimeOffset.Now);
