...
namespace Datadog.Trace.Tests.Sampling
{
    ...
    public class SpanSamplerTests
    {
        ...
        public void NoMatchingRules_ShouldNot_TagSpan()
        {
            ...
            var span = TestSpanExtensions.CreateSpan(new SpanContext(5, 6, samplingPriority: null, serviceName: "service-name"), DateTimeOffset.Now, operationName: "operation-name");
        ...
        public void MatchingRule_ButNoSample_ShouldReturnFalse()
        {
            ...
            var sampler = new SpanSampler(rules);
            var span = TestSpanExtensions.CreateSpan(new SpanContext(5, 6, samplingPriority: null, serviceName: "test"), DateTimeOffset.Now, operationName: "test");
        ...
        public void SingleCharacterReplacement_ShouldTagSpan_WhenMatches()
        {
            ...
            var span = TestSpanExtensions.CreateSpan(new SpanContext(5, 6, samplingPriority: null, serviceName: "service"), DateTimeOffset.Now, operationName: "operation");
        ...
        public void SingleCharacterReplacement_ShouldNotTagSpan_WhenNotMatches()
        {
            ...
            var sampler = new SpanSampler(new List<SpanSamplingRule> { rule });
            var span = TestSpanExtensions.CreateSpan(new SpanContext(5, 6, samplingPriority: null, serviceName: "serrvice"), DateTimeOffset.Now, operationName: "opperation");
        ...
        {
            var span = TestSpanExtensions.CreateSpan(new SpanContext(traceId, RandomIdGenerator.Shared.NextSpanId(), samplingPriority: null, serviceName: "service-name"), DateTimeOffset.Now, operationName: "operation-name");
            return span;
        }
    }
}
