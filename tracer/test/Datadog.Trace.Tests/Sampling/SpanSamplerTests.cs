...
namespace Datadog.Trace.Tests.Sampling
{
    ...
    public class SpanSamplerTests
    {
        ...
        {
            var span = new Span(new SpanContext(traceId, IdGenerator.Current.NextSpanId(), null, serviceName: "service-name"), DateTimeOffset.Now) { OperationName = "operation-name" };
            return span;
        }
    }
}
