...
namespace Datadog.Trace.Tests.Sampling
{
    ...
    public class CustomSamplingRuleRegexTests
    {
        ...
        public void Constructs_With_ResourceName()
        {
            ...
            var matchingSpan = TestSpanExtensions.CreateSpan(new SpanContext(1, 1, serviceName: "foo"), DateTimeOffset.Now, resourceName: "/api/v1/user/123");
            var nonMatchingSpan = TestSpanExtensions.CreateSpan(new SpanContext(1, 1, serviceName: "foo"), DateTimeOffset.Now, resourceName: "/api/v2/user/123");
        ...
        public void Constructs_With_Tags()
        {
            ...
            var matchingSpan = TestSpanExtensions.CreateSpan(new SpanContext(1, 1, serviceName: "foo"), DateTimeOffset.Now);
            matchingSpan.SetTag("http.method", "GET");
            matchingSpan.SetMetric("http.status_code", 200);

            var nonMatchingSpan1 = TestSpanExtensions.CreateSpan(new SpanContext(1, 1, serviceName: "foo"), DateTimeOffset.Now);
            nonMatchingSpan1.SetTag("http.method", "GET");

            var nonMatchingSpan2 = TestSpanExtensions.CreateSpan(new SpanContext(1, 1, serviceName: "foo"), DateTimeOffset.Now);
