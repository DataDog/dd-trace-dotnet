...
namespace Datadog.Trace.Tests
{
    public class AgentWriterTests
    {
        ...
        public async Task WriteTrace_2Traces_SendToApi()
        {
            ...
            var expectedData1 = MessagePack.MessagePackSerializer.Serialize(trace, SpanFormatterResolver.Instance);
            ...
            var expectedData2 = MessagePack.MessagePackSerializer.Serialize(trace, SpanFormatterResolver.Instance);
        ...
        public async Task AddsTraceKeepRateMetricToRootSpan()
        {
            ...
            var expectedData = MessagePack.MessagePackSerializer.Serialize(trace, SpanFormatterResolver.Instance);
        ...
        {
            return MessagePack.MessagePackSerializer.Serialize(trace, SpanFormatterResolver.Instance).Length;
        }
