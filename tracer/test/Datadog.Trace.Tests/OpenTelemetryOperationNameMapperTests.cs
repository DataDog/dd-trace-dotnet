...
namespace Datadog.Trace.Tests
{
    ...
    public class OpenTelemetryOperationNameMapperTests
    {
        ...
        {
            var span = TestSpanExtensions.CreateSpan(new SpanContext(1, 1), DateTimeOffset.UtcNow, tags: new OpenTelemetryTags());
        ...
        public void OperationName_ShouldFollow_PriorityOrder(string expectedActivityKind)
        {
            ...
            while (order.Count > 0)
            {
                ...
                // span.OperationName = null; // non-recording-spans experiment: setter removed
            }
        }
