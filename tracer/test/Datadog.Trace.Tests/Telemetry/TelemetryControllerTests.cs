...
public class TelemetryControllerTests
{
    ...
    public async Task TelemetryControllerShouldSendTelemetry()
    {
        ...
        controller.RecordTracerSettings(new ImmutableTracerSettingsInternal(new TracerSettingsInternal()), "DefaultServiceName");
        controller.Start();
    ...
    public async Task TelemetryControllerRecordsConfigurationFromTracerSettings()
    {
        ...
        var settings = new ImmutableTracerSettingsInternal(new TracerSettingsInternal());
