...
public class TelemetryFactoryTests
{
    ...
    public void TelemetryFactory_DisabledIfTelemetryIsDisabled()
    {
        ...
        var tracerSettings = new InternalImmutableTracerSettings(new InternalTracerSettings(NullConfigurationSource.Instance, NullConfigurationTelemetry.Instance));
