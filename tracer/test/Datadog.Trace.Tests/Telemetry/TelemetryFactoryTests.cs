...
public class TelemetryFactoryTests
{
    ...
    public void TelemetryFactory_DisabledIfTelemetryIsDisabled()
    {
        ...
        var tracerSettings = new ImmutableTracerSettingsInternal(new TracerSettingsInternal(NullConfigurationSource.Instance, NullConfigurationTelemetry.Instance, new OverrideErrorLog()));
