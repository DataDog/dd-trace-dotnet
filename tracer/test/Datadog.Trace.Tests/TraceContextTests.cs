...
namespace Datadog.Trace.Tests
{
    public class TraceContextTests
    {
        ...
        public void FlushPartialTraces(bool partialFlush)
        {
            ...
            {
                var span = new Span(new SpanContext(42, IdGenerator.Current.NextUInt64()), DateTimeOffset.UtcNow);

                traceContext.AddSpan(span);
                traceContext.CloseSpan(span);
            }

            var rootSpan = new Span(new SpanContext(42, IdGenerator.Current.NextUInt64()), DateTimeOffset.UtcNow);
        ...
        public void FullFlushShouldNotPropagateSamplingPriority()
        {
            ...
            Span CreateSpan() => new Span(new SpanContext(42, IdGenerator.Current.NextUInt64()), DateTimeOffset.UtcNow);
