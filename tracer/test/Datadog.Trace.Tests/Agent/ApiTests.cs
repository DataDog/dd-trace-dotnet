...
namespace Datadog.Trace.Tests.Agent
{
    public class ApiTests
    {
        ...
        public async Task SendTraceAsync_200OK_AllGood()
        {
            ...
            var api = new Api(factoryMock.Object, statsd: null, updateSampleRates: null, partialFlushEnabled: false, propagateProcessTags: true);
        ...
        public async Task SendTracesAsync_ShouldNotRetry_ForSpecificResponses(int statusCode)
        {
            ...
            var api = new Api(factoryMock.Object, statsd: null, updateSampleRates: null, partialFlushEnabled: false, propagateProcessTags: false);
        ...
        public async Task ExtractAgentVersionHeaderAndLogsWarning()
        {
            ...
            var api = new Api(factoryMock.Object, statsd: null, updateSampleRates: null, partialFlushEnabled: true, propagateProcessTags: false, logMock.Object);
        ...
        public async Task SetsDefaultSamplingRates()
        {
            ...
            var api = new Api(factoryMock.Object, statsd: null, updateSampleRates, partialFlushEnabled: false, propagateProcessTags: false);
        ...
        public void LogPartialFlushWarning(string agentVersion, bool partialFlushEnabled, bool expectedResult)
        {
            ...
            var api = new Api(factoryMock.Object, statsd: null, updateSampleRates: null, partialFlushEnabled, propagateProcessTags: false);
