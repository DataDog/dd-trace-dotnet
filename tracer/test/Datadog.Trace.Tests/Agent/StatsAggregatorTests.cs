...
namespace Datadog.Trace.Tests.Agent
{
    public class StatsAggregatorTests
    {
        ...
        public async Task CallFlushAutomatically()
        {
            ...
            try
            {
                ...
                while (stopwatch.Elapsed.Minutes < 1)
                {
                    ...
                    aggregator.Add(new Span(new SpanContextInternal(1, 1), DateTime.UtcNow));
        ...
        public async Task EmptyBuckets()
        {
            ...
            aggregator.Add(new Span(new SpanContextInternal(1, 2), DateTimeOffset.UtcNow));
        ...
        public async Task CreatesDistinctBuckets_TS003()
        {
            ...
            {
                var span = new Span(new SpanContextInternal(id, id), start);
        ...
        public async Task CollectsMeasuredSpans_TS004()
        {
            ...
            try
            {
                var parentSpan = new Span(new SpanContextInternal(1, 1, serviceName: "service"), start);
                ...
                var childSpan = new Span(new SpanContextInternal(parentSpan.Context, new TraceContext(Mock.Of<IDatadogTracer>()), "service"), start);
                childSpan.SetDuration(TimeSpan.FromMilliseconds(100));

                var measuredChildSpan1 = new Span(new SpanContextInternal(parentSpan.Context, new TraceContext(Mock.Of<IDatadogTracer>()), "service"), start);
                ...
                var measuredChildSpan2 = new Span(new SpanContextInternal(parentSpan.Context, new TraceContext(Mock.Of<IDatadogTracer>()), "service"), start);
        ...
        public async Task CollectsTopLevelSpans_TS005()
        {
            ...
            try
            {
                var simpleSpan = new Span(new SpanContextInternal(1, 1, serviceName: "service"), start);
                simpleSpan.SetDuration(TimeSpan.FromMilliseconds(100));

                var parentSpan = new Span(new SpanContextInternal(2, 2, serviceName: "service"), start);
                ...
                var snapshotSpan = new Span(new SpanContextInternal(5, 5, serviceName: "service"), start);
                ...
                var httpClientServiceSpan = new Span(new SpanContextInternal(parentSpan.Context, new TraceContext(Mock.Of<IDatadogTracer>()), "service-http-client"), start);
        ...
        public async Task RecordsSuccessesAndErrorsSeparately_TS006()
        {
            ...
            try
            {
                var success1Span = new Span(new SpanContextInternal(1, 1, serviceName: "service"), start);
                success1Span.SetDuration(TimeSpan.FromMilliseconds(100));

                var success2Span = new Span(new SpanContextInternal(2, 2, serviceName: "service"), start);
                success2Span.SetDuration(TimeSpan.FromMilliseconds(200));

                var errorSpan = new Span(new SpanContextInternal(3, 3, serviceName: "service"), start);
        ...
        public async Task RelativeErrorIsAccurate_TS009()
        {
            ...
            try
            {
                ...
                {
                    var span = new Span(new SpanContextInternal((ulong)i, (ulong)i, serviceName: "service"), start);
        ...
        private static ImmutableTracerSettingsInternal GetSettings(int? statsComputationIntervalSeconds = null)
        {
            var settings = statsComputationIntervalSeconds.HasValue
                               ? TracerSettingsInternal.Create(new() { { ConfigurationKeys.StatsComputationInterval, statsComputationIntervalSeconds.Value } })
