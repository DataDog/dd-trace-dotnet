...
namespace Datadog.Trace.Tests.Agent
{
    public class SpanBufferTests
    {
        ...
        {
            var buffer = new SpanBuffer(10 * 1024 * 1024, SpanFormatterResolver.Instance, TracesEncoding.DatadogV0);
        ...
        {
            var buffer = new SpanBuffer(10, SpanFormatterResolver.Instance, TracesEncoding.DatadogV0);
        ...
        {
            Assert.Throws<ArgumentException>(() => new SpanBuffer(4, SpanFormatterResolver.Instance, TracesEncoding.DatadogV0));
        }

        [Fact]
        public void TemporaryBufferSizeLimit()
        {
            var buffer = new SpanBuffer(256, SpanFormatterResolver.Instance, TracesEncoding.DatadogV0);
        ...
        public void IsFirstChunkInBuffer_FirstChunkIsTrue_SubsequentChunksAreFalse()
        {
            ...
            var buffer = new SpanBuffer(maxBufferSize: 256, mockResolver.Object, TracesEncoding.DatadogV0);
            var temporaryBuffer = new byte[256];
