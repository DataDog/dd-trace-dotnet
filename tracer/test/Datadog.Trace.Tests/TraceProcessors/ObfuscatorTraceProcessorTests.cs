...
namespace Datadog.Trace.Tests.TraceProcessors
{
    ...
    {
        // https://github.com/DataDog/dd-trace-java/blob/35487fa08f16503105b2ff37fb084ffa5c894f24/internal-api/src/test/groovy/datadog/trace/api/normalize/SQLNormalizerTest.groovy
        ...
        public static IEnumerable<object[]> GetSqlObfuscatedQuery()
        {
            ...
            yield return new object[] { "SELECT * FROM TABLE WHERE userId = 'abc\\'1287\\'681\\'\\'\\'\\'964'", "SELECT * FROM TABLE WHERE userId = ?" };
            yield return new object[] { "SELECT * FROM TABLE WHERE userId IN (\'a\', \'b\', \'c\')", "SELECT * FROM TABLE WHERE userId IN (?, ?, ?)" };
            yield return new object[] { "SELECT * FROM TABLE WHERE userId IN (\'abc\\'1287681\\'964\', \'abc\\'1287\\'681\\'\\'\\'\\'964\', \'abc\\'1287\\'681\\'964\')", "SELECT * FROM TABLE WHERE userId IN (?, ?, ?)" };
            ...
            yield return new object[] { "INSERT INTO \"VALUE\" (\"col1\", \"col2\", \"col3\") VALUES (\'blah\',12983,X'ff')", "INSERT INTO \"VALUE\" (\"col1\", \"col2\", \"col3\") VALUES (?,?,?)" };
            yield return new object[] { "INSERT INTO VALUE (col1,col2,col3) VALUES (\'blah\',12983,X'ff')", "INSERT INTO VALUE (col1,col2,col3) VALUES (?,?,?)" };
            yield return new object[] { "INSERT INTO VALUE (col1,col2,col3) VALUES (12983,X'ff',\'blah\')", "INSERT INTO VALUE (col1,col2,col3) VALUES (?,?,?)" };
            yield return new object[] { "INSERT INTO VALUE (col1,col2,col3) VALUES (X'ff',\'blah\',12983)", "INSERT INTO VALUE (col1,col2,col3) VALUES (?,?,?)" };
            yield return new object[] { "INSERT INTO VALUE (col1,col2,col3) VALUES ('a',\'b\',1)", "INSERT INTO VALUE (col1,col2,col3) VALUES (?,?,?)" };
            yield return new object[] { "INSERT INTO VALUE (col1, col2, col3) VALUES ('a',\'b\',1)", "INSERT INTO VALUE (col1, col2, col3) VALUES (?,?,?)" };
            yield return new object[] { "INSERT INTO VALUE ( col1, col2, col3 ) VALUES ('a',\'b\',1)", "INSERT INTO VALUE ( col1, col2, col3 ) VALUES (?,?,?)" };
            yield return new object[] { "INSERT INTO VALUE (col1,col2,col3) VALUES ('a', \'b\' ,1)", "INSERT INTO VALUE (col1,col2,col3) VALUES (?, ? ,?)" };
            yield return new object[] { "INSERT INTO VALUE (col1, col2, col3) VALUES ('a', \'b\', 1)", "INSERT INTO VALUE (col1, col2, col3) VALUES (?, ?, ?)" };
            yield return new object[] { "INSERT INTO VALUE ( col1, col2, col3 ) VALUES ('a', \'b\', 1)", "INSERT INTO VALUE ( col1, col2, col3 ) VALUES (?, ?, ?)" };
            yield return new object[] { "INSERT INTO VALUE (col1,col2,col3) VALUES (X'ff',\'罿潯罿潯罿潯罿潯罿潯\',12983)", "INSERT INTO VALUE (col1,col2,col3) VALUES (?,?,?)" };
            yield return new object[] { "INSERT INTO VALUE (col1,col2,col3) VALUES (X'ff',\'罿\',12983)", "INSERT INTO VALUE (col1,col2,col3) VALUES (?,?,?)" };
            yield return new object[] { "SELECT 3 AS NUCLEUS_TYPE,A0.ID,A0.\"NAME\" FROM \"VALUE\" A0", "SELECT ? AS NUCLEUS_TYPE,A0.ID,A0.\"NAME\" FROM \"VALUE\" A0" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > .9999", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > 0.9999", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > -0.9999", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > -1e6", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > +1e6", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > +255", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > +6.34F", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > +6f", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > +0.5D", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > -1d", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > x'ff'", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > X'ff'", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > 0xff", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \'\'", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \' \'", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \'  \'", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \' \\\' \'", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \' \\\'Бегите, глупцы \'", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \' x \'", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \' x x\'", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \' x\\\'ab x\'", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \' \\\' 0xf \'", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?" };
            yield return new object[] { "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \'5,123\'", "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?" };
            yield return new object[] { "CREATE TABLE S_H2 (id INTEGER not NULL, PRIMARY KEY ( id ))", "CREATE TABLE S_H2 (id INTEGER not NULL, PRIMARY KEY ( id ))" };
            yield return new object[] { "CREATE TABLE S_H2 ( id INTEGER not NULL, PRIMARY KEY ( id ) )", "CREATE TABLE S_H2 ( id INTEGER not NULL, PRIMARY KEY ( id ) )" };
            yield return new object[] { "SELECT * FROM TABLE WHERE name = 'O''Brady'", "SELECT * FROM TABLE WHERE name = ?" };
            yield return new object[] { "INSERT INTO visits VALUES (2, 8, '2013-01-02', 'rabies shot')", "INSERT INTO visits VALUES (?, ?, ?, ?)" };
            yield return new object[]
            {
                @"SELECT
            ...
            yield return new object[] { @"DROP VIEW IF EXISTS v_country_all; GO CREATE VIEW v_country_all AS SELECT * FROM country;", @"DROP VIEW IF EXISTS v_country_all; GO CREATE VIEW v_country_all AS SELECT * FROM country;" };
            yield return new object[]
            {
            ...
            yield return new object[] { "SELECT * FROM TABLE WHERE userId = ',' and foo=foo.bar", "SELECT * FROM TABLE WHERE userId = ? and foo=foo.bar" };
            yield return new object[] { "SELECT * FROM TABLE WHERE userId =     ','||foo.bar", "SELECT * FROM TABLE WHERE userId =     ?||foo.bar" };
            yield return new object[]
            {
        ...
        {
            var actualValue = Internal.Processors.ObfuscatorTraceProcessor.ObfuscateSqlResource(inValue);
