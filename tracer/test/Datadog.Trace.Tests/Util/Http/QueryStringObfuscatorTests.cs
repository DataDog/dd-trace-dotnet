...
namespace Datadog.Trace.Tests.Util.Http
{
    ...
    public class QueryStringObfuscatorTests
    {
        ...
        {
            var queryStringObfuscator = new QueryStringObfuscator.Obfuscator(null);
        ...
        {
            var queryStringObfuscator = new QueryStringObfuscator.Obfuscator(QueryStringObfuscator.DefaultObfuscationQueryStringRegex);
        ...
        {
            var queryStringObfuscator = new QueryStringObfuscator.Obfuscator(@"(?i)(?:p(?:ass)?w(?:or)?d|pass(?:_?phrase)?|secret|(?:api_?|private_?|public_?|access_?|secret_?)key(?:_?id)?|authentic\d*)(?:\s*=[^&]+|""\s*:\s*""[^""]+"")|[a-z0-9\._\-]{100,}");
        ...
        {
            var querystringObfuscator = new Mock<QueryStringObfuscator.Obfuscator>(() => new QueryStringObfuscator.Obfuscator(@"\[(.*?)\]((?:.\s*)*?)\[\/\1\]"));
            querystringObfuscator.Setup(q => q.Log()).Verifiable();
            ...
            querystringObfuscator.Verify(o => o.Log(), Times.Once);
        }
    }
}
