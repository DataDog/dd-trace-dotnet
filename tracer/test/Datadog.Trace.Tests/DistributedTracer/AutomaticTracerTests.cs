...
namespace Datadog.Trace.Tests.DistributedTracer
{
    ...
    public class AutomaticTracerTests
    {
        ...
        public void GetSpanContext_NoChild()
        {
            ...
            automaticTracer.SetDistributedTrace(new InternalSpanContext(1, 2));
        ...
        public void GetSpanContext()
        {
            ...
            var expectedSpanContext = new InternalSpanContext((TraceId)1, 2, InternalSamplingPriorityValues.UserKeep, "Service", "Origin");
        ...
        public void SetSpanContext()
        {
            ...
            var expectedSpanContext = new InternalSpanContext(1, 2);
        ...
        public void SetSamplingPriority_NoChild()
        {
            ...
            ((IDistributedTracer)automaticTracer).SetSamplingPriority(InternalSamplingPriorityValues.UserKeep);
        }
        ...
        public void SetSamplingPriority()
        {
            ...
            manualTracer.Verify(t => t.SetSamplingPriority(InternalSamplingPriorityValues.UserKeep), Times.Once);
        }
        ...
        public void GetDistributedTrace()
        {
            ...
            using (var scope = InternalTracer.Instance.StartActive("Test"))
            {
