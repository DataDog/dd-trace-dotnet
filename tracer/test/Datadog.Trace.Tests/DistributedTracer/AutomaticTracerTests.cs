...
namespace Datadog.Trace.Tests.DistributedTracer
{
    ...
    public class AutomaticTracerTests
    {
        ...
        public void SetSamplingPriority_NoChild()
        {
            ...
            ((IDistributedTracer)automaticTracer).SetSamplingPriority(SamplingPriorityInternal.UserKeep);
        }
        ...
        public void SetSamplingPriority()
        {
            ...
            manualTracer.Verify(t => t.SetSamplingPriority(SamplingPriorityInternal.UserKeep), Times.Once);
        }
