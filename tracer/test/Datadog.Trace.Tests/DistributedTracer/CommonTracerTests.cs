...
namespace Datadog.Trace.Tests.DistributedTracer
{
    ...
    public class CommonTracerTests
    {
        ...
        public void SetSamplingPriority()
        {
            ...
            scope.Span.Context.TraceContext.SamplingDecision?.Priority.Should().Be(expectedSamplingPriority, "SetSamplingPriority should have successfully set the active trace sampling priority");
        }
