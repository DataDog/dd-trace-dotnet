...
namespace Datadog.Trace.Tests.DistributedTracer
{
    public class ManualTracerTests
    {
        ...
        public void SetSamplingPriority()
        {
            ...
            ((IDistributedTracer)manualTracer).SetSamplingPriority(InternalSamplingPriorityValues.UserKeep);

            automaticTracer.Verify(t => t.SetSamplingPriority(InternalSamplingPriorityValues.UserKeep), Times.Once());
        }
