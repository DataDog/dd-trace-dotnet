...
namespace Datadog.Trace.Tests.DistributedTracer
{
    public class ManualTracerTests
    {
        ...
        {
            var expectedSpanContext = new SpanContext(1, 2, SamplingPriorityInternal.UserKeep, "Service", "Origin");
        ...
        public void SetSamplingPriority()
        {
            ...
            ((IDistributedTracer)manualTracer).SetSamplingPriority(SamplingPriorityInternal.UserKeep);

            automaticTracer.Verify(t => t.SetSamplingPriority(SamplingPriorityInternal.UserKeep), Times.Once());
        }
