// <copyright file="DebuggerSnapshotGenericTypesTests.cs" company="Datadog">
...
{
    [UsesVerify]
    public class DebuggerSnapshotGenericTypesTests
    {
        static DebuggerSnapshotGenericTypesTests()
        {
