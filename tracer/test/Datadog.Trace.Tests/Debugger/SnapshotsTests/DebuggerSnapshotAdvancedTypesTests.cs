// <copyright file="DebuggerSnapshotAdvancedTypesTests.cs" company="Datadog">
...
{
    [UsesVerify]
    public class DebuggerSnapshotAdvancedTypesTests
    {
        static DebuggerSnapshotAdvancedTypesTests()
        {
