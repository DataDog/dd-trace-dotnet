// <copyright file="DebuggerSnapshotPropertyFieldTests.cs" company="Datadog">
...
{
    [UsesVerify]
    public class DebuggerSnapshotPropertyFieldTests
    {
        static DebuggerSnapshotPropertyFieldTests()
        {
