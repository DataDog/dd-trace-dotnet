...
public class DynamicInstrumentationTests
{
    ...
    public async Task DebuggerEnabled_ServicesCalled()
    {
        ...
        var debugger = DynamicInstrumentation.Create(settings, string.Empty, discoveryService, rcmSubscriptionManagerMock, lineProbeResolver, snapshotUploader, diagnosticsUploader, probeStatusPoller, updater, new DogStatsd.NoOpStatsd());
