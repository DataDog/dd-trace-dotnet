...
namespace Datadog.Trace.Tests.Propagators
{
    public class DatadogPropagatorTests
    {
        ...
        {
            var context = new SpanContext(TraceId, SpanId, SamplingPriority, origin: Origin, propagatedTags: PropagatedTags);
        ...
        {
            var context = new SpanContext(TraceId, SpanId, samplingPriority: null, origin: null) { PropagatedTags = null };
            var headers = new Mock<IHeadersCollection>();
        ...
        {
            var context = new SpanContext(TraceId, SpanId, samplingPriority: 12, origin: null);
            var headers = new Mock<IHeadersCollection>();
