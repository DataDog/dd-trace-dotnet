...
namespace Datadog.Trace.Tests.Propagators
{
    public class DatadogPropagatorTests
    {
        ...
        {
            var context = new InternalSpanContext(TraceId, SpanId, SamplingPriority, serviceName: null, Origin) { PropagatedTags = PropagatedTagsCollection };
        ...
        public void Inject_IHeadersCollection_Tag_Propagation_Disabled()
        {
            ...
            var tracer = new InternalTracer(settings, agentWriter: Mock.Of<IAgentWriter>(), sampler: null, scopeManager: null, null, telemetry: null);
            ...
            var context = new InternalSpanContext(parent: null, traceContext, serviceName: null, TraceId, SpanId);
            var headers = new Mock<IHeadersCollection>();
            Propagator.Inject(context, headers.Object);
        ...
        {
            var context = new InternalSpanContext(TraceId, SpanId, samplingPriority: null, serviceName: null, origin: null) { PropagatedTags = null };
            var headers = new Mock<IHeadersCollection>();
        ...
        {
            var context = new InternalSpanContext(TraceId, SpanId, samplingPriority: 12, serviceName: null, origin: null);
            var headers = new Mock<IHeadersCollection>();
