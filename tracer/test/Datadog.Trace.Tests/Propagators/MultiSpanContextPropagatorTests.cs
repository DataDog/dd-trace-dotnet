...
namespace Datadog.Trace.Tests.Propagators
{
    public class MultiSpanContextPropagatorTests
    {
        ...
        public void Inject_All_IHeadersCollection()
        {
            ...
            Propagator.Inject(new PropagationContext(spanContext, baggage: null), headers.Object);
        ...
        public void ExtractAndInject_W3C_PreserveOriginalTraceId()
        {
            ...
            Propagator.Inject(new PropagationContext(result, baggage: null), headersForInjection.Object);
