...
namespace Datadog.Trace.ClrProfiler.IntegrationTests
{
    ...
    public abstract class HotChocolateTestsBase : TracingIntegrationTest
    {
        ...
        private readonly Regex _stacktraceIndexRegex = new(@"""stacktrace"":""   at Samples\.HotChocolate\.Query\.ThrowExceptionIndex\([^""]*""");
        ...
        protected async Task RunSubmitsTraces(string packageVersion = "", bool usingWebsockets = false)
        {
            ...
            settings.AddRegexScrubber(_stacktraceIndexRegex, @"""stacktrace"":""   at Samples.HotChocolate.Query.ThrowExceptionIndex() in Query.cs:line 00""");
        ...
        private string GetSuffix(string packageVersion)
        {
            ...
            if (string.IsNullOrEmpty(packageVersion) || new Version(packageVersion) >= new Version("16.0.0"))
            {
                return string.Empty;
            }
