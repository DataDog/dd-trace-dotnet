    ...
    public class CIAgentlessEventBufferTests
    {
        ...
        public void SerializeSpans(int traceCount, int spanCount, bool resizeExpected)
        {
            ...
            for (int i = 0; i < traceCount; i++)
            {
                ...
                {
                    events.Add(new Ci.EventModel.SpanEvent(TestSpanExtensions.CreateSpan(new SpanContext((ulong)i, (ulong)i), DateTimeOffset.UtcNow)));
                }
            }
        ...
        public void Overflow()
        {
            ...
            var spanEvent = new Ci.EventModel.SpanEvent(TestSpanExtensions.CreateSpan(new SpanContext(1, 1), DateTimeOffset.UtcNow));
