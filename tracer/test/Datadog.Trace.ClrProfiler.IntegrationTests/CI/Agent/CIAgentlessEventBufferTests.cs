    ...
    public class CIAgentlessEventBufferTests
    {
        ...
        public void SerializeSpans(int traceCount, int spanCount, bool resizeExpected)
        {
            ...
            for (int i = 0; i < traceCount; i++)
            {
                ...
                {
                    events.Add(new SpanEvent(new Span(new SpanContextInternal((ulong)i, (ulong)i), DateTimeOffset.UtcNow)));
                }
            }
        ...
        public void Overflow()
        {
            ...
            var spanEvent = new SpanEvent(new Span(new SpanContextInternal(1, 1), DateTimeOffset.UtcNow));
