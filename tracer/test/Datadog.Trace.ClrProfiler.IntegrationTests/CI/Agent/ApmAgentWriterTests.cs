...
namespace Datadog.Trace.ClrProfiler.IntegrationTests.CI.Agent
{
    public class ApmAgentWriterTests
    {
        ...
        public async Task WriteTrace_2Traces_SendToApi()
        {
            ...
            _api.Verify(x => x.SendTracesAsync(It.Is<ArraySegment<byte>>(y => Equals(y, expectedData1)), It.Is<int>(i => i == 1), It.IsAny<bool>(), It.IsAny<long>(), It.IsAny<long>(), false), Times.Once);
            ...
            _api.Verify(x => x.SendTracesAsync(It.Is<ArraySegment<byte>>(y => Equals(y, expectedData2)), It.Is<int>(i => i == 1), It.IsAny<bool>(), It.IsAny<long>(), It.IsAny<long>(), false), Times.Once);
