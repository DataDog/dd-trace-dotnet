...
namespace Datadog.Trace.ClrProfiler.IntegrationTests.CI.Agent
{
    public class ApmAgentWriterTests
    {
        ...
        private readonly Internal.Configuration.ImmutableTracerSettings _settings;
        ...
        public ApmAgentWriterTests()
        {
            ...
            _settings = new Internal.Configuration.ImmutableTracerSettings(Internal.Ci.Configuration.CIVisibilitySettings.FromDefaultSources().TracerSettings);
        ...
        public async Task WriteTrace_2Traces_SendToApi()
        {
            ...
            var expectedData1 = Internal.Vendors.MessagePack.MessagePackSerializer.Serialize(traceChunk1, SpanFormatterResolver.Instance);
            ...
            var expectedData2 = Internal.Vendors.MessagePack.MessagePackSerializer.Serialize(traceChunk2, SpanFormatterResolver.Instance);
