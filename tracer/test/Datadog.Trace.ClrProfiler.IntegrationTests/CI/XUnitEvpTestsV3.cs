// <copyright file="XUnitEvpTestsV3.cs" company="Datadog">
...
public class XUnitEvpTestsV3 : TestingFrameworkEvpTest
{
    ...
    private const string TestSuiteName = "Samples.XUnitTestsV3.TestSuite";
    private const string UnSkippableSuiteName = "Samples.XUnitTestsV3.UnSkippableSuite";
    private const int ExpectedTestCount = 16;

    public XUnitEvpTestsV3(ITestOutputHelper output)
    ...
    public static IEnumerable<object[]> GetDataForEarlyFlakeDetection()
    {
        foreach (var row in GetData())
        {
            ...
            yield return row.Concat(
                """{"data":{"id":"511938a3f19c12f8bb5e5caa695ca24f4563de3f","type":"ci_app_tracers_test_service_settings","attributes":{"code_coverage":false,"early_flake_detection":{"enabled":true,"slow_test_retries":{"10s":10,"30s":10,"5m":10,"5s":10},"faulty_session_threshold":100},"flaky_test_retries_enabled":false,"itr_enabled":true,"require_git":false,"tests_skipping":true}}}""",
                """{"data":{"id":"lNemDTwOV8U","type":"ci_app_libraries_tests","attributes":{"tests":{"Samples.XUnitTestsV3":{"Samples.XUnitTestsV3.TestSuite":["TraitPassTest"]}}}}}""",
                115,
    ...
    public async Task SubmitTraces(string packageVersion, string evpVersionToRemove, bool expectedGzip)
    {
                ...
                switch (targetTest.Meta[TestTags.Name])
                {
                    ...
                    case "SimpleParameterizedTest":
                        ...
                        AssertTargetSpanAnyOf(
                            targetTest,
                            TestTags.Parameters,
                            "{\"metadata\":{\"test_name\":\"Samples.XUnitTestsV3.TestSuite.SimpleParameterizedTest(xValue: 1, yValue: 1, expectedResult: 2)\"},\"arguments\":{\"xValue\":\"1\",\"yValue\":\"1\",\"expectedResult\":\"2\"}}",
                            "{\"metadata\":{\"test_name\":\"Samples.XUnitTestsV3.TestSuite.SimpleParameterizedTest(xValue: 2, yValue: 2, expectedResult: 4)\"},\"arguments\":{\"xValue\":\"2\",\"yValue\":\"2\",\"expectedResult\":\"4\"}}",
                    ...
                    case "SimpleErrorParameterizedTest":
                        ...
                        AssertTargetSpanAnyOf(
                            targetTest,
                            TestTags.Parameters,
                            "{\"metadata\":{\"test_name\":\"Samples.XUnitTestsV3.TestSuite.SimpleErrorParameterizedTest(xValue: 1, yValue: 0, expectedResult: 2)\"},\"arguments\":{\"xValue\":\"1\",\"yValue\":\"0\",\"expectedResult\":\"2\"}}",
                            "{\"metadata\":{\"test_name\":\"Samples.XUnitTestsV3.TestSuite.SimpleErrorParameterizedTest(xValue: 2, yValue: 0, expectedResult: 4)\"},\"arguments\":{\"xValue\":\"2\",\"yValue\":\"0\",\"expectedResult\":\"4\"}}",
        ...
        settings.UseTypeName(nameof(XUnitEvpTestsV3));
