                ...
                public string? Environment
                {
                    ...
                    set
                    {
                        ...
                        Datadog.Trace.Telemetry.TelemetryFactory.Config.Record(
                            "some_key", value, recordValue: true, Datadog.Trace.Configuration.Telemetry.ConfigurationOrigins.Code);
                        _Environment = value;
                    }
                }
            }
                ...
                public bool BoolTest
                {
                    ...
                    set
                    {
                        Datadog.Trace.Telemetry.TelemetryFactory.Metrics.Record(
                            (Datadog.Trace.Telemetry.Metrics.PublicApiUsage)1);
                        Datadog.Trace.Telemetry.TelemetryFactory.Config.Record(
                            "some_key", value, Datadog.Trace.Configuration.Telemetry.ConfigurationOrigins.Code);
