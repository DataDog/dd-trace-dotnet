...
namespace Datadog.Trace.ClrProfiler
{
    ...
    {
        private static IEnumerable<NativeCallTargetDefinition2> Instrumentations = Array.Empty<NativeCallTargetDefinition2>();
        ...
        static InstrumentationDefinitions()
        {
            ...
            Instrumentations = new NativeCallTargetDefinition2[]
            {
                ...
                // Kafka
                new ("Confluent.Kafka", "Confluent.Kafka.Producer`2", "Produce",  new[] { "System.Void", "Confluent.Kafka.TopicPartition", "Confluent.Kafka.Message`2[!0,!1]", "System.Action`1[Confluent.Kafka.DeliveryReport`2[!0,!1]]" }, 1, 4, 0, 1, 65535, 65535, assemblyFullName, "Datadog.Trace.ClrProfiler.AutoInstrumentation.Kafka.KafkaProduceSyncIntegration",0,1),
            };
        }
    ...
    internal static partial class InstrumentationDefinitions
    {
        ...
        static InstrumentationDefinitions()
        {
            ...
            Instrumentations = new NativeCallTargetDefinition2[]
            {
                ...
                // MongoDb
                new ("Confluent.Kafka", "Confluent.Kafka.Producer`2", "ProduceAsync",  new[] { "System.Threading.Tasks.Task`1[Confluent.Kafka.DeliveryReport`2[!0,!1]]", "Confluent.Kafka.TopicPartition", "Confluent.Kafka.Message`2[!0,!1]", "System.Threading.CancellationToken" }, 1, 4, 0, 1, 65535, 65535, assemblyFullName, "Datadog.Trace.ClrProfiler.AutoInstrumentation.Kafka.FakeMongoDbIntegration",0,1),
            };
        }
    ...
    internal static partial class InstrumentationDefinitions
    {
        ...
        static InstrumentationDefinitions()
        {
            ...
            Instrumentations = new NativeCallTargetDefinition2[]
            {
                ...
                // AdoNet
                new ("System.Data", "System.Data.Common.DbCommand", "ExecuteNonQuery",  new[] { "System.Int32" }, 4, 0, 0, 4, 65535, 65535, assemblyFullName, "Datadog.Trace.ClrProfiler.AutoInstrumentation.AdoNet.CommandExecuteNonQueryIntegration",1,1),
    ...
    internal static partial class InstrumentationDefinitions
    {
        ...
        static InstrumentationDefinitions()
        {
            ...
            Instrumentations = new NativeCallTargetDefinition2[]
            {
                ...
                // AspNetCore
                new ("Microsoft.AspNetCore.Mvc.Core", "Microsoft.AspNetCore.Mvc.ModelBinding.DefaultModelBindingContext", "set_Result",  new[] { "System.Void", "Microsoft.AspNetCore.Mvc.ModelBinding.ModelBindingResult" }, 2, 0, 0, 6, 65535, 65535, assemblyFullName, "Datadog.Trace.ClrProfiler.AspNetCore.DefaultModelBindingContext_SetResult_Integration",0,2),
                new ("Microsoft.AspNetCore.Mvc.Core", "Microsoft.AspNetCore.Mvc.ModelBinding.DefaultModelBindingContext", "set_Result",  new[] { "System.Void", "Microsoft.AspNetCore.Mvc.ModelBinding.ModelBindingResult" }, 2, 0, 0, 6, 65535, 65535, assemblyFullName, "Datadog.Trace.ClrProfiler.AspNetCore.DefaultModelBindingContext_SetResult_Integration",1,2),
            };
        }
    ...
    internal static partial class InstrumentationDefinitions
    {
        ...
        static InstrumentationDefinitions()
        {
            ...
            Instrumentations = new NativeCallTargetDefinition2[]
            {
                ...
                // AspNetCore
                new ("Microsoft.AspNetCore.Mvc.Core", "Microsoft.AspNetCore.Mvc.ModelBinding.DefaultModelBindingContext", "set_Result",  new[] { "System.Void", "Microsoft.AspNetCore.Mvc.ModelBinding.ModelBindingResult" }, 2, 0, 0, 6, 65535, 65535, assemblyFullName, "Datadog.Trace.ClrProfiler.AspNetCore.DefaultModelBindingContext_SetResult_Integration",0,6),
                new ("Microsoft.AspNetCore.Mvc.Core", "Microsoft.AspNetCore.Mvc.ModelBinding.DefaultModelBindingContext", "set_Result",  new[] { "System.Void", "Microsoft.AspNetCore.Mvc.ModelBinding.ModelBindingResult" }, 2, 0, 0, 6, 65535, 65535, assemblyFullName, "Datadog.Trace.ClrProfiler.AspNetCore.DefaultModelBindingContext_SetResult_Integration",1,3),
            };
        }
