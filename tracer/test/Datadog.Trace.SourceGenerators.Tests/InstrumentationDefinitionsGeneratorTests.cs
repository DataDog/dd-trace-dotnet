...
";
        ...
        [Fact]
        public void CanGenerateIntegrationDefinitionForIastWeakHash()
        {
            const string input = @"
using System;
...
";
            ...
            var (diagnostics, output) = TestHelpers.GetGeneratedOutput<InstrumentationDefinitionsGenerator>(
                SourceHelper.InstrumentMethodAttribute,
                SourceHelper.ClrNames,
                SourceHelper.HashAlgorithmConstants,
                input);
            Assert.Equal(expected, output);
            Assert.Empty(diagnostics);
        }
        ...
        [Fact]
        public void CanGenerateIntegrationDefinitionForIastWeakCipher()
        {
            const string input = @"
using System;
using System.ComponentModel;
...
";
            ...
            var (diagnostics, output) = TestHelpers.GetGeneratedOutput<InstrumentationDefinitionsGenerator>(
                SourceHelper.InstrumentMethodAttribute,
                SourceHelper.ClrNames,
                SourceHelper.CipherAlgorithmConstants,
                input);
            Assert.Equal(expected, output);
            Assert.Empty(diagnostics);
        }
