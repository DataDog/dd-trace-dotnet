// <copyright file="ValueTypeFieldErrorTests.cs" company="Datadog">
...
using Datadog.Trace.DuckTyping.Tests.Errors.Fields.ValueType.ProxiesDefinitions.Valid;
using Datadog.Trace.DuckTyping.Tests.Errors.Fields.ValueType.ProxiesDefinitions.WrongFieldName;
using Datadog.Trace.DuckTyping.Tests.Errors.Fields.ValueType.ProxiesDefinitions.WrongReturnType;
using FluentAssertions;
using FluentAssertions.Execution;
using Xunit;

namespace Datadog.Trace.DuckTyping.Tests.Errors.Fields.ValueType
{
