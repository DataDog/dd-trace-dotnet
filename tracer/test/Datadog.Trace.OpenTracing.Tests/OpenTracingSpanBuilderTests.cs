...
namespace Datadog.Trace.OpenTracing.Tests
{
    public class OpenTracingSpanBuilderTests
    {
        ...
        public OpenTracingSpanBuilderTests()
        {
            ...
            var datadogTracer = new Tracer(settings, writerMock.Object, samplerMock.Object, spanSampler: null, scopeManager: null, statsd: null);
        ...
        public void Start_AsChildOfSpan_ChildReferencesParent()
        {
            ...
            Assert.Equal(root.DDSpan.Context.SpanId, childParentId);
        ...
        public void Start_SettingServiceInParent_ChildDoesNotInheritServiceName()
        {
            ...
            var child = _tracer.BuildSpan(null)
                                  .StartActive(finishSpanOnDispose: true);
        ...
        public void Start_WithStartTimeStamp_TimeStampProperlySet()
        {
            ...
            Assert.Equal(startTime, ddSpan.StartTime);
        }
