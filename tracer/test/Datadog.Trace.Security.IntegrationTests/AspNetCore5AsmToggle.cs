...
namespace Datadog.Trace.Security.IntegrationTests
{
    public class AspNetCore5AsmToggle : AspNetBase, IDisposable
    {
        ...
        public async Task TestSecurityToggling(bool? enableSecurity, uint expectedState)
        {
            ...
            CheckAckState(expectedState, null, "First RCM call");
            ...
            CheckAckState(expectedState, null, "Second RCM call");
        ...
        private void CheckAckState(uint expectedState, string expectedError, string message)
        {
            var request = GetRcmRequest();
