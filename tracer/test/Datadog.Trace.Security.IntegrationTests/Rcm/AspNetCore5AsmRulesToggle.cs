...
namespace Datadog.Trace.Security.IntegrationTests.Rcm
{
    public class AspNetCore5AsmRulesToggle : RcmBase
    {
        ...
        public async Task TestRulesToggling()
        {
            ...
            var request1 = await agent.SetupRcmAndWait(Output, new[] { ((object)new Payload { RuleStatus = new[] { new RuleOverride { Id = ruleId, Enabled = false } } }, acknowledgedId) }, ASMProduct, appliedServiceNames: new[] { acknowledgedId });
            ...
            var request2 = await agent.SetupRcmAndWait(Output, new[] { ((object)new Payload { RuleStatus = new[] { new RuleOverride { Id = ruleId, Enabled = true } } }, acknowledgedId2) }, ASMProduct, appliedServiceNames: new[] { acknowledgedId2 });
            ...
            var request3 = await agent.SetupRcmAndWait(Output, new[] { ((object)new Payload { RuleStatus = new[] { new RuleOverride { Id = ruleId, Enabled = true, OnMatch = new[] { "block" } } } }, acknowledgedId3) }, ASMProduct, appliedServiceNames: new[] { acknowledgedId3 });
