// <copyright file="AspNetWebApi2Rasp.cs" company="Datadog">
...
[Collection("IisTests")]
public class AspWebApi2RaspEnabledIastDisabledClassic : AspNetWebApi2RaspTests
{
    public AspWebApi2RaspEnabledIastDisabledClassic(IisFixture fixture, ITestOutputHelper outputHelper)
...
[Collection("IisTests")]
public class AspWebApi2RaspEnabledIastEnabledClassic : AspNetWebApi2RaspTests
{
    public AspWebApi2RaspEnabledIastEnabledClassic(IisFixture fixture, ITestOutputHelper outputHelper)
...
[Collection("IisTests")]
public class AspWebApi2RaspEnabledIastDisabledIntegrated : AspNetWebApi2RaspTests
{
    public AspWebApi2RaspEnabledIastDisabledIntegrated(IisFixture fixture, ITestOutputHelper outputHelper)
...
[Collection("IisTests")]
public class AspWebApi2RaspEnabledIastEnabledIntegrated : AspNetWebApi2RaspTests
{
    public AspWebApi2RaspEnabledIastEnabledIntegrated(IisFixture fixture, ITestOutputHelper outputHelper)
    : base(fixture, outputHelper, classicMode: false, enableIast: true)
    {
    }
}

public abstract class AspNetWebApi2RaspTests : AspNetBase, IClassFixture<IisFixture>, IAsyncLifetime
{
    private readonly IisFixture _iisFixture;
    private readonly bool _enableIast;
    private readonly bool _classicMode;

    public AspNetWebApi2RaspTests(IisFixture iisFixture, ITestOutputHelper output, bool classicMode, bool enableIast)
    ...
    public async Task TestRaspRequest(string url, string exploit)
    {
        ...
        var testName = _enableIast ? "RaspIast.AspNetWebApi" : "Rasp.AspNetWebApi";
    ...
    public async Task InitializeAsync()
    {
        ...
        var answer = await SubmitRequest("/api/home", null, string.Empty);
        _iisFixture.Agent.SpanFilters.Add(s => !s.Resource.Contains("api/home"));
    }
