// <copyright file="AspNetBlazorIastTests.cs" company="Datadog">
...
public abstract class AspNetBlazorIastTests50PctSamplingIastEnabled : AspNetBlazorIastTests
{
    public AspNetBlazorIastTests50PctSamplingIastEnabled(AspNetCoreTestFixture fixture, ITestOutputHelper outputHelper)
        : base(fixture, outputHelper, enableIast: true, testName: "AspNetBlazorIastTestsEnabled", isIastDeduplicationEnabled: false, vulnerabilitiesPerRequest: 100, samplingRate: 50)
    {
    }
...
public class AspNetBlazorIastTestsSpanTelemetryIastEnabled : AspNetBlazorIastTests
{
    public AspNetBlazorIastTestsSpanTelemetryIastEnabled(AspNetCoreTestFixture fixture, ITestOutputHelper outputHelper)
...
public class AspNetBlazorIastTestsOneVulnerabilityPerRequestIastEnabled : AspNetBlazorIastTestsVariableVulnerabilityPerRequestIastEnabled
{
    public AspNetBlazorIastTestsOneVulnerabilityPerRequestIastEnabled(AspNetCoreTestFixture fixture, ITestOutputHelper outputHelper)
: base(fixture, outputHelper, vulnerabilitiesPerRequest: 1)
    {
    }
}

public class AspNetBlazorIastTestsTwoVulnerabilityPerRequestIastEnabled : AspNetBlazorIastTestsVariableVulnerabilityPerRequestIastEnabled
{
    public AspNetBlazorIastTestsTwoVulnerabilityPerRequestIastEnabled(AspNetCoreTestFixture fixture, ITestOutputHelper outputHelper)
...
public abstract class AspNetBlazorIastTestsVariableVulnerabilityPerRequestIastEnabled : AspNetBlazorIastTests
{
    public AspNetBlazorIastTestsVariableVulnerabilityPerRequestIastEnabled(AspNetCoreTestFixture fixture, ITestOutputHelper outputHelper, int vulnerabilitiesPerRequest)
        : base(fixture, outputHelper, enableIast: true, testName: "AspNetBlazorIastTestsEnabled", isIastDeduplicationEnabled: false, samplingRate: 100, vulnerabilitiesPerRequest: vulnerabilitiesPerRequest)
    {
    }
...
public class AspNetBlazorIastTestsRestartedSampleIastEnabled : AspNetBlazorIastTests
{
    public AspNetBlazorIastTestsRestartedSampleIastEnabled(AspNetCoreTestFixture fixture, ITestOutputHelper outputHelper)
        : base(fixture, outputHelper, enableIast: true, vulnerabilitiesPerRequest: 200, isIastDeduplicationEnabled: false, testName: "AspNetBlazorIastTestsEnabled", redactionEnabled: true, samplingRate: 100)
    {
    }
...
public class AspNetBlazorIastTestsFullSamplingIastEnabled : AspNetBlazorIastTestsFullSampling
{
    public AspNetBlazorIastTestsFullSamplingIastEnabled(AspNetCoreTestFixture fixture, ITestOutputHelper outputHelper)
        : base(fixture, outputHelper, enableIast: true, vulnerabilitiesPerRequest: 200, isIastDeduplicationEnabled: false, testName: "AspNetBlazorIastTestsEnabled")
    {
...
public class AspNetBlazorIastTestsFullSamplingIastDisabled : AspNetBlazorIastTestsFullSampling
{
    public AspNetBlazorIastTestsFullSamplingIastDisabled(AspNetCoreTestFixture fixture, ITestOutputHelper outputHelper)
        : base(fixture, outputHelper, enableIast: false, testName: "AspNetBlazorIastTestsDisabled")
    {
    }
}

public class AspNetBlazorIastTestsFullSamplingRedactionEnabled : AspNetBlazorIastTestsFullSampling
{
    public AspNetBlazorIastTestsFullSamplingRedactionEnabled(AspNetCoreTestFixture fixture, ITestOutputHelper outputHelper)
        : base(fixture, outputHelper, enableIast: true, isIastDeduplicationEnabled: false, testName: "AspNetBlazorIastTestsRedactionEnabled", redactionEnabled: true, vulnerabilitiesPerRequest: 100)
    {
    }
}

[Collection(nameof(AspNetBlazorIastTestsFullSampling))]
[CollectionDefinition(nameof(AspNetBlazorIastTestsFullSampling), DisableParallelization = true)]
public abstract class AspNetBlazorIastTestsFullSampling : AspNetBlazorIastTests
{
    public AspNetBlazorIastTestsFullSampling(AspNetCoreTestFixture fixture, ITestOutputHelper outputHelper, bool enableIast, string testName, bool? isIastDeduplicationEnabled = null, int? vulnerabilitiesPerRequest = null, bool redactionEnabled = false)
...
public abstract class AspNetBlazorIastTests : AspNetBase, IClassFixture<AspNetCoreTestFixture>
{
    public AspNetBlazorIastTests(AspNetCoreTestFixture fixture, ITestOutputHelper outputHelper, bool enableIast, string testName, bool? isIastDeduplicationEnabled = null, int? samplingRate = null, int? vulnerabilitiesPerRequest = null, bool? redactionEnabled = false, int iastTelemetryLevel = (int)IastMetricsVerbosityLevel.Off)
        : base("Blazor", outputHelper, "/shutdown", testName: testName)
    {
        Fixture = fixture;
