...
namespace Datadog.Trace.ClrProfiler.Managed.Tests.AutoInstrumentation.Logging.ILogger
{
    public class ILoggerDuckTypingTests
    {
        ...
        public ILoggerDuckTypingTests()
        {
            ...
            _formatter = SettingsHelper.GetFormatter();
        ...
        {
            var scopeProvider = new LoggerExternalScopeProvider();
            var loggerProvider = new DirectSubmissionLoggerProvider(new NullDatadogSink(), SettingsHelper.GetFormatter(), DirectSubmissionLogLevel.Debug);
