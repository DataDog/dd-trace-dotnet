...
namespace Datadog.Trace.ClrProfiler.Managed.Tests.AutoInstrumentation.Logging.Log4Net
{
    public class DirectSubmissionLog4NetAppenderTests
    {
        ...
        public void LoggerEnqueuesLogMessage()
        {
            ...
            var appender = new DirectSubmissionLog4NetAppender(sink, DirectSubmissionLogLevel.Debug);
            ...
            var proxy = logEvent.DuckCast<LoggingEventDuck>();
        ...
        {
            var sink = new TestSink();
            var appender = new DirectSubmissionLog4NetAppender(sink, DirectSubmissionLogLevel.Warning);
        ...
        public void LoggerIncludesPropertiesInLog()
        {
            ...
            var sink = new TestSink();
            var appender = new DirectSubmissionLog4NetAppender(sink, DirectSubmissionLogLevel.Debug);
            var appenderProxy = appender.DuckCast<IAppender>();
