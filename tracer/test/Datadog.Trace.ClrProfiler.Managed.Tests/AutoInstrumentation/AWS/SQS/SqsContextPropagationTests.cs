...
public class SqsContextPropagationTests
{
    ...
    public void InjectHeadersIntoMessage_FullMessageAttributes_DoesntAddTraceContext()
    {
        ...
        ContextPropagation.InjectHeadersIntoMessage(proxy, _spanContext, dataStreamsManager: null, CachedMessageHeadersHelper<SendMessageRequest>.Instance);
    ...
    {
        ContextPropagation.InjectHeadersIntoMessage(requestProxy, _spanContext, dataStreamsManager: null, CachedMessageHeadersHelper<SendMessageRequest>.Instance);
