// <copyright file="MySqlOldFixture.cs" company="Datadog">
...
public class MySqlOldFixture : ContainerFixture
{
    ...
    {
        yield return new("MYSQL57_HOST", Container.Hostname);
        yield return new("MYSQL57_PORT", Container.GetMappedPublicPort(3306).ToString());
    }

    protected override async Task InitializeResources(Action<string, object> registerResource)
    {
        var container = new ContainerBuilder()
            .WithImage("mysql/mysql-server:5.7")
            .WithName("mysql57")
