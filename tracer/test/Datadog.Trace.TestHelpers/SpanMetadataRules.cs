...
#pragma warning disable SA1601 // Partial elements should be documented
    public static partial class SpanMetadataRules
    {
        ...
        public static Result IsMongoDb(this MockSpan span) => Result.FromSpan(span)
            ...
            .Tags(s => s
                .IsOptional("db.instance")
                .IsOptional("db.mongodb.collection")
        ...
        public static Result IsRabbitMQ(this MockSpan span) => Result.FromSpan(span)
            ...
            .Tags(s => s
                ...
                .IsOptional("messaging.rabbitmq.delivery_mode")
                .IsOptional("messaging.rabbitmq.exchange")
                .IsOptional("messaging.rabbitmq.routing_key")
                .IsOptional("messaging.destination")
