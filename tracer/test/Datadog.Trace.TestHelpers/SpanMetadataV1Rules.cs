    ...
    internal static class SpanMetadataV1Rules
    {
        ...
        public static Result IsMassTransitV1(this MockSpan span) => Result.FromSpan(span)
            ...
            .Tags(s => s
                ...
                // The following tags are emitted by MassTransit 8.x via ActivitySource and surfaced
                // through the OTel bridge (not via the typed MassTransitTags class used by MT7).
                ...
                .IsOptional("messaging.conversation_id")
                ...
                .IsOptional("server.address")
                .IsOptional("network.local.address")
                .IsOptional("network.peer.address")
                .IsOptional("network.type")
                .IsOptional("events")
