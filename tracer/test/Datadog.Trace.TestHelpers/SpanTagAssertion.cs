...
namespace Datadog.Trace.TestHelpers
{
    public class SpanTagAssertion<T> : SpanAssertion
    {
        ...
        public static void DefaultTagAssertions(SpanTagAssertion<T> s) => s
            ...
            .IsOptional("version")
            .IsOptional(Tags.Propagated.DecisionMaker) // _dd.p.dm, aka sampling mechanism
            .IsOptional(Tags.Propagated.TraceIdUpper)  // _dd.p.tid, contains the upper 64 bits of a 128-bit trace id
