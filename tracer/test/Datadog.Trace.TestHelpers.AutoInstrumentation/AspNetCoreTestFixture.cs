...
namespace Datadog.Trace.TestHelpers
{
    public sealed class AspNetCoreTestFixture : IDisposable
    {
        ...
        /// <param name="waitForHealthcheckSpan">This refers to the sendHealthCheck comment. If you dont care about the very first span and use the OverheadController with request sampling and concurrency, wait for the span, as the sampler releases on span closure.
        /// Api security uses it as it relies on the OverheadController mechanism (same as IAST)</param>
        /// <exception cref="Exception">exception, dont timeout</exception>
        /// <returns>Awaits the Response to the alive check</returns>
        public async Task TryStartApp(TestHelper helper, bool? enableSecurity = null, string externalRulesFile = null, bool sendHealthCheck = true, string packageVersion = "", bool waitForHealthcheckSpan = false)
        {
            ...
            await EnsureServerStarted(sendHealthCheck, waitForHealthcheckSpan);
        ...
        private async Task EnsureServerStarted(bool sendHealthCheck, bool waitForHealthcheckSpan = false)
        {
