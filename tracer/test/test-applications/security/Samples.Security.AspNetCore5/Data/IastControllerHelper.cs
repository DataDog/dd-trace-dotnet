...
namespace Samples.Security.Data
{
    public static class IastControllerHelper
    {
        private static readonly string[] SqlServerTables =
            [
                "CREATE TABLE Persons (Id uniqueidentifier NOT NULL,Name varchar(50) NOT NULL,Surname varchar(50) NULL,Married bit NULL,Gender char(10) NULL,DateOfBirth datetime NULL,Email varchar(50) NULL,FlattedAddress varchar(500) NULL,Mobile varchar(50) NULL,NIF varchar(50) NULL,Phone varchar(50) NULL,PostalCode varchar(50) NULL,Details varchar(5000) NULL,CityIniqueId varchar(50) NULL,CountryUniqueId varchar(50) NULL,ImagePath varchar(500) NULL)",
                @"CREATE TABLE Books(Id uniqueidentifier NOT NULL,Title nvarchar(500) NOT NULL,Price numeric(18, 2) NULL,ISBN nvarchar(50) NULL,	Pages int NOT NULL,    PublicationDate datetime NOT NULL,    Author nvarchar(500) NOT NULL,    Editorial nvarchar(50) NULL,	Prologue nvarchar(4000) NULL,	Format int NULL)",
            ];
        ...
        public static NpgsqlConnection CreatePostgresDatabase()
        {
            ...
            var connection = new NpgsqlConnection("Host=postgres;Username=postgres;Password=postgres;Database=postgres;");
            connection.Open();

            // TODO tables
            foreach (var command in PopulateCommands)
            {
                new NpgsqlCommand(command, connection).ExecuteReader();
            }
