...
namespace Samples.Security.AspNetCore5
{
    ...
    public class MetaStructController : ControllerBase
    {
        ...
        private static readonly Type _metaStructMessagePackHelperType = Type.GetType("Datadog.Trace.Agent.MessagePack.MetaStructMessagePackHelper, Datadog.Trace");
        private static MethodInfo _objectToByteArrayMethod = _metaStructMessagePackHelperType.GetMethod("ObjectToByteArray", BindingFlags.Static | BindingFlags.NonPublic);
        ...
        public IActionResult MetaStructTest()
        {
            ...
            if (rootSpan != null)
            {
                _AddMetaStructMethod.Invoke(tags, ["_dd.stack.exploit", _objectToByteArrayMethod.Invoke(null, [stack])]);
