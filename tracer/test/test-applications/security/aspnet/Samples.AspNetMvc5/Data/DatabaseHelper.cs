...
namespace Samples.AspNetMvc5.Data
{
    ...
    {
        public const string dbName = "Samples.AspNetMvc5";
        public static SqlConnection GetConnectionForDb(string connectionString) => new SqlConnection(connectionString + $";Database='{dbName}'");
