// <copyright file="MultiScopesWithSameLocalNameTest.cs" company="Datadog">
...
namespace Samples.Probes.Contracts.SmokeTests
{
    ...
    /// </summary>
    [LineProbeTestData(lineNumber: 31, expectedNumberOfSnapshots: 2)]
    [LineProbeTestData(lineNumber: 38, expectedNumberOfSnapshots: 2)]
    public class MultiScopesWithSameLocalNameTest : IRun
    {
        ...
        private void Mutate(ref int @out)
        {
            @out += 5;
        }
    }
