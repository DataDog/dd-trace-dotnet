...
public class NonSupportedInstrumentationTest : IRun
{
    ...
    struct GenericStructIsNotSupported<T>
    {
        ...
        [LogMethodProbeTestData(expectedNumberOfSnapshots: 0)] // Should fail on instrumentation as we don't support the instrumentation of methods that reside inside an inner generic struct.
