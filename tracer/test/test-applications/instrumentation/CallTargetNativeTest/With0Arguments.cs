...
struct With0ArgumentsGenericStaticStruct<T> // Note: This type is not run or even instrumented because it's a generic struct.
{
    public static void VoidMethod() { }
    public static int ReturnValueMethod() => 42;
    public static string ReturnReferenceMethod() => "Hello World";
...
partial class ArgumentsParentType
{
    ...
    public struct With0ArgumentsGenericStaticStruct<T> // Note: This type is not run or even instrumented because it's a generic struct.
    {
        public static void VoidMethod() { }
        public static int ReturnValueMethod() => 42;
        public static string ReturnReferenceMethod() => "Hello World";
