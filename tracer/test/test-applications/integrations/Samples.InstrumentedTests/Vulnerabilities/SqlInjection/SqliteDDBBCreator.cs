...
internal class SqliteDDBBCreator
{
    public static SQLiteConnection CreateDatabase()
    {
        ...
        new SQLiteCommand(@"INSERT INTO Books (Id, Title, Price, ISBN, Pages, PublicationDate, Author, Editorial, Prologue, Format) VALUES ('026decfd-bba3-4aa8-85d4-1c71eecfe8e9', 'Quixote', CAST(50.00 AS Decimal(18, 2)), '073343954', 334, CAST(0x0000A03100000000 AS DateTime), ' Cervantes', 'AB Press', 'something', 0)", dbConnection).ExecuteReader();
