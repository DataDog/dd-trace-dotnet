...
internal static class DDBBTestHelper
{
    public static List<string> GetCommands()
    {
        var commands = new List<string>
        {
            ...
            "CREATE TABLE Books(Id varchar(50) NOT NULL,Title nvarchar(500) NOT NULL,Price numeric(18, 2) NULL,ISBN nvarchar(50) NULL,\tPages int NOT NULL,    PublicationDate datetime NOT NULL,    Author nvarchar(500) NOT NULL,    Publisher nvarchar(50) NULL,\tPrologue nvarchar(4000) NULL,\tFormat int NULL)",
            @"INSERT INTO Persons (Id, Name, Surname, Married, Gender, DateOfBirth, Email, FlattedAddress, Mobile, NIF, Phone, PostalCode, Details, CityIniqueId, CountryUniqueId, ImagePath) VALUES ('D305C1EB-B72E-4340-B5BA-A19D0105A6C2', 'Michael', 'Smith', 0, 'Female    ', CAST(0x00006A1000000000 AS DateTime), 'Michael.Smith@gmail.com', 'Mountain Avenue 55', '650214751', '50099554L', '918084525', '28341', 'Not Defined', NULL, NULL, '~/Images/Antonio.jpg')",
            ...
            @"INSERT INTO Books (Id, Title, Price, ISBN, Pages, PublicationDate, Author, Publisher, Prologue, Format) VALUES ('026decfd-bba3-4aa8-85d4-1c71ffcfe8e9', 'CLR via C#', CAST(50.00 AS Decimal(18, 2)), '0735669954', 894, CAST(0x0000A03100000000 AS DateTime), ' Jeffrey Richter', 'Microsoft Press', 'bla bla bla', 0)",
            @"INSERT INTO Books (Id, Title, Price, ISBN, Pages, PublicationDate, Author, Publisher, Prologue, Format) VALUES ('026decfd-bba3-4aa8-85d4-1c71eecfe8e9', 'Quixote', CAST(50.00 AS Decimal(18, 2)), '073343954', 334, CAST(0x0000A03100000000 AS DateTime), ' Cervantes', 'AB Press', 'something', 0)"
        };
