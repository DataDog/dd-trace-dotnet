...
echo ^<CORECLR_PROFILER_PATH_64^>%solutionFolder%artifacts\monitoring-home\win-x64\Datadog.Trace.ClrProfiler.Native.dll^</CORECLR_PROFILER_PATH_64^> >> %file%
echo ^<CORECLR_PROFILER_PATH_32^>%solutionFolder%artifacts\monitoring-home\win-x86\Datadog.Trace.ClrProfiler.Native.dll^</CORECLR_PROFILER_PATH_32^> >> %file%
...
echo ^<COR_PROFILER_PATH_64^>%solutionFolder%artifacts\monitoring-home\win-x64\Datadog.Trace.ClrProfiler.Native.dll^</COR_PROFILER_PATH_64^> >> %file%
echo ^<COR_PROFILER_PATH_32^>%solutionFolder%artifacts\monitoring-home\win-x86\Datadog.Trace.ClrProfiler.Native.dll^</COR_PROFILER_PATH_32^> >> %file%
echo ^<DD_DOTNET_TRACER_HOME^>%solutionFolder%artifacts\monitoring-home^</DD_DOTNET_TRACER_HOME^> >> %file%
