...
public class StringBuilderBasicTests : InstrumentationTestsBase
{
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tainted-+:", new System.Text.StringBuilder(_taintedValue), () => new System.Text.StringBuilder(_taintedValue));
    }
    ...
    public void GivenATaintedString_WhenCreateStringBuilder_ResultIsTainted2()
    {
        AssertTaintedFormatWithOriginalCallCheck("UntaintedString:+-tainted-+:UntaintedString",
            new System.Text.StringBuilder(_untaintedString + _taintedValue + _untaintedString),
            () => new System.Text.StringBuilder(_untaintedString + _taintedValue + _untaintedString));
    }
    ...
    public void GivenATaintedString_WhenCreateStringBuilder_ResultIsNotTainted3()
    {
        AssertUntaintedWithOriginalCallCheck("UntaintedString",
            new System.Text.StringBuilder(_untaintedString),
            () => new System.Text.StringBuilder(_untaintedString));
    }
    ...
    {
        AssertUntaintedWithOriginalCallCheck(string.Empty, new System.Text.StringBuilder(null), () => new System.Text.StringBuilder(null));
    }

    [Fact]
    public void GivenATaintedString_WhenCallingNewStringBuilder_ResultIsTainted2()
    {
        new System.Text.StringBuilder(null).ToString().Should().Be(System.String.Empty);
    }
    ...
    public void GivenANotTaintedString_WhenCallingNewStringBuilder_ResultIsNotTainted()
    {
        AssertUntaintedWithOriginalCallCheck(
            () => new System.Text.StringBuilder(_notTaintedValue).ToString(), 
            () => new System.Text.StringBuilder(_notTaintedValue).ToString());
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tainted-+:", new System.Text.StringBuilder(_taintedValue).ToString(), () => new System.Text.StringBuilder(_taintedValue).ToString());
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tainted-+:", new System.Text.StringBuilder(_taintedValue, 100), () => new System.Text.StringBuilder(_taintedValue, 100));
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck("UntaintedString:+-tainted-+:UntaintedString",
            new System.Text.StringBuilder(_untaintedString + _taintedValue + _untaintedString, 100),
            () => new System.Text.StringBuilder(_untaintedString + _taintedValue + _untaintedString, 100));
    }
    ...
    {
        AssertUntaintedWithOriginalCallCheck("UntaintedString",
            new System.Text.StringBuilder(_untaintedString, 100),
            () => new System.Text.StringBuilder(_untaintedString, 100));
    }
    ...
    {
        AssertUntaintedWithOriginalCallCheck(string.Empty, new System.Text.StringBuilder(null, 3), () => new System.Text.StringBuilder(null, 3));
    }

    [Fact]
    public void GivenATaintedString_WhenCallingNewStringBuilderWithMaxLenght_ResultIsTainted3()
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tainted-+:", new System.Text.StringBuilder(_taintedValue, 500).ToString(), () => new System.Text.StringBuilder(_taintedValue, 500).ToString());
    }

    [Fact]
    public void GivenATaintedString_WhenCallingNewStringBuilderWithMaxLenght_ResultIsTainted4()
    {
        new System.Text.StringBuilder(null, 500).ToString().Should().Be(System.String.Empty);
    }

    [Fact]
    public void GivenATaintedString_WhenCallingNewStringBuilderWithWrongMaxLenght_ArgumentOutOfRangeException()
    {
        Assert.Throws<ArgumentOutOfRangeException>(() => new System.Text.StringBuilder(_taintedValue, -500));
    }
    ...
    {
        AssertUntaintedWithOriginalCallCheck("UntaintedString",
            new System.Text.StringBuilder(_untaintedString, 1),
            () => new System.Text.StringBuilder(_untaintedString, 1));
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tainted-+:", new System.Text.StringBuilder(_taintedValue, 0, 7, 10), () => new System.Text.StringBuilder(_taintedValue));
    }
    ...
    public void GivenATaintedString_WhenCreateStringBuilderCapacityOffsets_ResultIsTainted2()
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-in-+:",
            new System.Text.StringBuilder(_taintedValue, 2, 2, 10),
            () => new System.Text.StringBuilder(_taintedValue, 2, 2, 10));
    }
    ...
    public void GivenATaintedString_WhenCreateStringBuilderCapacityOffsets_ResultIsTainted3()
    {
        AssertTaintedFormatWithOriginalCallCheck("intedString:+-tain-+:",
            new System.Text.StringBuilder(_untaintedString + _taintedValue + _untaintedString, 4, 15, 22),
            () => new System.Text.StringBuilder(_untaintedString + _taintedValue + _untaintedString, 4, 15, 22));
    }
    ...
    public void GivenATaintedString_WhenCreateStringBuilderCapacityOffsets_ResultIsNotTainted3()
    {
        AssertUntaintedWithOriginalCallCheck("ta",
            new System.Text.StringBuilder(_untaintedString, 2, 2, 2),
            () => new System.Text.StringBuilder(_untaintedString, 2, 2, 2));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() => new System.Text.StringBuilder(null, 2, 2, 2));
    }

    [Fact]
    public void GivenATaintedString_WhenCreateStringBuilderCapacityOffsets_ExceptionIsThrown2()
    {
        Assert.Throws<ArgumentOutOfRangeException>(() => new System.Text.StringBuilder(_taintedValue, -1, 3, 3));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() => new System.Text.StringBuilder(_taintedValue, 1, 300, 3));
    }

    [Fact]
    public void GivenATaintedString_WhenCreateStringBuilderCapacityOffsets_ExceptionIsThrown6()
    {
        Assert.Throws<ArgumentOutOfRangeException>(() => new System.Text.StringBuilder(_taintedValue, 100, 3, 3));
    }

    [Fact]
    public void GivenATaintedString_WhenCallingNewStringBuilderWithSubString_ResultIsTainted()
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-inte-+:", new System.Text.StringBuilder(_taintedValue, 2, 4, 100).ToString(), () => new System.Text.StringBuilder(_taintedValue, 2, 4, 100).ToString());
    }
    ...
    public void GivenATaintedString_WhenCallingStringBuilderToString_ResultIsTainted()
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-ta-+:",
            new System.Text.StringBuilder(_taintedValue).ToString(0, 2),
            () => new System.Text.StringBuilder(_taintedValue).ToString(0, 2));
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-in-+:",
            new System.Text.StringBuilder(_taintedValue).ToString(2, 2),
            () => new System.Text.StringBuilder(_taintedValue).ToString(2, 2));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() => new System.Text.StringBuilder(_taintedValue).ToString(-1, 2));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() => new System.Text.StringBuilder(_taintedValue).ToString(1, 332));
    }

    [Fact]
    public void GivenATaintedString_WhenCallingNewStringBuilderWithWrongSubString_ArgumentOutOfRangeException6()
    {
        Assert.Throws<ArgumentOutOfRangeException>(() => new System.Text.StringBuilder(_taintedValue).ToString(200, 2));
    }

    [Fact]
    public void GivenATaintedString_WhenCallingNewStringBuilderToString2Params_ResultIsTainted()
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-int-+:", new System.Text.StringBuilder(_taintedValue).ToString(2, 3), () => new System.Text.StringBuilder(_taintedValue).ToString(2, 3));
    }
    ...
    {
        var stringBuilder = new System.Text.StringBuilder().Append(_taintedValue);
        MethodInfo replaceMethod = typeof(System.Text.StringBuilder).GetMethod("Replace", new Type[] {typeof(string), typeof(string) });
    ...
    {
        var stringBuilder = new System.Text.StringBuilder(_taintedValue);
        for (int i = 0; i < 100; i++)
        {
    ...
    {
        var stringBuilder = new System.Text.StringBuilder().Append("aw" + _taintedValue);
        MethodInfo replaceMethod = typeof(System.Text.StringBuilder).GetMethod("Replace", new Type[] { typeof(string), typeof(string) });
    ...
    {
        var stringBuilder = new System.Text.StringBuilder().Append(_taintedValue + "aw" + _taintedValue);
        MethodInfo replaceMethod = typeof(System.Text.StringBuilder).GetMethod("Replace", new Type[] { typeof(string), typeof(string) });
        replaceMethod.Invoke(stringBuilder, new object[] { "wtainted", string.Empty });
        var mystring = stringBuilder.ToString();
        ValidateRanges(mystring);
