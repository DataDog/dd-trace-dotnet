...
public class StringBuilderInsertTests : InstrumentationTestsBase
{
    ...
    private System.Text.StringBuilder _taintedStringBuilder = new System.Text.StringBuilder("TaintedStringBuilder");
    ...
    public void GivenATaintedString_WhenCallingStringBuilderInsertNullString_ResultIsTainted()
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tainted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, (string)null).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, (string)null).ToString());
    }
    ...
    public void GivenANullString_WhenCallingStringBuilderInsertObject_ResultIsNotTainted()
    {
        ...
        AssertUntaintedWithOriginalCallCheck(
            () => ((System.Text.StringBuilder)null).Insert(index, _untaintedString),
            () => ((System.Text.StringBuilder)null).Insert(index, _untaintedString));
    }
    ...
    public void GivenATaintedString_WhenCallingStringBuilderInsertString_ResultIsTainted()
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+:www:+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, "www").ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, "www").ToString());
    }
    ...
    public void GivenATaintedString_WhenCallingStringBuilderInsertStringTainted_ResultIsTainted()
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+::+-TAINTED2-+::+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, _taintedValue2).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, _taintedValue2).ToString());
    }
        ...
        string expected, int index, string value, int count)
    {
        AssertTaintedFormatWithOriginalCallCheck(expected,
            new System.Text.StringBuilder(_taintedValue).Insert(index, value, count).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(index, value, count).ToString());
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+::+-TAINTED2-+::+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, _taintedValue2, 1).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, _taintedValue2, 1).ToString());
    }
    ...
    public void GivenATaintedString_WhenCallingStringBuilderInsertStringTaintedAndCount_ResultIsTainted()
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+::+-TAINTED2-+::+-TAINTED2-+::+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, _taintedValue2, 2).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, _taintedValue2, 2).ToString());
    }
    ...
    public void GivenATaintedString_WhenCallingStringBuilderInsertChar_ResultIsTainted()
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+:d:+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, 'd').ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, 'd').ToString());
    }
    ...
    public void GivenATaintedString_WhenCallingStringBuilderInsertCharArray_ResultIsTainted()
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+:er:+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, new char[] { 'e', 'r' }).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, new char[] { 'e', 'r' }).ToString());
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tainted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, new char[] { }).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, new char[] { }).ToString());
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tainted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, (char[])null).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, (char[])null).ToString());
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+::+-TAINTED2-+::+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, _taintedValue2.ToCharArray()).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, _taintedValue2.ToCharArray()).ToString());
    }
    ...
    {
        AssertUntaintedWithOriginalCallCheck(() => new System.Text.StringBuilder(_taintedValue).Insert(-3, new char[] { 'e', 'r' }),
            () => new System.Text.StringBuilder(_taintedValue).Insert(-3, new char[] { 'e', 'r' }));
    }
    ...
    public void GivenATaintedString_WhenCallingStringBuilderInsertCharArrayTaintedAndCount_ResultIsTainted()
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+::+-NTE-+::+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, _taintedValue2.ToCharArray(), 3, 3).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, _taintedValue2.ToCharArray(), 3, 3).ToString());
    }
    ...
    {
        AssertUntaintedWithOriginalCallCheck(
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, _taintedValue2.ToCharArray(), startIndex, charCount),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, _taintedValue2.ToCharArray(), startIndex, charCount));
    }
    ...
    public void GivenATaintedString_WhenCallingStringBuilderInsertInt_ResultIsTainted()
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+:12:+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, 12).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, (int)12).ToString());
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+:12:+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, (long)12).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, (long)12).ToString());
    }
    ...
    public void GivenATaintedString_WhenCallingStringBuilderInsertfloat_ResultIsTainted()
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+:33:+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, (float)33).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, (float)33).ToString());
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+:33:+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, (decimal)33).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, (decimal)33).ToString());
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+:33:+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, (ushort)33).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, (ushort)33).ToString());
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+:33:+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, (uint)33).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, (uint)33).ToString());
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+:33:+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, (sbyte)33).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, (sbyte)33).ToString());
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+:12:+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, (byte)12).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, (byte)12).ToString());
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+:33:+-nted-+:",
            new System.Text.StringBuilder(_taintedValue).Insert(3, (short)33).ToString(),
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, (short)33).ToString());
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+:www:+-nted-+:", 
            new System.Text.StringBuilder(_taintedValue).Insert(3, (object)"www").ToString(), 
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, (object)"www").ToString());
    }
    ...
    {
        AssertTaintedFormatWithOriginalCallCheck(":+-tai-+::+-TAINTED2-+::+-nted-+:", 
            new System.Text.StringBuilder(_taintedValue).Insert(3, (object)_taintedValue2).ToString(), 
            () => new System.Text.StringBuilder(_taintedValue).Insert(3, (object)_taintedValue2).ToString());
    }
}
