...
namespace Samples.SqlServer.NetFramework20
{
    public class SqlCommandExecutor20Adapter : DbCommandExecutor<SqlCommand>
    {
        ...
        public override Task ExecuteNonQueryAsync(SqlCommand command) => Task.CompletedTask;

        public override Task ExecuteNonQueryAsync(SqlCommand command, CancellationToken cancellationToken) => Task.CompletedTask;

        public override void ExecuteScalar(SqlCommand command) => _sqlCommandExecutor20.ExecuteScalar(command);

        public override Task ExecuteScalarAsync(SqlCommand command) => Task.CompletedTask;

        public override Task ExecuteScalarAsync(SqlCommand command, CancellationToken cancellationToken) => Task.CompletedTask;
        ...
        public override Task ExecuteReaderAsync(SqlCommand command) => Task.CompletedTask;

        public override Task ExecuteReaderAsync(SqlCommand command, CommandBehavior behavior) => Task.CompletedTask;

        public override Task ExecuteReaderAsync(SqlCommand command, CancellationToken cancellationToken) => Task.CompletedTask;

        public override Task ExecuteReaderAsync(SqlCommand command, CommandBehavior behavior, CancellationToken cancellationToken) => Task.CompletedTask;
    }
}
