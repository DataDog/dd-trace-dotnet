...
namespace Samples.AzureServiceBus.APM
{
    ...
    public class Program
    {
        ...
        private static async Task TestServiceBusMessageBatchAsync(ServiceBusSender sender, ServiceBusReceiver receiver)
        {
            ...
            Console.WriteLine($"Created batch with MaxSize: {messageBatch.MaxSizeInBytes} bytes");
            ...
            Console.WriteLine($"Batch now contains {messageBatch.Count} messages, total size: {messageBatch.SizeInBytes} bytes");
