...
namespace LogsInjection.Log4Net.VersionConflict_2x
{
    public class Program
    {
        ...
        private static void RunLoggingProcedure(ILog log)
        {
            log.Info($"{ExcludeMessagePrefix}Starting manual1 Datadog scope.");
                    ...
                    using (Tracer.Instance.StartActive("manual3"))
                    {
                        ...
                        using (TracerUtils.StartAutomaticTrace("automatic4"))
                        {
                            ...
                            using (TracerUtils.StartAutomaticTrace("automatic5"))
                            {
                                ...
                                {
                                    log.Info($"Trace: manual1-automatic2-manual3-automatic4-automatic5-manual6");
                                }
            ...
            log.Info($"{ExcludeMessagePrefix}Exited manual1 Datadog scope.");
        }
