...
echo "sha=$sha"
echo "SOURCE_PIPELINE_PULLREQUEST_SOURCECOMMITID=$SOURCE_PIPELINE_PULLREQUEST_SOURCECOMMITID"
...
repo=${2-${SYSTEM_PULLREQUEST_SOURCEREPOSITORYURI-${BUILD_REPOSITORY_URI}}}
commit_sha=${3-${SYSTEM_PULLREQUEST_SOURCECOMMITID-${SOURCE_PIPELINE_PULLREQUEST_SOURCECOMMITID-${BUILD_SOURCEVERSION}}}}
