...
echo "FORCE_APPSEC_THROUGHPUT_RUN=$FORCE_APPSEC_THROUGHPUT_RUN"
echo "IS_APPSEC_CHANGED=$IS_APPSEC_CHANGED"
echo "IS_APPSEC_CHANGED2=$IS_APPSEC_CHANGED2"
echo "IS_APPSEC_CHANGED3=$IS_APPSEC_CHANGED3"
...
if [ "$1" = "linux" ]; then
	...
	if [ "$FORCE_APPSEC_THROUGHPUT_RUN" == "true" || "$IS_APPSEC_CHANGED" == "true" || "$FORCE_APPSEC_THROUGHPUT_RUN" == "True" || "$IS_APPSEC_CHANGED" == "True"]; then
