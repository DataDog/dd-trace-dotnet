@echo off
IF EXIST results_Samples.FakeDbCommand.windows.netfx.json DEL /F results_Samples.FakeDbCommand.windows.netfx.json
...
echo *********************
dotnet timeit Samples.FakeDbCommand.windows.netfx.json
