...
// Cross-platform replacement for the previous profiler/run-scenario.sh helper.
//
// Usage (Linux native, or through tracer/build_in_docker.{sh,ps1} from any host):
//     ./tracer/build.sh           RunProfilerScenario --scenario 5 --scenario-timeout 30
//     ./tracer/build_in_docker.sh RunProfilerScenario --scenario 5 --scenario-timeout 30
//
// Scenario IDs are values of the `Scenario` enum in
