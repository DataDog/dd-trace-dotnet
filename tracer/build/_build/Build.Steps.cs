...
partial class Build
{
    ...
    Target CompileNativeSrcMacOs => _ => _
        ...
        .Executes(() =>
        {
            ...
            // Build native
            CMake.Value(
                arguments: $"-DCMAKE_MAKE_PROGRAM=make -DCMAKE_CXX_COMPILER=clang++ -DCMAKE_C_COMPILER=clang -B {buildDirectory} -S {RootDirectory} -DCMAKE_BUILD_TYPE={BuildConfiguration}",
