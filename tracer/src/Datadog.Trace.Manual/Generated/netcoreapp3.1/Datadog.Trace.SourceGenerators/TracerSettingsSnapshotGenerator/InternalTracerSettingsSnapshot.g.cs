...
{
    internal InternalTracerSettingsSnapshot(Datadog.Trace.Internal.Configuration.InternalTracerSettings settings)
    {
    ...
    internal void RecordChanges(Datadog.Trace.Internal.Configuration.InternalTracerSettings settings, IConfigurationTelemetry telemetry)
    {
    ...
    partial void AdditionalInitialization(Datadog.Trace.Internal.Configuration.InternalTracerSettings settings);
    partial void RecordAdditionalChanges(Datadog.Trace.Internal.Configuration.InternalTracerSettings settings, IConfigurationTelemetry telemetry);
}