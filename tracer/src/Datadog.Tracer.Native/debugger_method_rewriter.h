...
private:
    ...
    HRESULT LoadArgument(bool isStatic, const ILRewriterWrapper& rewriterWrapper, int argumentIndex,
                         const TypeSignature& argument) const;
    HRESULT LoadLocal(const ILRewriterWrapper& rewriterWrapper, int localIndex, const TypeSignature& argument) const;
    HRESULT WriteCallsToLogArgOrLocal(ModuleMetadata& moduleMetadata, DebuggerTokens* debuggerTokens, bool isStatic,
    ...
    HRESULT WriteCallsToLogArg(ModuleMetadata& moduleMetadata, DebuggerTokens* debuggerTokens, bool isStatic,
                               const std::vector<TypeSignature>& args, int numArgs, ILRewriterWrapper& rewriterWrapper,
                               ULONG callTargetStateIndex, ILInstr** beginCallInstruction, ProbeType probeType,
                               mdFieldDef isReEntryFieldTok = mdFieldDefNil) const;
    HRESULT WriteCallsToLogLocal(ModuleMetadata& moduleMetadata, DebuggerTokens* debuggerTokens, bool isStatic,
    ...
    HRESULT ApplyLogCalls(int instrumentedMethodIndex, LineProbeDefinitions& lineProbes, ModuleID module_id,
                          ...
                          ILRewriterWrapper& rewriterWrapper, ULONG callTargetStateIndex,
                          std::vector<EHClause>& lineProbesEHClauses, bool isAsyncMethod) const;

    HRESULT CallLineProbe(int instrumentedMethodIndex, ModuleID module_id, ModuleMetadata& module_metadata,
    ...
    HRESULT ApplyLineProbes(int instrumentedMethodIndex, LineProbeDefinitions& lineProbes, ModuleID module_id,
                            ModuleMetadata& module_metadata, FunctionInfo* caller, DebuggerTokens* debuggerTokens,
                            mdToken function_token, bool isStatic, std::vector<TypeSignature>& methodArguments,
                            int numArgs, ILRewriter& rewriter, std::vector<TypeSignature>& methodLocals, int numLocals,
                            ILRewriterWrapper& rewriterWrapper, ULONG lineProbeCallTargetStateIndex,
                            std::vector<EHClause>& lineProbesEHClauses, bool isAsyncMethod) const;
    ...
    HRESULT ApplyMethodProbe(const MethodProbeDefinitions& methodProbes, ModuleID module_id,
                             ...
                             mdToken callTargetReturnToken, ILInstr* firstInstruction, int instrumentedMethodIndex,
    ...
    HRESULT ApplyMethodSpanProbe(ModuleID module_id, ModuleMetadata& module_metadata, FunctionInfo* caller,
                                 ...
                                 bool isVoid, bool isStatic, const std::vector<TypeSignature>& methodArguments,
                                 int numArgs, const std::shared_ptr<SpanProbeOnMethodDefinition>& spanProbe,
                                 ...
                                 int instrumentedMethodIndex, ILInstr*& beforeLineProbe,
                                 std::vector<EHClause>& newClauses) const;

    HRESULT EndAsyncMethodProbe(ILRewriterWrapper& rewriterWrapper, ModuleMetadata& module_metadata,
                                ...
                                int numLocals, ULONG callTargetReturnIndex, mdFieldDef isReEntryFieldTok,
    ...
    HRESULT ApplyAsyncMethodProbe(const MethodProbeDefinitions& methodProbes, ModuleID module_id,
                                  ...
                                  DebuggerTokens* debugger_tokens, mdToken function_token, bool isStatic,
                                  TypeSignature* methodReturnType, const std::vector<TypeSignature>& methodLocals,
                                  ...
                                  std::vector<EHClause>& newClauses) const;
    HRESULT ApplyAsyncMethodSpanProbe(const std::shared_ptr<SpanProbeOnMethodDefinition>& spanProbe, ModuleID moduleId,
    ...
    HRESULT Rewrite(RejitHandlerModule* moduleHandler, RejitHandlerModuleMethod* methodHandler,
                    ICorProfilerFunctionControl* pFunctionControl, MethodProbeDefinitions& methodProbes,
                    LineProbeDefinitions& lineProbes, SpanProbeOnMethodDefinitions& spanProbesOnMethod) const;
...
public:
    ...
    static HRESULT IsTypeImplementIAsyncStateMachine(const ComPtr<IMetaDataImport2>& metadataImport, ULONG32 typeToken,
    ...
    static void MarkAllProbesAsError(MethodProbeDefinitions& methodProbes, LineProbeDefinitions& lineProbes,
                                     SpanProbeOnMethodDefinitions& spanOnMethodProbes, const WSTRING& reasoning);
