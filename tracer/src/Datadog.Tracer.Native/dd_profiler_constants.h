...
const shared::WSTRING skip_assembly_prefixes[]{
    ...
    WStr("System.Xml"),
    WStr("testhost"),
    WStr("Microsoft.TestPlatform"),
    WStr("Microsoft.VisualStudio.TestPlatform")
};
...
const shared::WSTRING managed_profiler_full_assembly_version =
    WStr("Datadog.Trace, Version=2.23.0.0, Culture=neutral, PublicKeyToken=def86d061d0d2eeb");
