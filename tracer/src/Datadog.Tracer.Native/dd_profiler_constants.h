...
const shared::WSTRING managed_profiler_full_assembly_version =
    WStr("Datadog.Trace, Version=2.49.0.0, Culture=neutral, PublicKeyToken=def86d061d0d2eeb");
...
const shared::WSTRING exporter_bindings_type_name = WStr("Datadog.Trace.Agent.Native.ExporterBindings+NativeMethods");
