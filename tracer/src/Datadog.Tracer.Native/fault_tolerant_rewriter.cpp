                                                           ...
                                                           ICorProfilerFunctionControl* pFunctionControl)
{
    ...
    std::vector<MethodIdentifier> methods = {{moduleId, methodIdOfOriginalMethod},
                                             {moduleId, methodIdOfInstrumentedMethod}};
    auto requests = m_rejit_handler->GetRejitRequests(methods);
    m_rejit_handler->EnqueueRequestRejit(std::move(requests), nullptr);
