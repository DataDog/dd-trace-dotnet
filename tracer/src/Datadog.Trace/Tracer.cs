...
namespace Datadog.Trace
{
    ...
    public class Tracer : ITracer, IDatadogTracer
    {
        ...
        IScope ITracer.ActivateSpan(ISpan span)
        {
        ...
        /// <returns>A Scope object wrapping this span.</returns>
        IScope ITracer.ActivateSpan(ISpan span, bool finishOnClose)
        {
        ...
        /// <param name="ignoreActiveScope">If set the span will not be a child of the currently active span</param>
        /// <returns>The newly created span</returns>
        ISpan ITracer.StartSpan(string operationName, ISpanContext parent, string serviceName, DateTimeOffset? startTime, bool ignoreActiveScope)
        {
        ...
        internal SpanContext CreateSpanContext(ISpanContext parent = null, string serviceName = null, bool ignoreActiveScope = false, ulong? traceId = null, ulong? spanId = null)
        {
            ...
            {
                parent = TracerManager.ScopeManager.Active?.InternalSpan?.InternalContext;
            }
