...
#pragma warning restore DD0002
        ...
        ISpan IDatadogOpenTracingTracer.StartSpan(string operationName, ISpanContext parent, string serviceName, DateTimeOffset? startTime, bool ignoreActiveScope)
        {
            ...
            var spanContext = CreateSpanContext(
                ...
                serviceNameSource: serviceName is not null ? Configuration.Schema.ServiceNameMetadata.Manual : null);
        ...
        internal MaybeRecordedSpanContext CreateSpanContext(string operationName, string resourceName, ISpanContext parent = null, string serviceName = null, string serviceNameSource = null, TraceId traceId = default, ulong spanId = 0, string rawTraceId = null, string rawSpanId = null)
        {
            var spanContext = CreateInnerSpanContext(parent, serviceName, serviceNameSource, traceId, spanId, rawTraceId, rawSpanId);
        ...
        private SpanContext CreateInnerSpanContext(ISpanContext parent = null, string serviceName = null, string serviceNameSource = null, TraceId traceId = default, ulong spanId = 0, string rawTraceId = null, string rawSpanId = null)
        {
