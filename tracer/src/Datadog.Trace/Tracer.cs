    ...
    public class Tracer : ITracer, IDatadogTracer, IDatadogOpenTracingTracer
    {
        ...
        public static void AddMetaStructData()
        {
            ...
            if (rootSpan != null)
            {
                ...
                rootSpan.SetTag("_dd.appsec.json", "{\"triggers\":[{\"stack_id\": \"213123213123213\",\"rule\":{\"id\":\"rasp-001-001\",\"name\":\"Path traversal attack\",\"tags\":{\"category\":\"vulnerability_trigger\",\"type\":\"lfi\"}},\"rule_matches\":[{\"operator\":\"lfi_detector\",\"operator_value\":null,\"parameters\":[{\"address\":null,\"highlight\":[\"/etc/password\"],\"key_path\":null,\"value\":null}]}]}]}");
                rootSpan.SetTag("_dd.origin", "appsec");
                rootSpan.SetTag("appsec.blocked", "true");
                rootSpan.SetTag("appsec.event", "true");
            }
        }
