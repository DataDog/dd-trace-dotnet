...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.RabbitMQ
{
    ...
    public class QueueBindIntegration
    {
        ...
        {
            return new CallTargetState(RabbitMQIntegration.CreateScope(InternalTracer.Instance, out _, Command, InternalSpanKinds.Client, queue: queue, exchange: exchange, routingKey: routingKey, host: instance?.Session?.Connection?.Endpoint?.HostName));
        }
