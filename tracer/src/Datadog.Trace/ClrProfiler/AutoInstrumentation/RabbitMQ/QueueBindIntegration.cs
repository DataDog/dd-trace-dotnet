...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.RabbitMQ
{
    ...
    public class QueueBindIntegration
    {
        ...
        {
            return new CallTargetState(RabbitMQIntegration.CreateScope(TracerInternal.Instance, out _, Command, SpanKinds.Client, queue: queue, exchange: exchange, routingKey: routingKey, host: instance?.Session?.Connection?.Endpoint?.HostName));
        }
