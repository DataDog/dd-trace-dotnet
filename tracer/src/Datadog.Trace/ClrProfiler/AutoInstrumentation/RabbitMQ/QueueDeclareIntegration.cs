...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.RabbitMQ
{
    ...
    public class QueueDeclareIntegration
    {
        ...
        {
            return new CallTargetState(RabbitMQIntegration.CreateScope(TracerInternal.Instance, out _, Command, SpanKinds.Client, queue: queue, host: instance?.Session?.Connection?.Endpoint?.HostName));
        }
