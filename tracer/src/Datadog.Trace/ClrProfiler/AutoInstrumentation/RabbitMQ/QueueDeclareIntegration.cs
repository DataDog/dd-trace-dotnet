...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.RabbitMQ
{
    ...
    public class QueueDeclareIntegration
    {
        ...
        {
            return new CallTargetState(RabbitMQIntegration.CreateScope(InternalTracer.Instance, out _, Command, InternalSpanKinds.Client, queue: queue, host: instance?.Session?.Connection?.Endpoint?.HostName));
        }
