...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.RabbitMQ
{
    ...
    public class ExchangeDeclareIntegration
    {
        ...
        {
            return new CallTargetState(RabbitMQIntegration.CreateScope(TracerInternal.Instance, out _, Command, SpanKinds.Client, exchange: exchange, host: instance.Session?.Connection?.Endpoint?.HostName));
        }
