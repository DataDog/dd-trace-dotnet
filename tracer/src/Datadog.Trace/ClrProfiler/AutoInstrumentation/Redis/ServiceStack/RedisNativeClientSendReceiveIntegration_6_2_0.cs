...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.Redis.ServiceStack
{
    ...
    public class RedisNativeClientSendReceiveIntegration_6_2_0
    {
        ...
        {
            Scope scope = RedisHelper.CreateScope(Tracer.Instance, IntegrationId, IntegrationName, instance.Host ?? string.Empty, instance.Port, RedisHelper.GetRawCommand(cmdWithBinaryArgs));
