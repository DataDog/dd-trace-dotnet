...
#pragma warning restore CS8605 // Unboxing a possibly null value.
                {
                    ...
                    else if (triggerType == "ServiceBus" && tracer.Settings.IsIntegrationEnabled(IntegrationId.AzureServiceBus))
                    {
                    ...
                    else if (triggerType == "EventHub" && tracer.Settings.IsIntegrationEnabled(IntegrationId.AzureEventHubs))
                    {
