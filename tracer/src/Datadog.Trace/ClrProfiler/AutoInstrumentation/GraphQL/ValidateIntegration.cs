...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.GraphQL
{
    ...
    public class ValidateIntegration
    {
        ...
        internal static CallTargetReturn<TValidationResult> OnMethodEnd<TTarget, TValidationResult>(TTarget instance, TValidationResult validationResult, Exception exception, ref CallTargetState state)
