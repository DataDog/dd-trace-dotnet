...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.GraphQL
{
    ...
    public class ValidateIntegration
    {
        ...
        public static CallTargetReturn<TValidationResult> OnMethodEnd<TTarget, TValidationResult>(TTarget instance, TValidationResult validationResult, Exception exception, ref CallTargetState state)
