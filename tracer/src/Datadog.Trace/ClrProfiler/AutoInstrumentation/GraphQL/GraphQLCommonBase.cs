...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.GraphQL
{
    internal abstract class GraphQLCommonBase
    {
        ...
        {
            var scope = tracer.StartActiveInternal(ExecuteOperationName, serviceName: tracer.CurrentTraceSettings.ServiceNames.GetServiceName(tracer, serviceName), tags: tags);
            var span = scope.Span;
