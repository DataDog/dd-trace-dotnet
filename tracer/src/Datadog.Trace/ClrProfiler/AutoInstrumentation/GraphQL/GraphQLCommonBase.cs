...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.GraphQL
{
    internal abstract class GraphQLCommonBase
    {
        ...
        protected static Scope CreateScopeFromExecuteAsync(TracerInternal tracer, IntegrationId integrationId, GraphQLTags tags, string serviceName, string queryOperationName, string source, string queryOperationType)
        {
