...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.GraphQL
{
    ...
    public class ValidateAsync4Integration
    {
        ...
        internal static TValidationResult OnAsyncMethodEnd<TTarget, TValidationResult>(TTarget instance, TValidationResult validationResult, Exception exception, ref CallTargetState state)
