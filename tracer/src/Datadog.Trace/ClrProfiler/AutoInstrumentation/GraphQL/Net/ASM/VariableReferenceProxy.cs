// <copyright file="VariableReferenceProxy.cs" company="Datadog">
...
/// <summary>
/// GraphQL.Language.AST.ArgumentRefProxy interface for ducktyping
...
/// </summary>
[DuckCopy]
internal struct VariableReferenceProxy
{
    public string Name;
}
