                ...
                if (_cachedDogStatsDPipeName == null)
                {
                    lock (_lock)
                    {
                        if (_cachedDogStatsDPipeName == null)
                        {
                            ...
                            // generate a unique name so both tracer and compat layer agree on the same pipe
                            _cachedDogStatsDPipeName = ExporterSettings.AzureFunctionsGeneratedMetricsPipeName
                                ?? ServerlessCompatPipeNameHelper.GenerateUniquePipeName("dd_dogstatsd", "DogStatsD");
                        }
                    }
                }
