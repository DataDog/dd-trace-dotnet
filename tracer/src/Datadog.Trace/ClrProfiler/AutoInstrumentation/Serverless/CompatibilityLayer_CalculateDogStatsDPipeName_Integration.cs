    ...
    public sealed class CompatibilityLayer_CalculateDogStatsDPipeName_Integration
    {
            ...
            in CallTargetState state)
        {
            ...
            try
            {
                ...
                // If no pre-generated name exists, fall back to the compat layer's own calculated name
                // since the tracer won't know about any name we generate here anyway
                var pipeName = ExporterSettings.AzureFunctionsGeneratedMetricsPipeName ?? returnValue;
