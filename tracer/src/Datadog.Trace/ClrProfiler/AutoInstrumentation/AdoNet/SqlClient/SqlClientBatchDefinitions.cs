// <copyright file="SqlClientBatchDefinitions.cs" company="Datadog">
...
[assembly: AdoNetClientInstrumentMethods(
    ...
    TypeName = "Microsoft.Data.SqlClient.SqlBatch",
    MinimumVersion = "5.2.0", // didn't exist before
    MaximumVersion = "7.*.*",
    ...
    TargetMethodAttributes = new[]
    {
        ...
        // public SqlDataReader ExecuteReader(CommandBehavior behavior = null)
        typeof(BatchExecuteReaderWithBehaviorAttribute),
        // public Task<SqlDataReader> ExecuteReaderAsync(CancellationToken cancellationToken = null)
        typeof(BatchExecuteReaderWithCancellationAsyncAttribute),
        // public Task<SqlDataReader> ExecuteReaderAsync(CommandBehavior behavior, CancellationToken cancellationToken = null)
