// <copyright file="CommandExecuteReaderWithBehaviorAndCancellationAsyncIntegration.cs" company="Datadog">
...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.AdoNet
{
    ...
    public sealed class CommandExecuteReaderWithBehaviorAndCancellationAsyncIntegration
    {
        /// <summary>
        ...
        {
            return new CallTargetState(DbScopeFactory.Cache<TTarget>.CreateDbCommandScope(Tracer.Instance, (IDbCommand)instance, ContainerMetadata.Instance.ContainerTagsHash));
        }
