...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.AdoNet
{
    ...
    public class CommandExecuteNonQueryWithBehaviorIntegration
    {
        ...
        internal static CallTargetReturn<TReturn> OnMethodEnd<TTarget, TReturn>(TTarget instance, TReturn returnValue, Exception exception, ref CallTargetState state)
        {
