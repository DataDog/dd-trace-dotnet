...
/// <summary>
/// System.Boolean Datadog.Trace.Configuration.ImmutableTracerSettings::get_LogsInjectionEnabled() calltarget instrumentation
/// </summary>
[InstrumentMethod(
...
public class LogsInjectionEnabledGetIntegration
{
    ...
    {
        TelemetryFactory.Metrics.Record(PublicApiUsage.ImmutableTracerSettings_LogsInjectionEnabled_Get);
