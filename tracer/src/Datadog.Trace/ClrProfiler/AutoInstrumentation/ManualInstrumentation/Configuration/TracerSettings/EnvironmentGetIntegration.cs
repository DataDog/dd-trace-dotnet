...
/// <summary>
/// System.String Datadog.Trace.Configuration.TracerSettings::get_Environment() calltarget instrumentation
/// </summary>
[InstrumentMethod(
...
internal sealed class EnvironmentGetIntegration
{
    internal static CallTargetState OnMethodBegin<TTarget>(TTarget instance)
    {
        TelemetryFactory.Metrics.Record(PublicApiUsage.TracerSettings_Environment_Get);
