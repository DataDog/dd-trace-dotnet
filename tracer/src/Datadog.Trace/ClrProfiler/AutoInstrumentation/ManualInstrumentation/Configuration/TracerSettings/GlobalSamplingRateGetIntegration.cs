...
/// <summary>
/// System.Nullable`1[System.Double] Datadog.Trace.Configuration.TracerSettings::get_GlobalSamplingRate() calltarget instrumentation
/// </summary>
[InstrumentMethod(
...
internal sealed class GlobalSamplingRateGetIntegration
{
    internal static CallTargetState OnMethodBegin<TTarget>(TTarget instance)
    {
        TelemetryFactory.Metrics.Record(PublicApiUsage.TracerSettings_GlobalSamplingRate_Get);
