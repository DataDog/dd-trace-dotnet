...
/// <summary>
/// System.Double Datadog.Trace.Configuration.ImmutableIntegrationSettings::get_AnalyticsSampleRate() calltarget instrumentation
/// </summary>
[InstrumentMethod(
...
public class AnalyticsSampleRateGetIntegration
{
    ...
    {
        TelemetryFactory.Metrics.Record(PublicApiUsage.ImmutableIntegrationSettings_AnalyticsSampleRate_Get);
