...
[InstrumentMethod(
    ...
    ParameterTypeNames = [ClrNames.String, ClrNames.Bool, "Nullable`1[Datadog.Trace.UserDetails]", "Nullable`1[System.Collections.Generic.IDictionary`2[System.String, System.String]]"],
...
{
    internal static CallTargetState OnMethodBegin<TTarget>(string userLogin, bool exists, UserDetails? userDetails, IDictionary<string, string>? metadata)
    {
