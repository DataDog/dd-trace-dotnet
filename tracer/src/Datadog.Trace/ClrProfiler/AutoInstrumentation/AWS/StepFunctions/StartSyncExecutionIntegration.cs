// <copyright file="StartSyncExecutionIntegration.cs" company="Datadog">
...
{
    /// <summary>
    /// AWSSDK.StepFunctions StartSyncExecution CallTarget instrumentation
    /// </summary>
    [InstrumentMethod(
        ...
        ParameterTypeNames = new[] { "Amazon.StepFunctions.Model.StartSyncExecutionRequest" },
        MinimumVersion = "3.3.0",
        MaximumVersion = "4.*.*",
        IntegrationName = AwsStepFunctionsCommon.IntegrationName)]
    [Browsable(false)]
    [EditorBrowsable(EditorBrowsableState.Never)]
    internal sealed class StartSyncExecutionIntegration
    {
