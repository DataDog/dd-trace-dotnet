...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.AWS.SDK
{
    ...
    public class RuntimePipelineInvokeSyncIntegration
    {
        ...
        internal static CallTargetReturn<TResponseContext> OnMethodEnd<TTarget, TResponseContext>(TTarget instance, TResponseContext responseContext, Exception exception, ref CallTargetState state)
