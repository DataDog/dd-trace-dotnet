...
internal sealed class PutObjectAsyncIntegration
{
    ...
    {
        if (Tracer.Instance.Settings.SpanPointersEnabled && state.Scope is not null && state.State is IPutObjectRequest request && returnValue?.Instance is not null)
        {
