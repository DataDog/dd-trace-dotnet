// <copyright file="InitiateMultipartUploadAsyncIntegration.cs" company="Datadog">
...
/// <summary>
/// AWSSDK.S3 InitiateMultipartUploadAsync CallTarget instrumentation
/// </summary>
[InstrumentMethod(
    AssemblyName = "AWSSDK.S3",
    TypeName = "Amazon.S3.AmazonS3Client",
    MethodName = "InitiateMultipartUploadAsync",
    ReturnTypeName = "System.Threading.Tasks.Task`1[Amazon.S3.Model.InitiateMultipartUploadResponse]",
    ParameterTypeNames = ["Amazon.S3.Model.InitiateMultipartUploadRequest", ClrNames.CancellationToken],
    MinimumVersion = "3.3.0",
    MaximumVersion = "4.*.*",
    IntegrationName = AwsS3Common.IntegrationName)]
[Browsable(false)]
[EditorBrowsable(EditorBrowsableState.Never)]
internal sealed class InitiateMultipartUploadAsyncIntegration
{
