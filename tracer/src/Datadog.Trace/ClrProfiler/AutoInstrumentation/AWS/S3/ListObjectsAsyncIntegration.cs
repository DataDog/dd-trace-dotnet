// <copyright file="ListObjectsAsyncIntegration.cs" company="Datadog">
...
/// <summary>
/// AWSSDK.S3 ListObjectsAsync CallTarget instrumentation
/// ListObjectsAsync has three overloaded methods, but the other two eventually
...
[InstrumentMethod(
    ...
    ParameterTypeNames = ["Amazon.S3.Model.ListObjectsRequest", ClrNames.CancellationToken],
    MinimumVersion = "3.3.0",
    MaximumVersion = "3.*.*",
    IntegrationName = AwsS3Common.IntegrationName)]
[Browsable(false)]
[EditorBrowsable(EditorBrowsableState.Never)]
public class ListObjectsAsyncIntegration
{
