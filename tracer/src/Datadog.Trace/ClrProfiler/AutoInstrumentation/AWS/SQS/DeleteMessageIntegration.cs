// <copyright file="DeleteMessageIntegration.cs" company="Datadog">
...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.AWS.SQS
{
    ...
    public class DeleteMessageIntegration
    {
        ...
        internal static CallTargetState OnMethodBegin<TTarget, TDeleteMessageRequest>(TTarget instance, TDeleteMessageRequest request)
            where TDeleteMessageRequest : IAmazonSQSRequestWithQueueUrl, IDuckType
        {
            ...
            var scope = AwsSqsCommon.CreateScopeQueueUrl(Tracer.Instance, Operation, request, out var tags);
