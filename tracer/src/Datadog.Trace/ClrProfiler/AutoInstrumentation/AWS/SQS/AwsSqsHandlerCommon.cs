...
internal static class AwsSqsHandlerCommon
{
    internal static CallTargetState BeforeSend<TSendMessageRequest>(TSendMessageRequest request, SendType sendType)
    {
        ...
        var scope = AwsSqsCommon.CreateScope(InternalTracer.Instance, sendType.OperationName, out var tags, spanKind: InternalSpanKinds.Producer);
        ...
        {
            var dataStreamsManager = InternalTracer.Instance.TracerManager.DataStreamsManager;
    ...
    internal static CallTargetState BeforeReceive(IReceiveMessageRequest request)
    {
        ...
        var scope = AwsSqsCommon.CreateScope(InternalTracer.Instance, "ReceiveMessage", out var tags, spanKind: InternalSpanKinds.Consumer);
