...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.AWS.Kinesis
{
    internal static class ContextPropagation
    {
        ...
        public static void InjectTraceIntoRecords<TRecordsRequest>(TRecordsRequest request, SpanContextInternal context)
        ...
        public static void InjectTraceIntoData<TRecordRequest>(TRecordRequest record, SpanContextInternal context)
