// <copyright file="PutRecordsAsyncV3_7Integration.cs" company="Datadog">
...
{
    /// <summary>
    /// AWSSDK.Kinesis PutRecordsAsync CallTarget instrumentation for SDK versions 3.7.0+
    /// </summary>
    [InstrumentMethod(
    ...
    public class PutRecordsAsyncV3_7Integration
    {
        ...
        {
            Console.WriteLine($"OnMethodBegin(PutRecordsAsync) NEW StreamName: {request.StreamName}");
            Console.WriteLine($"OnMethodBegin(PutRecordsAsync) NEW StreamARN: {request.StreamARN}");
