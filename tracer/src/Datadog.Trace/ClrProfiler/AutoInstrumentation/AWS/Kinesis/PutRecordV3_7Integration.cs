// <copyright file="PutRecordV3_7Integration.cs" company="Datadog">
...
{
    /// <summary>
    /// AWSSDK.Kinesis PutRecord CallTarget instrumentation for SDK versions 3.7.0+
    /// </summary>
    [InstrumentMethod(
    ...
    internal sealed class PutRecordV3_7Integration
    {
