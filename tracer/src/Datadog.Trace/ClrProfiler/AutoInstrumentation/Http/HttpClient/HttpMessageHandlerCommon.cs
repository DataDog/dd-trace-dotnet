    ...
    internal static class HttpMessageHandlerCommon
    {
            ...
            where TResponse : IHttpResponseMessage
        {
            ...
            try
            {
                ...
                {
                    scope.Span.SetHttpStatusCode(responseMessage.StatusCode, false, TracerInternal.Instance.Settings);
                }
        ...
        {
            if (implementationIntegrationId != null && !TracerInternal.Instance.Settings.IsIntegrationEnabled(implementationIntegrationId.Value))
            {
                return false;
            }
