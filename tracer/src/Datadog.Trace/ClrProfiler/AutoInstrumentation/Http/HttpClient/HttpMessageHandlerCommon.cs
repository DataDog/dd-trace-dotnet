...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.Http.HttpClient
{
    ...
    {
        public static CallTargetState OnMethodBegin<TTarget, TRequest>(TTarget instance, TRequest requestMessage, CancellationToken cancellationToken, IntegrationIds integrationId, Func<bool> isTracingEnableFunc = null)
