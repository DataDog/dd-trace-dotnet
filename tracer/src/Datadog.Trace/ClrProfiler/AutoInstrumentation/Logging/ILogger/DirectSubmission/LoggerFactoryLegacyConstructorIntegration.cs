// <copyright file="LoggerFactoryLegacyConstructorIntegration.cs" company="Datadog">
...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.Logging.ILogger.DirectSubmission
{
    ...
    public class LoggerFactoryLegacyConstructorIntegration
    {
        /// <summary>
        ...
        {
            if (!DirectLogSubmission.Instance.Settings.IsIntegrationEnabled(IntegrationIds.ILogger))
            {
