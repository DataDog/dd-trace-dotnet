// <copyright file="ActivityAddTagObjectIntegration.cs" company="Datadog">
...
{
    /// <summary>
    /// CallTarget instrumentation for <c>System.Diagnostics.Activity.AddTag(string, object?)</c>.
    /// Available on DiagnosticSource 5.0+ (the object overload was added in .NET 5).
    ...
    public sealed class ActivityAddTagObjectIntegration
    {
