// <copyright file="DeserializeBinaryRequestMessageIntegration.cs" company="Datadog">
...
{
    /// <summary>
    /// System.Runtime.Remoting.Channels.CoreChannel.DeserializeBinaryRequestMessage calltarget instrumentation
    /// </summary>
    [InstrumentMethod(
        AssemblyName = "System.Runtime.Remoting",
        TypeName = "System.Runtime.Remoting.Channels.CoreChannel",
        MethodName = "DeserializeBinaryRequestMessage",
        ReturnTypeName = "System.Runtime.Remoting.Messaging.IMessage",
        ParameterTypeNames = new[] { ClrNames.String, "System.IO.Stream", ClrNames.Bool, "System.Runtime.Serialization.Formatters.TypeFilterLevel" },
    ...
    public class DeserializeBinaryRequestMessageIntegration
    {
        private static readonly IDatadogLogger Log = DatadogLogging.GetLoggerFor(typeof(DeserializeBinaryRequestMessageIntegration));
        ...
        /// <param name="objectUri">Object URI string instance</param>
        ...
        internal static CallTargetState OnMethodBegin<TTarget, TEnum>(TTarget instance, string objectUri, Stream inputStream, bool strictBinding, TEnum securityLevel)
        {
