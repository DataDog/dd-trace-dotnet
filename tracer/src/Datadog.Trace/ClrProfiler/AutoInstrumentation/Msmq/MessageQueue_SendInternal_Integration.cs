...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.Msmq
{
    ...
    public class MessageQueue_SendInternal_Integration
    {
            ...
            where TMessageQueue : IMessageQueue
        {
            ...
            var scope = MsmqCommon.CreateScope(TracerInternal.Instance, Command, SpanKinds.Producer, instance, messageQueueTransaction != null || messageQueueTransactionType != MessageQueueTransactionType.None);
