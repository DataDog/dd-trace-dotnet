...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.Couchbase
{
    ...
    public class IIOServiceExecuteIntegration
    {
        ...
        public static CallTargetReturn<TOperationResult> OnMethodEnd<TTarget, TOperationResult>(TTarget instance, TOperationResult tResult, Exception exception, ref CallTargetState state)
        {
