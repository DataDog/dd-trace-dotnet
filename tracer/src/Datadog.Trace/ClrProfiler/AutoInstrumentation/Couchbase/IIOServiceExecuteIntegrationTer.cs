// <copyright file="IIOServiceExecuteIntegrationTer.cs" company="Datadog">
...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.Couchbase
{
    ...
    public class IIOServiceExecuteIntegrationTer
    {
        private static readonly IDatadogLogger Log = DatadogLogging.GetLoggerFor(typeof(IIOServiceExecuteIntegrationTer));
