...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.Grpc
{
    internal static class GrpcCommon
    {
        ...
        public static void AddGrpcTags(GrpcTags tags, InternalTracer tracer, int grpcType, string? name, string? path, string? serviceName, bool analyticsEnabledWithGlobalSetting = false)
            => AddGrpcTags(tags, tracer, GetGrpcMethodKind(grpcType), name, path, serviceName, analyticsEnabledWithGlobalSetting);

        public static void AddGrpcTags(GrpcTags tags, InternalTracer tracer, string grpcType, string? name, string? path, string? serviceName, bool analyticsEnabledWithGlobalSetting = false)
        {
        ...
        public static void RecordFinalClientSpanStatus(InternalTracer tracer, int grpcStatusCode, string errorMessage, Exception? ex)
        {
