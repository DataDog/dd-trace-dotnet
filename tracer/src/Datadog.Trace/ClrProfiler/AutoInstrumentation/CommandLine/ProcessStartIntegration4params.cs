// <copyright file="ProcessStartIntegration4params.cs" company="Datadog">
...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.Process
{
   ...
   IntegrationName = nameof(Configuration.IntegrationId.CommandExecution))]
    public class ProcessStartIntegration4params
    {
        /// <summary>
        ...
        internal static CallTargetState OnMethodBegin<TTarget>(ref string filename, ref string userName, ref SecureString password, ref string domain)
        {
            return new CallTargetState(scope: ProcessStartCommon.CreateScope(filename, null, userName, domain));
        }
