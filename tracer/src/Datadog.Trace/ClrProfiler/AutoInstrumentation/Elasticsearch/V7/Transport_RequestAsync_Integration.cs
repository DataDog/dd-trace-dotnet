...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.Elasticsearch.V7
{
    ...
    public class Transport_RequestAsync_Integration
    {
        ...
        {
            var scope = ElasticsearchNetCommon.CreateScope(InternalTracer.Instance, ElasticsearchV7Constants.IntegrationId, method?.ToString(), requestParameters, out var tags);
