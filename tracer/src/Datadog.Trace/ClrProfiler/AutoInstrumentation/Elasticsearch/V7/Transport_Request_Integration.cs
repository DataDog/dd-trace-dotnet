...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.Elasticsearch.V7
{
    ...
    public class Transport_Request_Integration
    {
        ...
        public static CallTargetState OnMethodBegin<TTarget, THttpMethod, TPostData, TRequestParameters>(TTarget instance, THttpMethod method, string path, TPostData postData, TRequestParameters requestParameters)
        {
