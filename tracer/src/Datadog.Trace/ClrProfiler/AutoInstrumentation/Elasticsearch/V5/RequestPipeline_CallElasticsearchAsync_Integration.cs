...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.Elasticsearch.V5
{
    ...
    public class RequestPipeline_CallElasticsearchAsync_Integration
    {
        ...
        {
            var scope = ElasticsearchNetCommon.CreateScope(TracerInternal.Instance, ElasticsearchV5Constants.IntegrationId, instance.DuckCast<RequestPipelineStruct>(), requestData);
