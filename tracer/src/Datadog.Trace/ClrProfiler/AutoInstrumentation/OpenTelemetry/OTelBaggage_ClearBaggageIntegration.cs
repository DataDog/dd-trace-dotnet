...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.OpenTelemetry
{
    ...
    public sealed class OTelBaggage_ClearBaggageIntegration
    {
        ...
        internal static CallTargetReturn<TReturn> OnMethodEnd<TTarget, TReturn>(TTarget instance, TReturn returnValue, Exception exception, in CallTargetState state)
        {
            ...
            {
                // Although the OpenTelemetry Baggage model is immutable (this method returns an empty Baggage instance),
                // the Datadog Baggage model is mutable, allowing the user to get the Datadog.Trace.Baggage.Current once and continue to mutate that reference.
                // To ensure that updates from OpenTelemetry are reflected in the Datadog Baggage model, we must clear the current Datadog Baggage.
