    ...
    internal static class AspNetWebApi2Integration
    {
        ...
        internal static Scope CreateScope(IHttpControllerContext controllerContext, out AspNetTags tags)
        {
            ...
            try
            {
                ...
                {
                    SpanContextPropagator.Instance.ExtractHeaderTags(scope.Span, headersCollection.Value, tracer.Settings.HeaderTags, SpanContextPropagator.HttpRequestHeadersTagPrefix, request.Headers.UserAgent.ToString());
                }
