...
internal sealed class TestCommand5ctorIntegration
{
    ...
    {
        if (!DotnetCommon.DotnetTestIntegrationEnabled || TestOptimization.Instance.Settings.CodeCoverageEnabled != true || msbuildArgs is null)
        {
