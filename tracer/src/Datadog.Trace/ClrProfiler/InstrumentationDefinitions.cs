...
namespace Datadog.Trace.ClrProfiler
{
    internal static partial class InstrumentationDefinitions
    {
        ...
        {
            var definitions = GetDefinitionsArray();
            if (ServerlessInstrumentation.Serverless.IsRunningInLambda())
            {
                definitions = ServerlessInstrumentation.Serverless.GetDefinitions(definitions, assemblyFullName);
            }
