...
internal static class NativeCallTargetUnmanagedMemoryHelper
{
...
#if NETCOREAPP
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static unsafe IntPtr WriteReadOnlySpanUtf16String(ReadOnlySpan<byte> value)
    {
        return (IntPtr)Unsafe.AsPointer(ref Unsafe.AsRef(in value.GetPinnableReference()));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IntPtr WriteReadOnlySpanUtf16StringArray(ReadOnlySpan<byte> arrayItem1)
    {
        var unmanagedArray = Allocate(SizeOfPointer);
        Marshal.WriteIntPtr(unmanagedArray, 0, WriteReadOnlySpanUtf16String(arrayItem1));
        return unmanagedArray;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IntPtr WriteReadOnlySpanUtf16StringArray(
        ReadOnlySpan<byte> arrayItem1,
        ReadOnlySpan<byte> arrayItem2)
    {
        var unmanagedArray = Allocate(2 * SizeOfPointer);
        Marshal.WriteIntPtr(unmanagedArray, 0, WriteReadOnlySpanUtf16String(arrayItem1));
        Marshal.WriteIntPtr(unmanagedArray, 1 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem2));
        return unmanagedArray;
    }
    ...
    public static IntPtr WriteReadOnlySpanUtf16StringArray(
        ReadOnlySpan<byte> arrayItem1,
        ReadOnlySpan<byte> arrayItem2,
        ReadOnlySpan<byte> arrayItem3)
    {
        var unmanagedArray = Allocate(3 * SizeOfPointer);
        Marshal.WriteIntPtr(unmanagedArray, 0, WriteReadOnlySpanUtf16String(arrayItem1));
        Marshal.WriteIntPtr(unmanagedArray, 1 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem2));
        Marshal.WriteIntPtr(unmanagedArray, 2 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem3));
        return unmanagedArray;
    }
    ...
    public static IntPtr WriteReadOnlySpanUtf16StringArray(
        ...
        ReadOnlySpan<byte> arrayItem2,
        ReadOnlySpan<byte> arrayItem3,
        ReadOnlySpan<byte> arrayItem4)
    {
        var unmanagedArray = Allocate(4 * SizeOfPointer);
        Marshal.WriteIntPtr(unmanagedArray, 0, WriteReadOnlySpanUtf16String(arrayItem1));
        Marshal.WriteIntPtr(unmanagedArray, 1 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem2));
        Marshal.WriteIntPtr(unmanagedArray, 2 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem3));
        Marshal.WriteIntPtr(unmanagedArray, 3 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem4));
        return unmanagedArray;
    }
        ...
        ReadOnlySpan<byte> arrayItem5)
    {
        ...
        Marshal.WriteIntPtr(unmanagedArray, 2 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem3));
        Marshal.WriteIntPtr(unmanagedArray, 3 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem4));
        Marshal.WriteIntPtr(unmanagedArray, 4 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem5));
        return unmanagedArray;
    }
        ...
        ReadOnlySpan<byte> arrayItem6)
    {
        ...
        Marshal.WriteIntPtr(unmanagedArray, 3 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem4));
        Marshal.WriteIntPtr(unmanagedArray, 4 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem5));
        Marshal.WriteIntPtr(unmanagedArray, 5 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem6));
        return unmanagedArray;
    }
        ...
        ReadOnlySpan<byte> arrayItem7)
    {
        ...
        Marshal.WriteIntPtr(unmanagedArray, 4 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem5));
        Marshal.WriteIntPtr(unmanagedArray, 5 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem6));
        Marshal.WriteIntPtr(unmanagedArray, 6 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem7));
        return unmanagedArray;
    }
        ...
        ReadOnlySpan<byte> arrayItem8)
    {
        ...
        Marshal.WriteIntPtr(unmanagedArray, 5 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem6));
        Marshal.WriteIntPtr(unmanagedArray, 6 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem7));
        Marshal.WriteIntPtr(unmanagedArray, 7 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem8));
        return unmanagedArray;
    }
        ...
        ReadOnlySpan<byte> arrayItem9)
    {
        ...
        Marshal.WriteIntPtr(unmanagedArray, 6 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem7));
        Marshal.WriteIntPtr(unmanagedArray, 7 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem8));
        Marshal.WriteIntPtr(unmanagedArray, 8 * SizeOfPointer, WriteReadOnlySpanUtf16String(arrayItem9));
        return unmanagedArray;
    }
#endif
}
