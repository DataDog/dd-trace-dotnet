            ...
            try
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        if (raspInstrumentationRequired || iastEnabled)
                        {
                            ...
                            if (raspInstrumentationRequired)
                            {
                                Log.Debug("Rasp instrumentation is required");
                            }
                            else
                            {
                                Log.Debug("Rasp instrumentation is not required");
                            }
