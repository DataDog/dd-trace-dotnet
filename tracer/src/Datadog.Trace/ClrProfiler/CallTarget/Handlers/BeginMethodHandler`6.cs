...
internal static class BeginMethodHandler<TIntegration, TTarget, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>
{
    ...
    static BeginMethodHandler()
    {
        try
        {
            ...
            {
                _invokeDelegate = CallTargetAotEngine.CreateBeginDelegate<InvokeDelegate>(typeof(TIntegration), typeof(TTarget), typeof(TArg1), typeof(TArg2), typeof(TArg3), typeof(TArg4), typeof(TArg5), typeof(TArg6));
            }
            else
            {
