    ...
    internal static unsafe class BeginMethodHandler<TIntegration, TTarget, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>
    {
        ...
        static BeginMethodHandler()
        {
            ...
            try
            {
                ...
                {
                    _invokePointer = (delegate*<TTarget, ref TArg1, ref TArg2, ref TArg3, ref TArg4, ref TArg5, ref TArg6, CallTargetState>)_dynamicMethod.MethodHandle.GetFunctionPointer();
                }
            }
            catch (Exception ex)
            {
