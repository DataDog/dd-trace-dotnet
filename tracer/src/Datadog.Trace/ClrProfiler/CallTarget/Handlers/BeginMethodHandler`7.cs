...
internal static class BeginMethodHandler<TIntegration, TTarget, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7>
{
    ...
    static BeginMethodHandler()
    {
        try
        {
            ...
            {
                _invokeDelegate = CallTargetAotEngine.CreateBeginDelegate<InvokeDelegate>(typeof(TIntegration), typeof(TTarget), typeof(TArg1), typeof(TArg2), typeof(TArg3), typeof(TArg4), typeof(TArg5), typeof(TArg6), typeof(TArg7));
            }
            else
            {
                ...
                if (IntegrationMapper.CreateBeginMethodDelegate(typeof(TIntegration), typeof(TTarget), [tArg1ByRef, tArg2ByRef, tArg3ByRef, tArg4ByRef, tArg5ByRef, tArg6ByRef, tArg7ByRef]) is { } dynMethod)
                {
        ...
        {
            _invokeDelegate ??= (TTarget? _, ref TArg1? _, ref TArg2? _, ref TArg3? _, ref TArg4? _, ref TArg5? _, ref TArg6? _, ref TArg7? _) => CallTargetState.GetDefault();
        }
    }
