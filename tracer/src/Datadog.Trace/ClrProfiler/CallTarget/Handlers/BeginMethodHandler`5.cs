...
{
    internal static unsafe class BeginMethodHandler<TIntegration, TTarget, TArg1, TArg2, TArg3, TArg4, TArg5>
    {
        private static readonly DynamicMethod _dynamicMethod;
        private static readonly delegate*<TTarget, ref TArg1, ref TArg2, ref TArg3, ref TArg4, ref TArg5, CallTargetState> _invokePointer;
        ...
        static BeginMethodHandler()
        {
            ...
            try
            {
                ...
                _dynamicMethod = IntegrationMapper.CreateBeginMethodDelegate(typeof(TIntegration), typeof(TTarget), new[] { tArg1ByRef, tArg2ByRef, tArg3ByRef, tArg4ByRef, tArg5ByRef });
                if (_dynamicMethod != null)
                {
                    _invokePointer = (delegate*<TTarget, ref TArg1, ref TArg2, ref TArg3, ref TArg4, ref TArg5, CallTargetState>)_dynamicMethod.MethodHandle.GetFunctionPointer();
                }
            }
            catch (Exception ex)
            {
        ...
        private static CallTargetState EmptyInvoke(TTarget instance, ref TArg1 arg1, ref TArg2 arg2, ref TArg3 arg3, ref TArg4 arg4, ref TArg5 arg5) => CallTargetState.GetDefault();
        ...
        internal static CallTargetState Invoke(TTarget instance, ref TArg1 arg1, ref TArg2 arg2, ref TArg3 arg3, ref TArg4 arg4, ref TArg5 arg5)
        {
            ...
            return new CallTargetState(activeScope, spanContextRaw, _invokePointer(instance, ref arg1, ref arg2, ref arg3, ref arg4, ref arg5));
        }
    }
}
