...
namespace Datadog.Trace.ClrProfiler.CallTarget.Handlers
{
    internal static class BeginMethodHandler<TIntegration, TTarget, TArg1, TArg2, TArg3, TArg4, TArg5>
    {
        ...
        internal static unsafe void EnsureInitializedForNativeAot(delegate*<TTarget, ref TArg1, ref TArg2, ref TArg3, ref TArg4, ref TArg5, CallTargetState> invokeDelegate)
        {
            if (_invokeDelegate is null)
            {
                ...
                {
                    _invokeDelegate = (TTarget instance, ref TArg1 arg1, ref TArg2 arg2, ref TArg3 arg3, ref TArg4 arg4, ref TArg5 arg5) => invokeDelegate(instance, ref arg1, ref arg2, ref arg3, ref arg4, ref arg5);
                }
            }
        }
#endif
