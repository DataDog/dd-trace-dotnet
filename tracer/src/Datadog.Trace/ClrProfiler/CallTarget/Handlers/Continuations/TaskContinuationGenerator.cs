    ...
    internal class TaskContinuationGenerator<TIntegration, TTarget, TReturn> : ContinuationGenerator<TTarget, TReturn>
    {
        ...
        private class SyncCallbackHandler : CallbackHandler
        {
            ...
            public unsafe SyncCallbackHandler(IntPtr continuation, bool preserveContext)
            {
                ...
                _continuation = (TTarget target, object returnValue, Exception exception, in CallTargetState state) => callback(target, returnValue, exception, in state);
                _preserveContext = preserveContext;
            }
        ...
        private class AsyncCallbackHandler : CallbackHandler
        {
            ...
            public unsafe AsyncCallbackHandler(IntPtr asyncContinuation, bool preserveContext)
            {
                ...
                _asyncContinuation = (TTarget target, object returnValue, Exception exception, in CallTargetState state) => callback(target, returnValue, exception, in state);
                _preserveContext = preserveContext;
            }
