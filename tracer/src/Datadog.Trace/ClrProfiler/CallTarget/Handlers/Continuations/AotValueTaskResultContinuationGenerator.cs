// <copyright file="AotValueTaskResultContinuationGenerator.cs" company="Datadog">
...
/// <summary>
/// Executes typed <see cref="System.Threading.Tasks.ValueTask{TResult}"/> async-end continuations in AOT mode by
/// binding directly to the generated continuation wrapper registered in <see cref="CallTargetAotEngine"/>.
/// </summary>
internal sealed class AotValueTaskResultContinuationGenerator<TIntegration, TTarget, TReturn> : ContinuationGenerator<TTarget, TReturn>
{
    private static readonly Executor Resolver;

    static AotValueTaskResultContinuationGenerator()
    {
