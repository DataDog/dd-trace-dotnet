...
namespace Datadog.Trace.RemoteConfigurationManagement.Transport
{
    ...
    {
        public static IRemoteConfigurationApi Create(ImmutableExporterSettingsInternal exporterSettings, RemoteConfigurationSettings remoteConfigurationSettings, IDiscoveryService discoveryService)
        {
