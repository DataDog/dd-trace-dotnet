// <copyright file="TestSessionInternal.cs" company="Datadog">
...
/// </summary>
public sealed class TestSessionInternal
{
    private static readonly AsyncLocal<TestSessionInternal?> CurrentSession = new();
    private static readonly HashSet<TestSessionInternal> OpenedTestSessions = new();
    ...
    private TestSessionInternal(string? command, string? workingDirectory, string? framework, DateTimeOffset? startDate, bool propagateEnvironmentVariables)
    {
    ...
    /// </summary>
    internal static TestSessionInternal? Current
    {
    ...
    /// </summary>
    internal static IReadOnlyCollection<TestSessionInternal> ActiveTestSessions
    {
        get
        {
            lock (OpenedTestSessions)
    ...
    [PublicApi]
    public static TestSessionInternal GetOrCreate(string command)
    {
    ...
    /// <returns>New test session instance</returns>
    [PublicApi]
    public static TestSessionInternal GetOrCreate(string command, string workingDirectory)
    {
        TelemetryFactory.Metrics.RecordCountCIVisibilityManualApiEvent(MetricTags.CIVisibilityTestingEventType.Session);
    ...
    /// <returns>New test session instance</returns>
    [PublicApi]
    public static TestSessionInternal GetOrCreate(string command, string workingDirectory, string framework)
    {
        TelemetryFactory.Metrics.RecordCountCIVisibilityManualApiEvent(MetricTags.CIVisibilityTestingEventType.Session);
    ...
    /// <returns>New test session instance</returns>
    [PublicApi]
    public static TestSessionInternal GetOrCreate(string command, string workingDirectory, string framework, DateTimeOffset startDate)
    {
        TelemetryFactory.Metrics.RecordCountCIVisibilityManualApiEvent(MetricTags.CIVisibilityTestingEventType.Session);
    ...
    /// <returns>New test session instance</returns>
    [PublicApi]
    public static TestSessionInternal GetOrCreate(string command, string? workingDirectory, string? framework, DateTimeOffset? startDate, bool propagateEnvironmentVariables)
    {
        TelemetryFactory.Metrics.RecordCountCIVisibilityManualApiEvent(MetricTags.CIVisibilityTestingEventType.Session);
    ...
    /// <param name="propagateEnvironmentVariables">Propagate session data through environment variables (out of proc session)</param>
    /// <returns>New test session instance</returns>
    internal static TestSessionInternal InternalGetOrCreate(string command, string? workingDirectory, string? framework, DateTimeOffset? startDate, bool propagateEnvironmentVariables = false)
    {
        ...
        return new TestSessionInternal(command, workingDirectory, framework, startDate, propagateEnvironmentVariables);
    }
    ...
    [PublicApi]
    public TestModuleInternal CreateModule(string name)
    {
    ...
    /// <param name="name">Test module name</param>
    /// <returns>New test module instance</returns>
    internal TestModuleInternal InternalCreateModule(string name)
    {
        return new TestModuleInternal(name, null, null, null, Tags);
    }
    ...
    /// <returns>New test module instance</returns>
    [PublicApi]
    public TestModuleInternal CreateModule(string name, string framework, string frameworkVersion)
    {
        TelemetryFactory.Metrics.RecordCountCIVisibilityManualApiEvent(MetricTags.CIVisibilityTestingEventType.Module);
    ...
    /// <param name="frameworkVersion">Testing framework version</param>
    /// <returns>New test module instance</returns>
    internal TestModuleInternal InternalCreateModule(string name, string framework, string frameworkVersion)
    {
        return new TestModuleInternal(name, framework, frameworkVersion, null, Tags);
    }
    ...
    /// <returns>New test module instance</returns>
    [PublicApi]
    public TestModuleInternal CreateModule(string name, string framework, string frameworkVersion, DateTimeOffset startDate)
    {
        TelemetryFactory.Metrics.RecordCountCIVisibilityManualApiEvent(MetricTags.CIVisibilityTestingEventType.Module);
    ...
    /// <param name="startDate">Test session start date</param>
    /// <returns>New test module instance</returns>
    internal TestModuleInternal InternalCreateModule(string name, string framework, string frameworkVersion, DateTimeOffset startDate)
    {
        return new TestModuleInternal(name, framework, frameworkVersion, startDate, Tags);
    }
