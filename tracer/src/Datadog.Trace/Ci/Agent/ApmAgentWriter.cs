...
internal sealed class ApmAgentWriter : IEventWriter
{
        ...
        int maxBufferSize = DefaultMaxBufferSize)
    {
        ...
        var api = new Api(apiRequestFactory, statsdManager, updateSampleRates, discoveryService.SetCurrentConfigStateHash, partialFlushEnabled, healthMetricsEnabled: false);
