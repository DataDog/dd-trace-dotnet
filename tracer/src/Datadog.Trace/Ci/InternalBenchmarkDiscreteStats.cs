// <copyright file="InternalBenchmarkDiscreteStats.cs" company="Datadog">
...
/// </summary>
internal readonly struct InternalBenchmarkDiscreteStats
{
    /// <summary>
    /// Number of samples
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="InternalBenchmarkDiscreteStats"/> struct.
    /// </summary>
    ...
    public InternalBenchmarkDiscreteStats(int n, double max, double min, double mean, double median, double standardDeviation, double standardError, double kurtosis, double skewness, double p99, double p95, double p90)
    {
        N = n;
        Max = max;
        Min = min;
    ...
    public static InternalBenchmarkDiscreteStats GetFrom(double[] values)
    {
        ...
        return new InternalBenchmarkDiscreteStats(count, max, min, mean, median, standardDeviation, standardError, kurtosis, skewness, p99, p95, p90);
