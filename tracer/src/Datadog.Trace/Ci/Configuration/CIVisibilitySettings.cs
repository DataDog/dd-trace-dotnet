...
namespace Datadog.Trace.Ci.Configuration
{
    ...
    {
        private InternalTracerSettings? _tracerSettings;
        ...
        /// </summary>
        public InternalTracerSettings TracerSettings => LazyInitializer.EnsureInitialized(ref _tracerSettings, () => InitializeTracerSettings())!;
        ...
        private InternalTracerSettings InitializeTracerSettings()
        {
            ...
            var tracerSettings = new InternalTracerSettings(source, new ConfigurationTelemetry());
