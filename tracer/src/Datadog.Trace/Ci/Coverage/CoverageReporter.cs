...
{
    private static CoverageEventHandler _handler = CiVisibility.Instance.Settings.TestsSkippingEnabled == true ? new DefaultCoverageEventHandler() : new DefaultWithGlobalCoverageEventHandler();
