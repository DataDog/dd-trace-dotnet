...
internal readonly struct ExternalCoverageXmlResult
{
    ...
    /// <param name="executableLines">Executable-line or sequence-point count used by the report format.</param>
    /// <param name="coveredLines">Covered-line or visited sequence-point count used by the report format.</param>
    /// <param name="backfilled">Whether backend ITR coverage was used by the adapter.</param>
    ...
    /// <summary>
    /// Gets the executable-line or sequence-point count used by the report format.
    /// </summary>
    public double ExecutableLines { get; }

    /// <summary>
    /// Gets the covered-line or visited sequence-point count used by the report format.
    /// </summary>
    public double CoveredLines { get; }

    /// <summary>
    /// Gets a value indicating whether backend ITR coverage was used by the adapter.
    /// </summary>
