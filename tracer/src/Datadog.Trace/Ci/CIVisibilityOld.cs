// <copyright file="CIVisibilityOld.cs" company="Datadog">
...
internal class CIVisibilityOld
{
    ...
    internal static readonly IDatadogLogger Log = DatadogLogging.GetLoggerFor(typeof(CIVisibilityOld));
