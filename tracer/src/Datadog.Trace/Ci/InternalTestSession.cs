// <copyright file="InternalTestSession.cs" company="Datadog">
...
/// </summary>
internal sealed class InternalTestSession
{
    private static readonly AsyncLocal<InternalTestSession?> CurrentSession = new();
    private static readonly HashSet<InternalTestSession> OpenedTestSessions = new();
    ...
    private InternalTestSession(string? command, string? workingDirectory, string? framework, DateTimeOffset? startDate, bool propagateEnvironmentVariables)
    {
    ...
    /// </summary>
    internal static InternalTestSession? Current
    {
    ...
    /// </summary>
    internal static IReadOnlyCollection<InternalTestSession> ActiveTestSessions
    {
        get
        {
            lock (OpenedTestSessions)
    ...
    [PublicApi]
    public static InternalTestSession GetOrCreate(string command)
    {
    ...
    /// <returns>New test session instance</returns>
    [PublicApi]
    public static InternalTestSession GetOrCreate(string command, string workingDirectory)
    {
        TelemetryFactory.Metrics.RecordCountCIVisibilityManualApiEvent(MetricTags.CIVisibilityTestingEventType.Session);
    ...
    /// <returns>New test session instance</returns>
    [PublicApi]
    public static InternalTestSession GetOrCreate(string command, string workingDirectory, string framework)
    {
        TelemetryFactory.Metrics.RecordCountCIVisibilityManualApiEvent(MetricTags.CIVisibilityTestingEventType.Session);
    ...
    /// <returns>New test session instance</returns>
    [PublicApi]
    public static InternalTestSession GetOrCreate(string command, string workingDirectory, string framework, DateTimeOffset startDate)
    {
        TelemetryFactory.Metrics.RecordCountCIVisibilityManualApiEvent(MetricTags.CIVisibilityTestingEventType.Session);
    ...
    /// <returns>New test session instance</returns>
    [PublicApi]
    public static InternalTestSession GetOrCreate(string command, string? workingDirectory, string? framework, DateTimeOffset? startDate, bool propagateEnvironmentVariables)
    {
        TelemetryFactory.Metrics.RecordCountCIVisibilityManualApiEvent(MetricTags.CIVisibilityTestingEventType.Session);
    ...
    /// <param name="propagateEnvironmentVariables">Propagate session data through environment variables (out of proc session)</param>
    /// <returns>New test session instance</returns>
    internal static InternalTestSession InternalGetOrCreate(string command, string? workingDirectory, string? framework, DateTimeOffset? startDate, bool propagateEnvironmentVariables = false)
    {
        ...
        return new InternalTestSession(command, workingDirectory, framework, startDate, propagateEnvironmentVariables);
    }
    ...
    public Task CloseAsync(InternalTestStatus status)
    {
    ...
    /// <param name="duration">Duration of the test module</param>
    /// <returns>Task instance</returns>
    public Task CloseAsync(InternalTestStatus status, TimeSpan? duration)
    {
        if (InternalClose(status, duration))
        {
            CIVisibility.Log.Debug("### Test Session Flushing after close: {Command}", Command);
    ...
    /// <param name="status">Test session status</param>
    /// <param name="duration">Duration of the test module</param>
    internal bool InternalClose(InternalTestStatus status, TimeSpan? duration)
    {
    ...
    [PublicApi]
    public InternalTestModule CreateModule(string name)
    {
    ...
    /// <param name="name">Test module name</param>
    /// <returns>New test module instance</returns>
    internal InternalTestModule InternalCreateModule(string name)
    {
        return new InternalTestModule(name, null, null, null, Tags);
    }
    ...
    /// <returns>New test module instance</returns>
    [PublicApi]
    public InternalTestModule CreateModule(string name, string framework, string frameworkVersion)
    {
        TelemetryFactory.Metrics.RecordCountCIVisibilityManualApiEvent(MetricTags.CIVisibilityTestingEventType.Module);
    ...
    /// <param name="frameworkVersion">Testing framework version</param>
    /// <returns>New test module instance</returns>
    internal InternalTestModule InternalCreateModule(string name, string framework, string frameworkVersion)
    {
        return new InternalTestModule(name, framework, frameworkVersion, null, Tags);
    }
    ...
    /// <returns>New test module instance</returns>
    [PublicApi]
    public InternalTestModule CreateModule(string name, string framework, string frameworkVersion, DateTimeOffset startDate)
    {
        TelemetryFactory.Metrics.RecordCountCIVisibilityManualApiEvent(MetricTags.CIVisibilityTestingEventType.Module);
    ...
    /// <param name="startDate">Test session start date</param>
    /// <returns>New test module instance</returns>
    internal InternalTestModule InternalCreateModule(string name, string framework, string frameworkVersion, DateTimeOffset startDate)
    {
        return new InternalTestModule(name, framework, frameworkVersion, startDate, Tags);
    }
