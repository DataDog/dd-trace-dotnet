...
internal readonly struct TraceChunkModel
{
    ...
    public readonly double? RateLimiterRate = null;

    public readonly double? TracesKeepRate = null;
    ...
    public readonly string? ProcessTags = null;
        ...
        : this(in spans, traceContext?.RootSpan)
    {
        ...
        if (traceContext is not null)
        {
            ...
            AppliedSamplingRate = traceContext.AppliedSamplingRate;
            SamplingMechanism = traceContext.SamplingMechanism;
            ...
            if (traceContext.Tracer is { } tracer)
            {
                ...
                if (tracer.Settings is { } settings)
                {
                    ...
                    ProcessTags = settings.Manager.InitialMutableSettings.ProcessTags?.SerializedTags;
                }
