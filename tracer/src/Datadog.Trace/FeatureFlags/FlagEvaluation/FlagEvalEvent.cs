...
internal sealed class FlagEvalEvent
{
    ...
    public FlagEvalEvent(
        ...
        bool observeFullEvaluationData = false)
    {
        FlagKey = flagKey;
        Variant = variant;
        ...
        ContextAttrs = observeFullEvaluationData && contextAttrs is { Count: > 0 }
    ...
    /// <summary>Gets a value indicating whether this exact evaluation opted into full data.</summary>
