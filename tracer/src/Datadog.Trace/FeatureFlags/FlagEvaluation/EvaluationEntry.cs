...
internal sealed class EvaluationEntry
{
    ...
    /// </summary>
    public EvaluationEntry(long evalTimeMs, bool runtimeDefault, bool observeFullEvaluationData, Dictionary<string, object?>? contextAttrs)
    {
        Count = 1;
    ...
    /// <summary>Gets a value indicating whether every evaluation in this bucket opted into full data.</summary>
