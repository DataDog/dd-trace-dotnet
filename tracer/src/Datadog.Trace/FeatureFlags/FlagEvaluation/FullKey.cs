...
internal readonly struct FullKey : IEquatable<FullKey>
{
    ...
    /// </summary>
    public FullKey(string flagKey, string variant, string allocationKey, string errorMessage, bool runtimeDefault, string? targetingKey, string contextKey, bool observeFullEvaluationData)
    {
        FlagKey = flagKey;
        Variant = variant;
    ...
    /// <summary>Gets a value indicating whether the evaluations opted into full data.</summary>
    ...
    public override int GetHashCode()
    {
        unchecked
        {
            ...
            h = (h * 397) ^ ObserveFullEvaluationData.GetHashCode();
            return h;
        }
    }
}
