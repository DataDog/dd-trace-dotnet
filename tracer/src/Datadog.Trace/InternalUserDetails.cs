// <copyright file="InternalUserDetails.cs" company="Datadog">
...
namespace Datadog.Trace.Internal
{
    ...
    /// </summary>
    public struct InternalUserDetails
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalUserDetails"/> struct.
        /// </summary>
        /// <param name="id">The unique identifier associated with the users</param>
        public InternalUserDetails(string id)
        {
