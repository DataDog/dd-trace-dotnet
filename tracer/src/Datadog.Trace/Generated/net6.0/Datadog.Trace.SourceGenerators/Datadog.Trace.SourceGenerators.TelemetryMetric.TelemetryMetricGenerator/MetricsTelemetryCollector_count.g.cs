...
internal partial class MetricsTelemetryCollector
{
    ...
    {
        var index = 605 + ((int)tag1 * 7) + (int)tag2;
        Interlocked.Add(ref _buffer.Counts[index], increment);
    }
    ...
    {
        Interlocked.Add(ref _buffer.Counts[690], increment);
    }
    ...
    {
        Interlocked.Add(ref _buffer.Counts[696], increment);
    }
    ...
    private static AggregatedMetric[] GetCountBuffer()
        => new AggregatedMetric[]
        {
            ...
            // git_requests.search_commits, index = 668
            new(null),
            // git_requests.search_commits_errors, index = 669
            ...
            // git_requests.objects_pack, index = 674
            new(null),
            // git_requests.objects_pack_errors, index = 675
            new(new[] { "error_type:timeout" }),
            new(new[] { "error_type:network" }),
            new(new[] { "error_type:status_code" }),
            new(new[] { "error_type:status_code_4xx_response" }),
            new(new[] { "error_type:status_code_5xx_response" }),
            // git_requests.settings, index = 680
            new(null),
            // git_requests.settings_errors, index = 681
            new(new[] { "error_type:timeout" }),
            new(new[] { "error_type:network" }),
            new(new[] { "error_type:status_code" }),
            new(new[] { "error_type:status_code_4xx_response" }),
            new(new[] { "error_type:status_code_5xx_response" }),
            // git_requests.settings_response, index = 686
            new(null),
            new(new[] { "coverage_enabled" }),
            new(new[] { "itrskip_enabled" }),
            new(new[] { "coverage_enabled", "itrskip_enabled" }),
            // itr_skippable_tests.request, index = 690
            new(null),
            // itr_skippable_tests.request_errors, index = 691
            new(new[] { "error_type:timeout" }),
            new(new[] { "error_type:network" }),
            new(new[] { "error_type:status_code" }),
            new(new[] { "error_type:status_code_4xx_response" }),
            new(new[] { "error_type:status_code_5xx_response" }),
            // itr_skippable_tests.response_tests, index = 696
            new(null),
            // itr_skippable_tests.response_suites, index = 697
            new(null),
            // itr_skipped, index = 698
            new(new[] { "event_type:test" }),
            new(new[] { "event_type:suite" }),
            new(new[] { "event_type:module" }),
            new(new[] { "event_type:session" }),
            // itr_unskippable, index = 702
            new(new[] { "event_type:test" }),
            new(new[] { "event_type:suite" }),
            new(new[] { "event_type:module" }),
            new(new[] { "event_type:session" }),
            // itr_forced_run, index = 706
            new(new[] { "event_type:test" }),
            new(new[] { "event_type:suite" }),
            new(new[] { "event_type:module" }),
            new(new[] { "event_type:session" }),
            // code_coverage.is_empty, index = 710
            new(null),
            // code_coverage.errors, index = 711
            new(null),
        };
    ...
    private static int[] CountEntryCounts { get; }
        = new []{ 4, 171, 57, 1, 3, 4, 2, 2, 4, 1, 1, 1, 22, 3, 2, 4, 4, 1, 22, 3, 2, 44, 6, 1, 57, 1, 22, 3, 1, 1, 5, 11, 1, 12, 40, 40, 10, 10, 4, 1, 2, 10, 9, 63, 1, 5, 1, 5, 1, 5, 4, 1, 5, 1, 1, 4, 4, 4, 1, 1, };

    private const int _countsLength = 712;
}