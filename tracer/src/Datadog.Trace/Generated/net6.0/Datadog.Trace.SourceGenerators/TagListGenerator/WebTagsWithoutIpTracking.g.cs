...
{
    partial class WebTagsWithoutIpTracking
    {
        ...
        public override void SetTag(string key, string? value)
        {
            switch(key)
            {
                ...
                case "http.status_code": 
                    ...
                    break;
                case "span.kind": 
                    Logger.Value.Warning("Attempted to set readonly tag {TagName} on {TagType}. Ignoring.", key, nameof(WebTagsWithoutIpTracking));
                    break;
                default: 
