...
internal partial class TracerSettingsSnapshot : SettingsSnapshotBase
{
    internal TracerSettingsSnapshot(Datadog.Trace.Configuration.TracerSettings settings)
    {
        ...
        ExperimentalAppSecStandaloneEnabledInternal = settings.ExperimentalAppSecStandaloneEnabledInternal;
    ...
    private bool ExperimentalAppSecStandaloneEnabledInternal { get; }
    ...
    internal void RecordChanges(Datadog.Trace.Configuration.TracerSettings settings, IConfigurationTelemetry telemetry)
    {
        ...
        RecordIfChanged(telemetry, "DD_EXPERIMENTAL_APPSEC_STANDALONE_ENABLED", ExperimentalAppSecStandaloneEnabledInternal, settings.ExperimentalAppSecStandaloneEnabledInternal);
