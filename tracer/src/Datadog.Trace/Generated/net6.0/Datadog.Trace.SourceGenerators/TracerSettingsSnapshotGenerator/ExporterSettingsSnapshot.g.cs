...
{
    internal ExporterSettingsSnapshot(Datadog.Trace.Internal.Configuration.ExporterSettings settings)
    {
    ...
    internal void RecordChanges(Datadog.Trace.Internal.Configuration.ExporterSettings settings, IConfigurationTelemetry telemetry)
    {
    ...
    partial void AdditionalInitialization(Datadog.Trace.Internal.Configuration.ExporterSettings settings);
    partial void RecordAdditionalChanges(Datadog.Trace.Internal.Configuration.ExporterSettings settings, IConfigurationTelemetry telemetry);
}