...
internal partial class InternalExporterSettingsSnapshot : InternalSettingsSnapshotBase
{
    internal InternalExporterSettingsSnapshot(Datadog.Trace.Internal.Configuration.InternalExporterSettings settings)
    {
    ...
    internal void RecordChanges(Datadog.Trace.Internal.Configuration.InternalExporterSettings settings, IConfigurationTelemetry telemetry)
    {
    ...
    partial void AdditionalInitialization(Datadog.Trace.Internal.Configuration.InternalExporterSettings settings);
    partial void RecordAdditionalChanges(Datadog.Trace.Internal.Configuration.InternalExporterSettings settings, IConfigurationTelemetry telemetry);
}