        ...
        internal static Datadog.Trace.Configuration.IntegrationId? GetIntegrationId(string? integrationTypeName, System.Type targetType)
        {
            return integrationTypeName switch
            {
                ...
                "Datadog.Trace.ClrProfiler.AutoInstrumentation.AWS.S3.CompleteMultipartUploadIntegration"
                    ...
                    or "Datadog.Trace.ClrProfiler.AutoInstrumentation.AWS.S3.DeleteBucketIntegration"
                    or "Datadog.Trace.ClrProfiler.AutoInstrumentation.AWS.S3.DeleteBucketAsyncIntegration"
                    or "Datadog.Trace.ClrProfiler.AutoInstrumentation.AWS.S3.DeleteObjectIntegration"
                    or "Datadog.Trace.ClrProfiler.AutoInstrumentation.AWS.S3.DeleteObjectAsyncIntegration"
                    or "Datadog.Trace.ClrProfiler.AutoInstrumentation.AWS.S3.GetObjectIntegration"
                    or "Datadog.Trace.ClrProfiler.AutoInstrumentation.AWS.S3.GetObjectAsyncIntegration"
                    or "Datadog.Trace.ClrProfiler.AutoInstrumentation.AWS.S3.ListObjectsIntegration"
                    or "Datadog.Trace.ClrProfiler.AutoInstrumentation.AWS.S3.ListObjectsAsyncIntegration"
                    or "Datadog.Trace.ClrProfiler.AutoInstrumentation.AWS.S3.PutBucketIntegration"
                    or "Datadog.Trace.ClrProfiler.AutoInstrumentation.AWS.S3.PutBucketAsyncIntegration"
