...
internal static partial class ConfigurationKeys
{
    internal static class Iast
    {
        ...
        /// <summary>
        /// Configuration key for enabling or disabling IAST.
        /// Default value is true (enabled) — this build is an IAST-only analyzer,
        /// so the product is on by default.
        /// </summary>
        ...
        /// <summary>
        /// Optional override for the IAST vulnerability JSON-lines report file.
        /// A bare filename (e.g. "vulns.jsonl") is placed under the tracer log
        /// directory; a value containing a directory component is used verbatim
        /// as the full output path. Useful for tests that need a per-instance
        /// report path. Default value is unset (a PID-suffixed file under the
        /// tracer log directory is used).
        /// </summary>
        public const string VulnerabilityLogPath = "DD_IAST_VULNERABILITY_LOG_PATH";
