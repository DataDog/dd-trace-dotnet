...
internal partial class MetricsTelemetryCollector
{
    ...
    private static AggregatedMetric[] GetCountBuffer()
        => new AggregatedMetric[]
        {
            ...
            // executed.propagation, index = 340
            new(null),
            // executed.sink, index = 341
            ...
            new(new[] { "vulnerability_type:verb_tampering" }),
    ...
    private static int[] CountEntryCounts { get; }
        = new int[]{ 4, 74, 1, 3, 4, 2, 2, 4, 1, 1, 1, 22, 3, 2, 4, 4, 1, 22, 3, 2, 44, 6, 1, 74, 1, 22, 3, 1, 1, 5, 3, 2, 2, 2, 13, 1, 27, 1, };
    ...
    {
        Interlocked.Add(ref _buffer.Count[340], increment);
    }
