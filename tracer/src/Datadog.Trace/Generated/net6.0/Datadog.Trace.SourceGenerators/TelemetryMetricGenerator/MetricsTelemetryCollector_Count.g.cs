...
{
    private const int CountLength = 332;
    ...
    private static AggregatedMetric[] GetCountBuffer()
        => new AggregatedMetric[]
        {
            ...
            // spans_finished, index = 69
            new(null),
            // spans_enqueued_for_serialization, index = 70
            new(new[] { "reason:p0_keep" }),
            new(new[] { "reason:single_span_sampling" }),
            new(new[] { "reason:default" }),
            // spans_dropped, index = 73
            new(new[] { "reason:p0_drop" }),
            new(new[] { "reason:overfull_buffer" }),
            new(new[] { "reason:serialization_error" }),
            new(new[] { "reason:api_error" }),
            // trace_segments_created, index = 77
            new(new[] { "new_continued:new" }),
            new(new[] { "new_continued:continued" }),
            // trace_chunks_enqueued_for_serialization, index = 79
            new(new[] { "reason:p0_keep" }),
            new(new[] { "reason:default" }),
            // trace_chunks_dropped, index = 81
            new(new[] { "reason:p0_drop" }),
            new(new[] { "reason:overfull_buffer" }),
            new(new[] { "reason:serialization_error" }),
            new(new[] { "reason:api_error" }),
            // trace_chunks_sent, index = 85
            new(null),
            // trace_segments_closed, index = 86
            new(null),
            // trace_api.requests, index = 87
            new(null),
            // trace_api.responses, index = 88
            ...
            new(new[] { "status_code:504" }),
            new(new[] { "status_code:5xx" }),
            // stats_api.errors, index = 146
            new(new[] { "type:timeout" }),
            new(new[] { "type:network" }),
            new(new[] { "type:status_code" }),
            // telemetry_api.requests, index = 149
            new(new[] { "endpoint:agent" }),
            new(new[] { "endpoint:agentless" }),
            // telemetry_api.responses, index = 151
            ...
            // telemetry_api.errors, index = 195
            ...
            // version_conflict_tracers_created, index = 201
            new(null),
            // direct_log_logs, index = 202
            new(new[] { "integration_name:datadog" }),
            new(new[] { "integration_name:opentracing" }),
            new(new[] { "integration_name:ciapp" }),
            new(new[] { "integration_name:debugger_span_probe" }),
            ...
            new(new[] { "integration_name:unvalidatedredirect" }),
            new(new[] { "integration_name:testplatformassemblyresolver" }),
            // direct_log_api.requests, index = 267
            new(null),
            // direct_log_api.responses, index = 268
            new(new[] { "status_code:200" }),
            new(new[] { "status_code:201" }),
            new(new[] { "status_code:202" }),
            new(new[] { "status_code:204" }),
            ...
            new(new[] { "status_code:504" }),
            new(new[] { "status_code:5xx" }),
            // direct_log_api.errors, index = 290
            new(new[] { "type:timeout" }),
            new(new[] { "type:network" }),
            new(new[] { "type:status_code" }),
            // waf.init, index = 293
            new(null),
            // waf.updates, index = 294
            new(null),
            // waf.requests, index = 295
            ...
            // executed.propagation, index = 312
            new(null),
            // executed.sink, index = 313
    ...
    private static int[] CountEntryCounts { get; }
        = new int[]{ 4, 65, 1, 3, 4, 2, 2, 4, 1, 1, 1, 22, 3, 2, 4, 4, 1, 22, 3, 2, 44, 6, 1, 65, 1, 22, 3, 1, 1, 5, 12, 1, 18, 1, };
    ...
    {
        Interlocked.Add(ref _buffer.Count[69], increment);
    }
    ...
    {
        Interlocked.Add(ref _buffer.Count[123], increment);
    }
    ...
    {
        var index = 151 + ((int)tag1 * 22) + (int)tag2;
        Interlocked.Add(ref _buffer.Count[index], increment);
    }
    ...
    {
        var index = 195 + ((int)tag1 * 3) + (int)tag2;
        Interlocked.Add(ref _buffer.Count[index], increment);
    }

    public void RecordCountVersionConflictTracerCreated(int increment = 1)
    {
        Interlocked.Add(ref _buffer.Count[201], increment);
    }
    ...
    {
        Interlocked.Add(ref _buffer.Count[267], increment);
    }
    ...
    {
        Interlocked.Add(ref _buffer.Count[331], increment);
    }
}