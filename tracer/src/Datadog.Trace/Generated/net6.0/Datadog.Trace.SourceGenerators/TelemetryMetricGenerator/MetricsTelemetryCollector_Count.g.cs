...
{
    private const int CountLength = 358;
    ...
    private static AggregatedMetric[] GetCountBuffer()
        => new AggregatedMetric[]
        {
            ...
            // spans_finished, index = 73
            new(null),
            // spans_enqueued_for_serialization, index = 74
            new(new[] { "reason:p0_keep" }),
            new(new[] { "reason:single_span_sampling" }),
            new(new[] { "reason:default" }),
            // spans_dropped, index = 77
            new(new[] { "reason:p0_drop" }),
            new(new[] { "reason:overfull_buffer" }),
            new(new[] { "reason:serialization_error" }),
            new(new[] { "reason:api_error" }),
            // trace_segments_created, index = 81
            new(new[] { "new_continued:new" }),
            new(new[] { "new_continued:continued" }),
            // trace_chunks_enqueued_for_serialization, index = 83
            new(new[] { "reason:p0_keep" }),
            new(new[] { "reason:default" }),
            // trace_chunks_dropped, index = 85
            new(new[] { "reason:p0_drop" }),
            new(new[] { "reason:overfull_buffer" }),
            new(new[] { "reason:serialization_error" }),
            new(new[] { "reason:api_error" }),
            // trace_chunks_sent, index = 89
            new(null),
            // trace_segments_closed, index = 90
            new(null),
            // trace_api.requests, index = 91
            new(null),
            // trace_api.responses, index = 92
            ...
            new(new[] { "status_code:504" }),
            new(new[] { "status_code:5xx" }),
            // stats_api.errors, index = 150
            new(new[] { "type:timeout" }),
            new(new[] { "type:network" }),
            new(new[] { "type:status_code" }),
            // telemetry_api.requests, index = 153
            new(new[] { "endpoint:agent" }),
            new(new[] { "endpoint:agentless" }),
            // telemetry_api.responses, index = 155
            ...
            // telemetry_api.errors, index = 199
            ...
            // version_conflict_tracers_created, index = 205
            new(null),
            // direct_log_logs, index = 206
            new(new[] { "integration_name:datadog" }),
            new(new[] { "integration_name:opentracing" }),
            new(new[] { "integration_name:ciapp" }),
            new(new[] { "integration_name:debugger_span_probe" }),
            ...
            new(new[] { "integration_name:reflectioninjection" }),
            new(new[] { "integration_name:xss" }),
            // direct_log_api.requests, index = 275
            new(null),
            // direct_log_api.responses, index = 276
            new(new[] { "status_code:200" }),
            new(new[] { "status_code:201" }),
            new(new[] { "status_code:202" }),
            new(new[] { "status_code:204" }),
            ...
            new(new[] { "status_code:504" }),
            new(new[] { "status_code:5xx" }),
            // direct_log_api.errors, index = 298
            new(new[] { "type:timeout" }),
            new(new[] { "type:network" }),
            new(new[] { "type:status_code" }),
            // waf.init, index = 301
            new(null),
            // waf.updates, index = 302
            new(null),
            // waf.requests, index = 303
            ...
            // rasp.rule.eval, index = 311
            new(new[] { "waf_version", "rule_type:none" }),
            new(new[] { "waf_version", "rule_type:lfi" }),
            new(new[] { "waf_version", "rule_type:ssrf" }),
            // rasp.rule.match, index = 314
            new(new[] { "waf_version", "rule_type:none" }),
            new(new[] { "waf_version", "rule_type:lfi" }),
            new(new[] { "waf_version", "rule_type:ssrf" }),
            // rasp.timeout, index = 317
            new(new[] { "waf_version", "rule_type:none" }),
            new(new[] { "waf_version", "rule_type:lfi" }),
            new(new[] { "waf_version", "rule_type:ssrf" }),
            // executed.source, index = 320
            ...
            // executed.propagation, index = 332
            new(null),
            // executed.sink, index = 333
    ...
    private static int[] CountEntryCounts { get; }
        = new int[]{ 4, 69, 1, 3, 4, 2, 2, 4, 1, 1, 1, 22, 3, 2, 4, 4, 1, 22, 3, 2, 44, 6, 1, 69, 1, 22, 3, 1, 1, 5, 3, 3, 3, 3, 12, 1, 24, 1, };
    ...
    {
        Interlocked.Add(ref _buffer.Count[73], increment);
    }
    ...
    {
        Interlocked.Add(ref _buffer.Count[127], increment);
    }
    ...
    {
        var index = 155 + ((int)tag1 * 22) + (int)tag2;
        Interlocked.Add(ref _buffer.Count[index], increment);
    }
    ...
    {
        Interlocked.Add(ref _buffer.Count[357], increment);
    }
}