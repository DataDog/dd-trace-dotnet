...
internal partial class MetricsTelemetryCollector
{
    ...
    private static AggregatedMetric[] GetCountSharedBuffer()
        => new AggregatedMetric[]
        {
            ...
            new(new[] { "integration_name:verbtampering", "error_type:duck_typing" }),
            new(new[] { "integration_name:verbtampering", "error_type:invoker" }),
            new(new[] { "integration_name:verbtampering", "error_type:execution" }),
        };
