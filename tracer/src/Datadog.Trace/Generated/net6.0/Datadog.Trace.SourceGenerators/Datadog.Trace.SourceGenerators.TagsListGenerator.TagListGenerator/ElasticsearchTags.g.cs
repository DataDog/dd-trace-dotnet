...
#if NETCOREAPP
        private static ReadOnlySpan<byte> ActionBytes => new byte[] { 101, 108, 97, 115, 116, 105, 99, 115, 101, 97, 114, 99, 104, 46, 97, 99, 116, 105, 111, 110 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> MethodBytes => new byte[] { 101, 108, 97, 115, 116, 105, 99, 115, 101, 97, 114, 99, 104, 46, 109, 101, 116, 104, 111, 100 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> UrlBytes => new byte[] { 101, 108, 97, 115, 116, 105, 99, 115, 101, 97, 114, 99, 104, 46, 117, 114, 108 };
#else
