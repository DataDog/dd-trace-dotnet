...
#if NETCOREAPP
        private static ReadOnlySpan<byte> SourceStartBytes => new byte[] { 116, 101, 115, 116, 46, 115, 111, 117, 114, 99, 101, 46, 115, 116, 97, 114, 116 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> SourceEndBytes => new byte[] { 116, 101, 115, 116, 46, 115, 111, 117, 114, 99, 101, 46, 101, 110, 100 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> NameBytes => new byte[] { 116, 101, 115, 116, 46, 110, 97, 109, 101 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> ParametersBytes => new byte[] { 116, 101, 115, 116, 46, 112, 97, 114, 97, 109, 101, 116, 101, 114, 115 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> SourceFileBytes => new byte[] { 116, 101, 115, 116, 46, 115, 111, 117, 114, 99, 101, 46, 102, 105, 108, 101 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> CodeOwnersBytes => new byte[] { 116, 101, 115, 116, 46, 99, 111, 100, 101, 111, 119, 110, 101, 114, 115 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> TraitsBytes => new byte[] { 116, 101, 115, 116, 46, 116, 114, 97, 105, 116, 115 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> SkipReasonBytes => new byte[] { 116, 101, 115, 116, 46, 115, 107, 105, 112, 95, 114, 101, 97, 115, 111, 110 };
#else
