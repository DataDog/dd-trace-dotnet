...
#if NETCOREAPP
        private static ReadOnlySpan<byte> DbNameBytes => new byte[] { 100, 98, 46, 110, 97, 109, 101 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> DbUserBytes => new byte[] { 100, 98, 46, 117, 115, 101, 114 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> OutHostBytes => new byte[] { 111, 117, 116, 46, 104, 111, 115, 116 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> DbmDataPropagatedBytes => new byte[] { 95, 100, 100, 46, 100, 98, 109, 95, 116, 114, 97, 99, 101, 95, 105, 110, 106, 101, 99, 116, 101, 100 };
#else
