...
#if NETCOREAPP
        private static ReadOnlySpan<byte> CommandBytes => new byte[] { 97, 109, 113, 112, 46, 99, 111, 109, 109, 97, 110, 100 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> DeliveryModeBytes => new byte[] { 97, 109, 113, 112, 46, 100, 101, 108, 105, 118, 101, 114, 121, 95, 109, 111, 100, 101 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> ExchangeBytes => new byte[] { 97, 109, 113, 112, 46, 101, 120, 99, 104, 97, 110, 103, 101 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> RoutingKeyBytes => new byte[] { 97, 109, 113, 112, 46, 114, 111, 117, 116, 105, 110, 103, 95, 107, 101, 121 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> MessageSizeBytes => new byte[] { 109, 101, 115, 115, 97, 103, 101, 46, 115, 105, 122, 101 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> QueueBytes => new byte[] { 97, 109, 113, 112, 46, 113, 117, 101, 117, 101 };
#else
