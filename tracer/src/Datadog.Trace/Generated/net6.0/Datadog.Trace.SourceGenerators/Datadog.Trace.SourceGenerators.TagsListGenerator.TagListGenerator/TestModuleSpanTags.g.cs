...
#if NETCOREAPP
        private static ReadOnlySpan<byte> TypeBytes => new byte[] { 116, 101, 115, 116, 46, 116, 121, 112, 101 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> ModuleBytes => new byte[] { 116, 101, 115, 116, 46, 109, 111, 100, 117, 108, 101 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> BundleBytes => new byte[] { 116, 101, 115, 116, 46, 98, 117, 110, 100, 108, 101 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> FrameworkBytes => new byte[] { 116, 101, 115, 116, 46, 102, 114, 97, 109, 101, 119, 111, 114, 107 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> FrameworkVersionBytes => new byte[] { 116, 101, 115, 116, 46, 102, 114, 97, 109, 101, 119, 111, 114, 107, 95, 118, 101, 114, 115, 105, 111, 110 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> RuntimeNameBytes => new byte[] { 114, 117, 110, 116, 105, 109, 101, 46, 110, 97, 109, 101 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> RuntimeVersionBytes => new byte[] { 114, 117, 110, 116, 105, 109, 101, 46, 118, 101, 114, 115, 105, 111, 110 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> RuntimeArchitectureBytes => new byte[] { 114, 117, 110, 116, 105, 109, 101, 46, 97, 114, 99, 104, 105, 116, 101, 99, 116, 117, 114, 101 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> OSArchitectureBytes => new byte[] { 111, 115, 46, 97, 114, 99, 104, 105, 116, 101, 99, 116, 117, 114, 101 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> OSPlatformBytes => new byte[] { 111, 115, 46, 112, 108, 97, 116, 102, 111, 114, 109 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> OSVersionBytes => new byte[] { 111, 115, 46, 118, 101, 114, 115, 105, 111, 110 };
#else
