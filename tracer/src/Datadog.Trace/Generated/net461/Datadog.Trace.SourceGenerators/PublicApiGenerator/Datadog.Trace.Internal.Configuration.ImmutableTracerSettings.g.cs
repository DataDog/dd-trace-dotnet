...
partial record ImmutableTracerSettings
{
    ...
    public string? Environment
    {
        get
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)146);
    ...
    public string? ServiceName
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)156);
    ...
    public string? ServiceVersion
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)157);
    ...
    public bool TraceEnabled
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)160);
    ...
    public Datadog.Trace.Internal.Configuration.ImmutableExporterSettings Exporter
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)147);
...
#pragma warning restore CS1574
    ...
    public bool AnalyticsEnabled
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)144);
    ...
    public bool LogsInjectionEnabled
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)154);
    ...
    public int MaxTracesSubmittedPerSecond
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)155);
    ...
    public string? CustomSamplingRules
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)145);
    ...
    public double? GlobalSamplingRate
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)148);
    ...
    public Datadog.Trace.Internal.Configuration.ImmutableIntegrationSettingsCollection Integrations
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)152);
    ...
    public System.Collections.Generic.IReadOnlyDictionary<string, string> GlobalTags
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)149);
    ...
    public System.Collections.Generic.IReadOnlyDictionary<string, string> HeaderTags
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)151);
    ...
    public System.Collections.Generic.IReadOnlyDictionary<string, string> GrpcTags
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)150);
    ...
    public bool TracerMetricsEnabled
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)161);
    ...
    public bool StatsComputationEnabled
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)159);
    ...
    public bool KafkaCreateConsumerScopeEnabled
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)153);
    ...
    public bool StartupDiagnosticLogEnabled
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)158);
