...
namespace Datadog.Trace.Tagging
{
    ...
    {
        // AspNetCoreControllerBytes = Datadog.Trace.Vendors.MessagePack.StringEncoding.UTF8.GetBytes("aspnet_core.controller");
        ...
        // AspNetCoreActionBytes = Datadog.Trace.Vendors.MessagePack.StringEncoding.UTF8.GetBytes("aspnet_core.action");
        ...
        // AspNetCoreAreaBytes = Datadog.Trace.Vendors.MessagePack.StringEncoding.UTF8.GetBytes("aspnet_core.area");
        private static readonly byte[] AspNetCoreAreaBytes = new byte[] { 97, 115, 112, 110, 101, 116, 95, 99, 111, 114, 101, 46, 97, 114, 101, 97 };
        // AspNetCorePageBytes = Datadog.Trace.Vendors.MessagePack.StringEncoding.UTF8.GetBytes("aspnet_core.page");
