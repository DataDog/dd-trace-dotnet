...
internal static partial class IntegrationIdExtensions
{
    ...
    public static string ToStringFast(this Datadog.Trace.Configuration.IntegrationId value)
        => value switch
        {
            ...
            Datadog.Trace.Configuration.IntegrationId.VerbTampering => nameof(Datadog.Trace.Configuration.IntegrationId.VerbTampering),
            _ => value.ToString(),
        };
    ...
    public static Datadog.Trace.Configuration.IntegrationId[] GetValues()
        => new []
        {
            ...
            Datadog.Trace.Configuration.IntegrationId.VerbTampering,
        };
    ...
    public static string[] GetNames()
        => new []
        {
            ...
            nameof(Datadog.Trace.Configuration.IntegrationId.VerbTampering),
        };
}