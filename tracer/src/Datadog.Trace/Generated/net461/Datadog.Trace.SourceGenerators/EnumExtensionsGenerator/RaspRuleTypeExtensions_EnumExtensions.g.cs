...
internal static partial class RaspRuleTypeExtensions
{
    ...
    public static string ToStringFast(this Datadog.Trace.Telemetry.Metrics.MetricTags.RaspRuleType value)
        => value switch
        {
            ...
            Datadog.Trace.Telemetry.Metrics.MetricTags.RaspRuleType.CommandInjection => "waf_version;event_rules_version;rule_type:command_injection",
            _ => value.ToString(),
        };
    ...
    public static string[] GetDescriptions()
        => new []
        {
            ...
            "waf_version;event_rules_version;rule_type:command_injection",
        };
}