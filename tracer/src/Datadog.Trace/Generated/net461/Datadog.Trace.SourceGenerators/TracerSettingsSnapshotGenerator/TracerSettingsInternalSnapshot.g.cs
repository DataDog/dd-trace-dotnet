...
{
    internal TracerSettingsInternalSnapshot(Datadog.Trace.Configuration.TracerSettingsInternal settings)
    {
    ...
    internal void RecordChanges(Datadog.Trace.Configuration.TracerSettingsInternal settings, IConfigurationTelemetry telemetry)
    {
    ...
    partial void AdditionalInitialization(Datadog.Trace.Configuration.TracerSettingsInternal settings);
    partial void RecordAdditionalChanges(Datadog.Trace.Configuration.TracerSettingsInternal settings, IConfigurationTelemetry telemetry);
}