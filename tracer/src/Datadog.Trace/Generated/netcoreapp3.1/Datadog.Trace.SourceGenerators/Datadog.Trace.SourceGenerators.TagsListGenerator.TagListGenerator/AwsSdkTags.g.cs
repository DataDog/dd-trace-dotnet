...
namespace Datadog.Trace.Tagging
{
    partial class AwsSdkTags
    {
        ...
        // AgentName => Datadog.Trace.Vendors.MessagePack.StringEncoding.UTF8.GetBytes("aws.agent"
        private static readonly byte[] AgentNameBytes = new byte[] { 97, 119, 115, 46, 97, 103, 101, 110, 116 };
        // Operation => Datadog.Trace.Vendors.MessagePack.StringEncoding.UTF8.GetBytes("aws.operation"
        private static readonly byte[] OperationBytes = new byte[] { 97, 119, 115, 46, 111, 112, 101, 114, 97, 116, 105, 111, 110 };
        // Region => Datadog.Trace.Vendors.MessagePack.StringEncoding.UTF8.GetBytes("aws.region"
        private static readonly byte[] RegionBytes = new byte[] { 97, 119, 115, 46, 114, 101, 103, 105, 111, 110 };
        // RequestId => Datadog.Trace.Vendors.MessagePack.StringEncoding.UTF8.GetBytes("aws.requestId"
        private static readonly byte[] RequestIdBytes = new byte[] { 97, 119, 115, 46, 114, 101, 113, 117, 101, 115, 116, 73, 100 };
        // Service => Datadog.Trace.Vendors.MessagePack.StringEncoding.UTF8.GetBytes("aws.service"
        private static readonly byte[] ServiceBytes = new byte[] { 97, 119, 115, 46, 115, 101, 114, 118, 105, 99, 101 };
        // HttpMethod => Datadog.Trace.Vendors.MessagePack.StringEncoding.UTF8.GetBytes("http.method"
        private static readonly byte[] HttpMethodBytes = new byte[] { 104, 116, 116, 112, 46, 109, 101, 116, 104, 111, 100 };
        // HttpUrl => Datadog.Trace.Vendors.MessagePack.StringEncoding.UTF8.GetBytes("http.url"
        private static readonly byte[] HttpUrlBytes = new byte[] { 104, 116, 116, 112, 46, 117, 114, 108 };
        // HttpStatusCode => Datadog.Trace.Vendors.MessagePack.StringEncoding.UTF8.GetBytes("http.status_code"
