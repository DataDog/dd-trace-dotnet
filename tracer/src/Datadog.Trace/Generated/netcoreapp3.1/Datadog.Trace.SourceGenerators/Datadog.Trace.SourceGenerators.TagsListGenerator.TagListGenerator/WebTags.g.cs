...
#if NETCOREAPP
        private static ReadOnlySpan<byte> HttpUserAgentBytes => new byte[] { 104, 116, 116, 112, 46, 117, 115, 101, 114, 97, 103, 101, 110, 116 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> HttpRequestHeadersHostBytes => new byte[] { 104, 116, 116, 112, 46, 114, 101, 113, 117, 101, 115, 116, 46, 104, 101, 97, 100, 101, 114, 115, 46, 104, 111, 115, 116 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> NetworkClientIpBytes => new byte[] { 110, 101, 116, 119, 111, 114, 107, 46, 99, 108, 105, 101, 110, 116, 46, 105, 112 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> HttpClientIpBytes => new byte[] { 104, 116, 116, 112, 46, 99, 108, 105, 101, 110, 116, 95, 105, 112 };
#else
