...
#if NETCOREAPP
        private static ReadOnlySpan<byte> QueryBytes => new byte[] { 109, 111, 110, 103, 111, 100, 98, 46, 113, 117, 101, 114, 121 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> CollectionBytes => new byte[] { 109, 111, 110, 103, 111, 100, 98, 46, 99, 111, 108, 108, 101, 99, 116, 105, 111, 110 };
#else
