...
#if NETCOREAPP
        private static ReadOnlySpan<byte> AspNetRouteBytes => new byte[] { 97, 115, 112, 110, 101, 116, 46, 114, 111, 117, 116, 101 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> AspNetControllerBytes => new byte[] { 97, 115, 112, 110, 101, 116, 46, 99, 111, 110, 116, 114, 111, 108, 108, 101, 114 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> AspNetActionBytes => new byte[] { 97, 115, 112, 110, 101, 116, 46, 97, 99, 116, 105, 111, 110 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> AspNetAreaBytes => new byte[] { 97, 115, 112, 110, 101, 116, 46, 97, 114, 101, 97 };
#else
