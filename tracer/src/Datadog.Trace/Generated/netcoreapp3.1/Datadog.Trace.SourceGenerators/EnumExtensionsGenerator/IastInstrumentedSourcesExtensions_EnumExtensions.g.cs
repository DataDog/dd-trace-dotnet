...
internal static partial class IastInstrumentedSourcesExtensions
{
    ...
    public static string ToStringFast(this Datadog.Trace.Telemetry.Metrics.MetricTags.IastInstrumentedSources value)
        => value switch
        {
            ...
            Datadog.Trace.Telemetry.Metrics.MetricTags.IastInstrumentedSources.Database => "source_type:http.request.database",
            _ => value.ToString(),
        };
    ...
    public static Datadog.Trace.Telemetry.Metrics.MetricTags.IastInstrumentedSources[] GetValues()
        => new []
        {
            ...
            Datadog.Trace.Telemetry.Metrics.MetricTags.IastInstrumentedSources.Database,
        };
    ...
    public static string[] GetNames()
        => new []
        {
            ...
            nameof(Datadog.Trace.Telemetry.Metrics.MetricTags.IastInstrumentedSources.Database),
        };
    ...
    public static string[] GetDescriptions()
        => new []
        {
            ...
            "source_type:http.request.database",
        };
}