...
internal static partial class ConfigKeyAliasesSwitcher
{
    ...
    public static System.ReadOnlySpan<string> GetAliases(string mainKey)
    {
        ...
        "DD_API_SECURITY_DOWNSTREAM_BODY_ANALYSIS_SAMPLE_RATE" => new string[] {"DD_API_SECURITY_DOWNSTREAM_REQUEST_BODY_ANALYSIS_SAMPLE_RATE"},
        ...
        "OTEL_EXPORTER_OTLP_TRACES_HEADERS" => new string[] {"OTEL_EXPORTER_OTLP_HEADERS"},
        "OTEL_EXPORTER_OTLP_TRACES_PROTOCOL" => new string[] {"OTEL_EXPORTER_OTLP_PROTOCOL"},
        "OTEL_EXPORTER_OTLP_TRACES_TIMEOUT" => new string[] {"OTEL_EXPORTER_OTLP_TIMEOUT"},
            _ => []
        };
    }
#else
    public static string[] GetAliases(string mainKey) => mainKey switch
    {
            ...
            "DD_API_SECURITY_DOWNSTREAM_BODY_ANALYSIS_SAMPLE_RATE" => ["DD_API_SECURITY_DOWNSTREAM_REQUEST_BODY_ANALYSIS_SAMPLE_RATE"],
