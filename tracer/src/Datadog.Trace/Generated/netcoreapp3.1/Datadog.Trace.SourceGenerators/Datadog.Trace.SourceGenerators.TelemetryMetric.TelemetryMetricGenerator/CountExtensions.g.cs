...
internal static partial class CountExtensions
{
    ...
    public static string? GetNamespace(this Datadog.Trace.Telemetry.Metrics.Count metric)
        => metric switch
        {
            ...
            Datadog.Trace.Telemetry.Metrics.Count.IastInstrumentedSources => "iast",
            Datadog.Trace.Telemetry.Metrics.Count.IastInstrumentedPropagations => "iast",
            Datadog.Trace.Telemetry.Metrics.Count.IastInstrumentedSinks => "iast",
            _ => null,
        };
}