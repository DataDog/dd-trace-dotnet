...
{
    private const int CountLength = 551;
    ...
    private static AggregatedMetric[] GetCountBuffer()
        => new AggregatedMetric[]
        {
            ...
            // rasp.rule.match, index = 504
            new(new[] { "waf_version", "rule_type:lfi" }),
            new(new[] { "waf_version", "rule_type:ssrf" }),
            new(new[] { "waf_version", "rule_type:sql_injection" }),
            // rasp.timeout, index = 507
            new(new[] { "waf_version", "rule_type:lfi" }),
            new(new[] { "waf_version", "rule_type:ssrf" }),
            new(new[] { "waf_version", "rule_type:sql_injection" }),
            // executed.source, index = 510
            ...
            // executed.propagation, index = 523
            new(null),
            // executed.sink, index = 524
    ...
    private static int[] CountEntryCounts { get; }
        = new int[]{ 4, 74, 1, 3, 4, 2, 2, 4, 1, 1, 1, 22, 3, 2, 4, 4, 1, 22, 3, 90, 90, 2, 44, 6, 1, 74, 1, 22, 3, 1, 1, 5, 3, 3, 3, 3, 13, 1, 26, 1, };
    ...
    {
        Interlocked.Add(ref _buffer.Count[523], increment);
    }
    ...
    {
        Interlocked.Add(ref _buffer.Count[550], increment);
    }
}