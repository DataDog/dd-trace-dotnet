...
internal partial class CiVisibilityMetricsTelemetryCollector
{
    ...
    private static AggregatedMetric[] GetCountSharedBuffer()
        => new AggregatedMetric[]
        {
            ...
            new(new[] { "integration_name:avro", "error_type:duck_typing" }),
            new(new[] { "integration_name:avro", "error_type:invoker" }),
            new(new[] { "integration_name:avro", "error_type:execution" }),
            new(new[] { "integration_name:avro", "error_type:missing_member" }),
        };
