...
internal partial class ExporterSettingsInternalSnapshot : SettingsSnapshotBase
{
    internal ExporterSettingsInternalSnapshot(Datadog.Trace.Configuration.ExporterSettingsInternal settings)
    {
    ...
    internal void RecordChanges(Datadog.Trace.Configuration.ExporterSettingsInternal settings, IConfigurationTelemetry telemetry)
    {
    ...
    partial void AdditionalInitialization(Datadog.Trace.Configuration.ExporterSettingsInternal settings);
    partial void RecordAdditionalChanges(Datadog.Trace.Configuration.ExporterSettingsInternal settings, IConfigurationTelemetry telemetry);
}