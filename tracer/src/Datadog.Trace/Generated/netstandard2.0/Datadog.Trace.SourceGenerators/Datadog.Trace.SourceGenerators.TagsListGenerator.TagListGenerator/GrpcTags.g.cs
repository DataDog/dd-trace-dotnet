...
#if NETCOREAPP
        private static ReadOnlySpan<byte> MethodKindBytes => new byte[] { 103, 114, 112, 99, 46, 109, 101, 116, 104, 111, 100, 46, 107, 105, 110, 100 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> MethodNameBytes => new byte[] { 103, 114, 112, 99, 46, 109, 101, 116, 104, 111, 100, 46, 110, 97, 109, 101 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> MethodPathBytes => new byte[] { 103, 114, 112, 99, 46, 109, 101, 116, 104, 111, 100, 46, 112, 97, 116, 104 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> MethodPackageBytes => new byte[] { 103, 114, 112, 99, 46, 109, 101, 116, 104, 111, 100, 46, 112, 97, 99, 107, 97, 103, 101 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> MethodServiceBytes => new byte[] { 103, 114, 112, 99, 46, 109, 101, 116, 104, 111, 100, 46, 115, 101, 114, 118, 105, 99, 101 };
#else
...
#if NETCOREAPP
        private static ReadOnlySpan<byte> StatusCodeBytes => new byte[] { 103, 114, 112, 99, 46, 115, 116, 97, 116, 117, 115, 46, 99, 111, 100, 101 };
#else
