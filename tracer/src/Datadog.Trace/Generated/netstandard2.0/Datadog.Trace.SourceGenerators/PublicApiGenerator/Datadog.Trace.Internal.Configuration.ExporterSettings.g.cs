...
#pragma warning disable SA1624 // Documentation summary should begin with "Gets" - the documentation is primarily for public property
    ...
    public string? TracesPipeName
    {
        get
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)48);
            return TracesPipeNameInternal;
        }
        set
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)49);
    ...
    public int TracesPipeTimeoutMs
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)50);
            return TracesPipeTimeoutMsInternal;
        }
        set
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)51);
    ...
    public string? MetricsPipeName
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)40);
            return MetricsPipeNameInternal;
        }
        set
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)41);
    ...
    public string? TracesUnixDomainSocketPath
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)52);
            return TracesUnixDomainSocketPathInternal;
        }
        set
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)53);
    ...
    public string? MetricsUnixDomainSocketPath
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)42);
            return MetricsUnixDomainSocketPathInternal;
        }
        set
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)43);
    ...
    public int DogStatsdPort
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)38);
            return DogStatsdPortInternal;
        }
        set
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)39);
    ...
    public bool PartialFlushEnabled
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)44);
            return PartialFlushEnabledInternal;
        }
        set
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)45);
