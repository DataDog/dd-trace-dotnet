...
partial class TracerSettingsInternal
{
...
#pragma warning disable SA1624 // Documentation summary should begin with "Gets" - the documentation is primarily for public property
    ...
    public System.Collections.Generic.HashSet<string> DisabledIntegrationNames
    {
        ...
        /// </summary>
    [Datadog.Trace.SourceGenerators.PublicApi]
    public Datadog.Trace.Configuration.ExporterSettingsInternal Exporter
    {
        get
        {
            Datadog.Trace.Telemetry.TelemetryFactory.Metrics.Record(
        ...
        /// <see cref="IntegrationSettingsInternal.AnalyticsEnabled"/> on some predetermined integrations.
    ...
    public double? GlobalSamplingRate
    {
        ...
        /// <summary>
        /// Gets a collection of <see cref="IntegrationSettingsInternal"/> keyed by integration name.
        /// </summary>
    [Datadog.Trace.SourceGenerators.PublicApi]
    public Datadog.Trace.Configuration.IntegrationSettingsCollectionInternal Integrations
    {
        get
        {
            Datadog.Trace.Telemetry.TelemetryFactory.Metrics.Record(
