...
partial class ImmutableExporterSettings
{
    ...
    public System.Uri AgentUri
    {
        get
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)60);
    ...
    public string? TracesPipeName
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)66);
    ...
    public int TracesPipeTimeoutMs
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)67);
    ...
    public string? MetricsPipeName
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)62);
    ...
    public int DogStatsdPort
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)61);
    ...
    public bool PartialFlushEnabled
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)64);
    ...
    public int PartialFlushMinSpans
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)65);
    ...
    public string? TracesUnixDomainSocketPath
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)68);
    ...
    public string? MetricsUnixDomainSocketPath
    {
        ...
        {
            Datadog.Trace.Internal.Telemetry.TelemetryFactory.Metrics.Record(
                (Datadog.Trace.Internal.Telemetry.Metrics.PublicApiUsage)63);
