...
internal sealed partial class CiVisibilityMetricsTelemetryCollector
{
    ...
    private static AggregatedMetric[] GetCountSharedBuffer()
        => new AggregatedMetric[]
        {
            ...
            new(new[] { "integration_name:samplecalltargetnativeaotintegration", "error_type:duck_typing" }),
            new(new[] { "integration_name:samplecalltargetnativeaotintegration", "error_type:invoker" }),
            new(new[] { "integration_name:samplecalltargetnativeaotintegration", "error_type:execution" }),
            new(new[] { "integration_name:samplecalltargetnativeaotintegration", "error_type:missing_member" }),
        };
