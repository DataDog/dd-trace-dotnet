...
{
    private const int CountLength = 323;
    ...
    private static AggregatedMetric[] GetCountBuffer()
        => new AggregatedMetric[]
        {
            ...
            // spans_finished, index = 66
            new(null),
            // spans_enqueued_for_serialization, index = 67
            new(new[] { "reason:p0_keep" }),
            new(new[] { "reason:single_span_sampling" }),
            new(new[] { "reason:default" }),
            // spans_dropped, index = 70
            new(new[] { "reason:p0_drop" }),
            new(new[] { "reason:overfull_buffer" }),
            new(new[] { "reason:serialization_error" }),
            new(new[] { "reason:api_error" }),
            // trace_segments_created, index = 74
            new(new[] { "new_continued:new" }),
            new(new[] { "new_continued:continued" }),
            // trace_chunks_enqueued_for_serialization, index = 76
            new(new[] { "reason:p0_keep" }),
            new(new[] { "reason:default" }),
            // trace_chunks_dropped, index = 78
            new(new[] { "reason:p0_drop" }),
            new(new[] { "reason:overfull_buffer" }),
            new(new[] { "reason:serialization_error" }),
            new(new[] { "reason:api_error" }),
            // trace_chunks_sent, index = 82
            new(null),
            // trace_segments_closed, index = 83
            new(null),
            // trace_api.requests, index = 84
            new(null),
            // trace_api.responses, index = 85
            ...
            new(new[] { "status_code:504" }),
            new(new[] { "status_code:5xx" }),
            // stats_api.errors, index = 143
            new(new[] { "type:timeout" }),
            new(new[] { "type:network" }),
            new(new[] { "type:status_code" }),
            // telemetry_api.requests, index = 146
            new(new[] { "endpoint:agent" }),
            new(new[] { "endpoint:agentless" }),
            // telemetry_api.responses, index = 148
            ...
            // telemetry_api.errors, index = 192
            ...
            // version_conflict_tracers_created, index = 198
            new(null),
            // direct_log_logs, index = 199
            new(new[] { "integration_name:datadog" }),
            new(new[] { "integration_name:opentracing" }),
            new(new[] { "integration_name:ciapp" }),
            new(new[] { "integration_name:debugger_span_probe" }),
            ...
            new(new[] { "integration_name:ibmmq" }),
            new(new[] { "integration_name:remoting" }),
            // direct_log_api.requests, index = 261
            new(null),
            // direct_log_api.responses, index = 262
            new(new[] { "status_code:200" }),
            new(new[] { "status_code:201" }),
            new(new[] { "status_code:202" }),
            new(new[] { "status_code:204" }),
            ...
            new(new[] { "status_code:504" }),
            new(new[] { "status_code:5xx" }),
            // direct_log_api.errors, index = 284
            new(new[] { "type:timeout" }),
            new(new[] { "type:network" }),
            new(new[] { "type:status_code" }),
            // waf.init, index = 287
            new(null),
            // waf.updates, index = 288
            new(null),
            // waf.requests, index = 289
            ...
            // executed.propagation, index = 306
            new(null),
            // executed.sink, index = 307
    ...
    private static int[] CountEntryCounts { get; }
        = new int[]{ 4, 62, 1, 3, 4, 2, 2, 4, 1, 1, 1, 22, 3, 2, 4, 4, 1, 22, 3, 2, 44, 6, 1, 62, 1, 22, 3, 1, 1, 5, 12, 1, 15, 1, };
    ...
    {
        Interlocked.Add(ref _buffer.Count[66], increment);
    }
    ...
    {
        var index = 148 + ((int)tag1 * 22) + (int)tag2;
        Interlocked.Add(ref _buffer.Count[index], increment);
    }
    ...
    {
        var index = 192 + ((int)tag1 * 3) + (int)tag2;
        Interlocked.Add(ref _buffer.Count[index], increment);
    }

    public void RecordCountVersionConflictTracerCreated(int increment = 1)
    {
        Interlocked.Add(ref _buffer.Count[198], increment);
    }
    ...
    {
        Interlocked.Add(ref _buffer.Count[261], increment);
    }
    ...
    {
        Interlocked.Add(ref _buffer.Count[322], increment);
    }
}