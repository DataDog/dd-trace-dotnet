...
internal static partial class CountExtensions
{
    ...
    public static string GetName(this Datadog.Trace.Telemetry.Metrics.Count metric)
        => metric switch
        {
            ...
            Datadog.Trace.Telemetry.Metrics.Count.MetricsExportAttempts => "metrics_export_attempts",
            Datadog.Trace.Telemetry.Metrics.Count.MetricsExportSuccesses => "metrics_export_successes",
            Datadog.Trace.Telemetry.Metrics.Count.MetricsExportPartialSuccesses => "metrics_export_partial_successes",
            Datadog.Trace.Telemetry.Metrics.Count.MetricsExportFailures => "metrics_export_failures",
