...
internal partial class MetricsTelemetryCollector
{
    ...
    private static AggregatedMetric[] GetCountSharedBuffer()
        => new AggregatedMetric[]
        {
            ...
            new(new[] { "integration_name:owin", "error_type:duck_typing" }),
            new(new[] { "integration_name:owin", "error_type:invoker" }),
            new(new[] { "integration_name:owin", "error_type:execution" }),
            new(new[] { "integration_name:owin", "error_type:missing_member" }),
        };
