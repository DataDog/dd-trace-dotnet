...
internal static partial class IntegrationIdExtensions
{
    ...
    public static string ToStringFast(this Datadog.Trace.Configuration.IntegrationId value)
        => value switch
        {
            ...
            Datadog.Trace.Configuration.IntegrationId.Owin => nameof(Datadog.Trace.Configuration.IntegrationId.Owin),
            _ => value.ToString(),
        };
    ...
    public static string[] GetNames()
        => new []
        {
            ...
            nameof(Datadog.Trace.Configuration.IntegrationId.Owin),
        };
}