// <copyright file="SpanProbeIntegration.cs" company="Datadog">
...
namespace Datadog.Trace.Debugger.Instrumentation
{
    ...
    public class SpanProbeIntegration
    {
        ...
        internal static CallTargetState OnMethodBegin<TTarget>(TTarget instance, string probeId, string? resourceName, string? operationName)
        {
