...
namespace Datadog.Trace.Debugger.Instrumentation
{
    ...
    public ref struct LineDebuggerState
    {
        ...
        internal LineDebuggerState(string probeId, Scope scope, DateTimeOffset? startTime, int methodMetadataIndex, ref ProbeData probeData, int lineNumber, string probeFilePath, object invocationTarget)
        {
            _probeId = probeId;
            _scope = scope;
