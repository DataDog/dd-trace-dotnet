...
namespace Datadog.Trace.Debugger.Instrumentation
{
    ...
    public static partial class AsyncMethodDebuggerInvoker
    {
        ...
        /// <param name="asyncState">Debugger state</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void LogCall<TReturnValue>(TReturnValue returnValue, string methodName, int bytecodeOffset, ref AsyncMethodDebuggerState asyncState)
        {
            if (!asyncState.IsActive)
            {
                return;
            ...
            asyncState.SnapshotCreator.CaptureReturnValue(returnValue, methodName, lineNumber, returnValue?.GetType() ?? typeof(TReturnValue));
        }
