...
namespace Datadog.Trace.Debugger.Instrumentation
{
    ...
    public static class MethodDebuggerInvoker
    {
        ...
        /// <param name="state">Debugger state</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void LogCall<TReturnValue>(TReturnValue returnValue, string methodName, int bytecodeOffset, ref MethodDebuggerState state)
        {
            if (!state.IsActive)
            {
                return;
            ...
            state.SnapshotCreator.CaptureReturnValue(returnValue, methodName, lineNumber, returnValue?.GetType() ?? typeof(TReturnValue));
        }
