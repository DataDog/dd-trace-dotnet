...
namespace Datadog.Trace.Debugger.ExceptionAutoInstrumentation
{
    ...
    internal static class ExceptionReplayDiagnosticTagNames
    {
        ...
        public const string InvalidatedExceptionCase1 = nameof(InvalidatedExceptionCase1);
        public const string InvalidatedExceptionCase2 = nameof(InvalidatedExceptionCase2);
