...
internal class LiveDebuggerFactory
{
    ...
    public static LiveDebugger Create(IDiscoveryService discoveryService, IRcmSubscriptionManager remoteConfigurationManager, ImmutableTracerSettingsInternal tracerSettings, string serviceName, ITelemetryController telemetry, DebuggerSettings debuggerSettings, IGitMetadataTagsProvider gitMetadataTagsProvider)
    {
    ...
    private static IDogStatsd GetDogStatsd(ImmutableTracerSettingsInternal tracerSettings, string serviceName)
    {
        IDogStatsd statsd;
    ...
    private static IDebuggerUploader CreateSymbolsUploader(IDiscoveryService discoveryService, IRcmSubscriptionManager remoteConfigurationManager, ImmutableTracerSettingsInternal tracerSettings, string serviceName, DebuggerSettings settings, IGitMetadataTagsProvider gitMetadataTagsProvider)
    {
    ...
    private static IApiRequestFactory GetApiFactory(ImmutableTracerSettingsInternal tracerSettings, bool isMultipart)
    {
