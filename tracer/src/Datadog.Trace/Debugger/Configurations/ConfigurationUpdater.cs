...
namespace Datadog.Trace.Debugger.Configurations
{
    internal class ConfigurationUpdater
    {
        ...
        {
            return LiveDebugger.Instance.UpdateAddedProbeInstrumentations(comparer.AddedDefinitions);
        }

        private ApplyDetails[] HandleRemovedProbesChanges(List<RemoteConfigurationPath> paths)
        {
            return LiveDebugger.Instance.UpdateRemovedProbeInstrumentations(paths);
        }
