...
namespace Datadog.Trace.Telemetry
{
    internal class TelemetryFactory
    {
        ...
        public ITelemetryController CreateTelemetryController(ImmutableTracerSettingsInternal tracerSettings, IDiscoveryService discoveryService)
        ...
        public ITelemetryController CreateCiVisibilityTelemetryController(ImmutableTracerSettingsInternal tracerSettings, IDiscoveryService discoveryService, bool isAgentAvailable)
        ...
        public ITelemetryController CreateTelemetryController(ImmutableTracerSettingsInternal tracerSettings, TelemetrySettings settings, IDiscoveryService discoveryService, bool useCiVisibilityTelemetry)
        {
