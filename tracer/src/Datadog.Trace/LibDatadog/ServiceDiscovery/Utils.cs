...
{
    internal static void StoreTracerMetadata(
        byte schemaVersion,
        string runtimeId,
        ...
        string serviceVersion)
    {
        ...
        var result = NativeInterop.ServiceDiscovery.StoreTracerMetadata(schemaVersion, runtimeIdCharSlice, tracerLanguageCharSlice, tracerVersionCharSlice, hostnameCharSlice, serviceNameCharSlice, serviceEnvCharSlice, serviceVersionCharSlice);

        CharSlice.FreeCharSlice(runtimeIdCharSlice);
