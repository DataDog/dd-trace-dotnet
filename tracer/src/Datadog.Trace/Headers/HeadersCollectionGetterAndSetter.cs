// <copyright file="HeadersCollectionGetterAndSetter.cs" company="Datadog">
...
internal readonly struct HeadersCollectionGetterAndSetter<TCarrier> : ICarrierGetter<TCarrier>, ICarrierSetter<TCarrier>
