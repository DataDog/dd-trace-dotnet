// <copyright file="SpanContextInternal.cs" company="Datadog">
...
namespace Datadog.Trace
{
    ...
    /// </summary>
    public partial class SpanContextInternal : ISpanContext, IReadOnlyDictionary<string, string>
    {
        ...
        /// <see cref="SpanCreationSettings.Parent"/> in <see cref="TracerInternal.StartActive(string, SpanCreationSettings)"/>
        /// to specify that the new span should not inherit the currently active scope as its parent.
        /// </summary>
        public static readonly ISpanContext None = new ReadOnlySpanContextInternal(traceId: Trace.TraceId.Zero, spanId: 0, serviceName: null);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SpanContextInternal"/> class
        ...
        [PublicApi]
        public SpanContextInternal(ulong? traceId, ulong spanId, SamplingPriority? samplingPriority = null, string serviceName = null)
        ...
        /// <param name="isRemote">Whether this <see cref="SpanContextInternal"/> was from a distributed context.</param>
        internal SpanContextInternal(TraceId traceId, ulong spanId, int? samplingPriority, string serviceName, string origin, bool isRemote = false)
        ...
        /// <param name="isRemote">Whether this <see cref="SpanContextInternal"/> was from a distributed context.</param>
        internal SpanContextInternal(TraceId traceId, ulong spanId, int? samplingPriority, string serviceName, string origin, string rawTraceId, string rawSpanId, bool isRemote = false)
            : this(traceId, serviceName)
        {
            SpanId = spanId;
            SamplingPriority = samplingPriority;
        ...
        /// <param name="isRemote">Whether this <see cref="SpanContextInternal"/> was from a distributed context.</param>
        internal SpanContextInternal(ISpanContext parent, TraceContext traceContext, string serviceName, TraceId traceId = default, ulong spanId = 0, string rawTraceId = null, string rawSpanId = null, bool isRemote = false)
            : this(GetTraceId(parent, traceId), serviceName)
        {
            ...
            if (parent is SpanContextInternal spanContext)
            {
        ...
        private SpanContextInternal(TraceId traceId, string serviceName)
        {
        ...
        /// <summary>
        ///  Gets a value indicating whether this <see cref="SpanContextInternal"/> was propagated from a remote parent.
        /// </summary>
            ...
            return context switch
                   {
                       ...
                       SpanContextInternal sc => sc.TraceId128,
