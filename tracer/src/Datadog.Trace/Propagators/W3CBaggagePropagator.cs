...
internal class W3CBaggagePropagator : IContextInjector, IContextExtractor
{
        ...
        where TCarrierSetter : struct, ICarrierSetter<TCarrier>
    {
        ...
        GetSettings(context, out var baggageMaximumItems, out var baggageMaximumBytes);
        var headerValue = CreateHeader(baggage, baggageMaximumItems, baggageMaximumBytes);
    ...
    private static void GetSettings(PropagationContext context, out int baggageMaximumItems, out int baggageMaximumBytes)
    {
        ...
        {
            baggageMaximumItems = DefaultMaximumBaggageItems;
            baggageMaximumBytes = DefaultMaximumBaggageBytes;
        }
    }
