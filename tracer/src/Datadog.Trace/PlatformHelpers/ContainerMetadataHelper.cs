// <copyright file="ContainerMetadataHelper.cs" company="Datadog">
...
{
    public static void AddContainerMetadataHeaders(this IApiRequest request, ContainerMetadata containerMetadata)
    {
