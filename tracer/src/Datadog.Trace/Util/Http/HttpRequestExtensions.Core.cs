...
namespace Datadog.Trace.Util.Http
{
    internal static partial class HttpRequestExtensions
    {
        ...
        internal static Dictionary<string, object> PrepareArgsForWaf(this HttpRequest request, RouteData routeData = null)
        {
            ...
            foreach (var k in request.Headers.Keys)
            {
                ...
                {
                    headersDic.Add(k.ToLowerInvariant(), request.Headers[k].ToString());
                }
            }
            ...
            var queryStringDic = new Dictionary<string, object>(request.Query.Count);
