// <copyright file="DefaultAction5Callbacks.cs" company="Datadog">
...
internal readonly struct DefaultAction5Callbacks : IAction5Callbacks
{
    ...
    public DefaultAction5Callbacks(DelegateBegin? onDelegateBegin = null, DelegateEnd? onDelegateEnd = null, ExceptionDelegate? onException = null)
    {
    ...
    object? IAction5Callbacks.OnDelegateBegin<TArg1, TArg2, TArg3, TArg4, TArg5>(object? sender, ref TArg1 arg1, ref TArg2 arg2, ref TArg3 arg3, ref TArg4 arg4, ref TArg5 arg5)
        => OnDelegateBegin?.Invoke(sender, arg1, arg2, arg3, arg4, arg5);
