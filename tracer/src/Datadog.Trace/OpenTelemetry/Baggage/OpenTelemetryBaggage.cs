// <copyright file="OpenTelemetryBaggage.cs" company="Datadog">
...
internal static class OpenTelemetryBaggage
{
    ...
    internal static IReadOnlyDictionary<string, string>? GetBaggageItems()
    {
        ...
        var proxy = (IOpenTelemetryBaggage)result.CreateInstance(null);
