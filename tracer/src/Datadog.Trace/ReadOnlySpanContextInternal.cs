// <copyright file="ReadOnlySpanContextInternal.cs" company="Datadog">
...
{
    internal class ReadOnlySpanContextInternal : ISpanContext
    {
        public ReadOnlySpanContextInternal(TraceId traceId, ulong spanId, string serviceName)
        {
            TraceId128 = traceId;
            SpanId = spanId;
