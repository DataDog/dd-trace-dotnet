...
namespace Datadog.Trace
{
    internal class TracerManagerFactory
    {
            ...
            ITracerFlareManager tracerFlareManager)
        {
            ...
            SpanContextPropagator.Instance = SpanContextPropagatorFactory.GetSpanContextPropagator(settings.PropagationStyleInject, settings.PropagationStyleExtract, settings.PropagationExtractFirstOnly, settings.PropagationBehaviorExtract);
