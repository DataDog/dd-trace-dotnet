    ...
    internal class Security : IDatadogSecurity, IDisposable
    {
        ...
        private void Report(ITransport transport, Span span, string resultData, bool blocked)
        {
            ...
            if (exceededTraces <= 0)
            {
                ...
                span.SetTraceSamplingPriority(_settings.KeepTraces ? SamplingPriorityInternal.UserKeep : SamplingPriorityInternal.AutoReject);
            }
            else
            {
                ...
                {
                    span.SetTraceSamplingPriority(SamplingPriorityInternal.AutoReject);
                }
            }
