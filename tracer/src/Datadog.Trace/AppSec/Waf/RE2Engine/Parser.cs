...
namespace engine
{
    ...
    public class Parser
    {
        ...
        private Regexp[] popToPseudo()
        {
            ...
            var subrange = stack.GetRange(i, n - i);
        ...
        private Regexp parseInternal()
        {
            ...
            while (t.more())
            {
                ...
                switch (t.peek())
                {
                    ...
                    {
                        repeatPos = t.pos();
                        Regexp.Op op = default(Regexp.Op);
                        switch (t.pop())
                        {
                            case '*':
                                op = Regexp.Op.STAR;
...
// on success, undefined on failure, in which case false is returned.
        ...
        public class Pair<F, S>
        {
            ...
            public static Pair<F, S> of(F first, S second)
            {
