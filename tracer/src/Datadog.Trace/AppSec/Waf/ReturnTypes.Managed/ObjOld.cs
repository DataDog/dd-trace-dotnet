// <copyright file="ObjOld.cs" company="Datadog">
...
namespace Datadog.Trace.AppSec.Waf
{
    ...
    internal class ObjOld : IDisposable
    {
        private IntPtr ptr;
        ...
        public ObjOld(IntPtr ptr) => this.ptr = ptr;
        ...
        public ObjTypeOld ArgsType
        {
            get
            {
                Initialize();
                return EncoderOld.DecodeArgsType(innerObj.Type);
            }
        }
