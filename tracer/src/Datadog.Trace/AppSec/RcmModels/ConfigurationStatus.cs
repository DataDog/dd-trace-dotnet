...
internal class ConfigurationStatus
{
    ...
    public ConfigurationStatus(string embeddedRulesPath)
    {
        _embeddedRulesPath = embeddedRulesPath;
    }
    ...
    public bool FallbackToEmbeddedRulesetAtNextUpdate { get; set; }
    ...
    internal Dictionary<string, object> ToDictionary()
    {
        ...
        if (rulesetFromRcm != null)
        {
            rulesetFromRcm.AddToDictionaryAtRoot(dictionary);
        }
        else if (FallbackToEmbeddedRulesetAtNextUpdate)
        {
