// <copyright file="EventTrackingSdkInternal.cs" company="Datadog">
...
/// Allow
/// </summary>
public static class EventTrackingSdkInternal
{
        /// <summary>
        ...
        public static void TrackUserLoginSuccessEvent(string userId)
        {
            ...
            TrackUserLoginSuccessEvent(userId, null, TracerInternal.Instance);
        }
        ...
        public static void TrackUserLoginSuccessEvent(string userId, IDictionary<string, string> metadata)
        {
            ...
            TrackUserLoginSuccessEvent(userId, metadata, TracerInternal.Instance);
        }

        internal static void TrackUserLoginSuccessEvent(string userId, IDictionary<string, string> metadata, TracerInternal tracer)
        {
        ...
        public static void TrackUserLoginFailureEvent(string userId, bool exists)
        {
            ...
            TrackUserLoginFailureEvent(userId, exists, null, TracerInternal.Instance);
        }
        ...
        public static void TrackUserLoginFailureEvent(string userId, bool exists, IDictionary<string, string> metadata)
        {
            ...
            TrackUserLoginFailureEvent(userId, exists, metadata, TracerInternal.Instance);
        }

        internal static void TrackUserLoginFailureEvent(string userId, bool exists, IDictionary<string, string> metadata, TracerInternal tracer)
        {
            if (string.IsNullOrEmpty(userId))
            {
                ThrowHelper.ThrowArgumentNullException(nameof(userId));
        ...
        public static void TrackCustomEvent(string eventName)
        {
            ...
            TrackCustomEvent(eventName, null, TracerInternal.Instance);
        }
        ...
        public static void TrackCustomEvent(string eventName, IDictionary<string, string> metadata)
        {
            ...
            TrackCustomEvent(eventName, metadata, TracerInternal.Instance);
        }

        internal static void TrackCustomEvent(string eventName, IDictionary<string, string> metadata, TracerInternal tracer)
        {
