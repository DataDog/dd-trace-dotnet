// <copyright file="SpanContextInjectorInternal.cs" company="Datadog">
...
namespace Datadog.Trace
{
    ...
    /// </summary>
    public class SpanContextInjectorInternal
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpanContextInjectorInternal"/> class
        /// </summary>
        [PublicApi]
        public SpanContextInjectorInternal()
        {
        ...
        internal static void InjectInternal<TCarrier>(TCarrier carrier, Action<TCarrier, string, string> setter, ISpanContext context, string? messageType = null, string? target = null)
        {
            ...
            if (context is SpanContextInternal spanContext)
            {
                ...
                var dsm = TracerInternal.Instance.TracerManager.DataStreamsManager;
