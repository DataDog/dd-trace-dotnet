...
using Datadog.Trace.Vendors.ICSharpCode.SharpZipLib.Encryption;
using Datadog.Trace.Vendors.ICSharpCode.SharpZipLib.Zip.Compression;
using Datadog.Trace.Vendors.ICSharpCode.SharpZipLib.Zip.Compression.Streams;
using System;
...
namespace Datadog.Trace.Vendors.ICSharpCode.SharpZipLib.Zip
{
	...
	/// using System.IO;
	///
	/// using Datadog.Trace.Vendors.ICSharpCode.SharpZipLib.Zip;
	///
	/// class MainClass
	/// {
	...
	internal class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </summary>
		internal delegate void KeysRequiredEventHandler(
			object sender,
