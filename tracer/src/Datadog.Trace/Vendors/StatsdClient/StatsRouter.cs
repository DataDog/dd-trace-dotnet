...
namespace Datadog.Trace.Vendors.StatsdClient
{
    ...
    {
        private static readonly IDatadogLogger Log = DatadogLogging.GetLoggerFor<StatsRouter>();
        ...
        public void Route(Stats stats)
        {
            switch (stats.Kind)
            {
                ...
                case StatsKind.Metric:
                    ...
                    {
                        Log.Warning("Failed to route metric {Name} in router", stats.Metric.StatName);
            ...
            Log.Information("Serialized metric {Name} in router", stats.Metric.StatName);
