...
namespace Datadog.Trace.Vendors.dnlib.DotNet {
	...
	/// </summary>
	internal abstract class MemberRef : IHasCustomAttribute, IMethodDefOrRef, ICustomAttributeType, IField, IContainsGenericParameter, IHasCustomDebugInformation {
		/// <summary>
	...
	/// </summary>
	internal class MemberRefUser : MemberRef {
		/// <summary>
		/// Constructor
		/// </summary>
