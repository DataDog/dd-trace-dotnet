...
namespace Datadog.Trace.Vendors.dnlib.DotNet {
	...
	/// </summary>
	internal interface IType : IFullName, IOwnerModule, ICodedToken, IGenericParameterProvider, IContainsGenericParameter {
		/// <summary>
	...
	/// </summary>
	internal interface IContainsGenericParameter {
		/// <summary>
