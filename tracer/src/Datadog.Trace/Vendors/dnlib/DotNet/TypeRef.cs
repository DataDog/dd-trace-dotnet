...
namespace Datadog.Trace.Vendors.dnlib.DotNet {
	...
	/// </summary>
	internal abstract class TypeRef : ITypeDefOrRef, IHasCustomAttribute, IMemberRefParent, IHasCustomDebugInformation, IResolutionScope {
		/// <summary>
	...
	/// </summary>
	internal class TypeRefUser : TypeRef {
		/// <summary>
		/// Constructor
		/// </summary>
