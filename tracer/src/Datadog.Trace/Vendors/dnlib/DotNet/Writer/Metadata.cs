...
namespace Datadog.Trace.Vendors.dnlib.DotNet.Writer {
	...
	/// </summary>
	internal readonly struct MetadataHeapsAddedEventArgs {
		/// <summary>
	...
	/// </summary>
	internal enum DebugMetadataKind {
		/// <summary>
	...
	/// </summary>
	internal readonly struct MetadataWriterEventArgs {
		/// <summary>
		/// Gets the metadata writer
		/// </summary>
		public Metadata Metadata { get; }
	...
	/// </summary>
	internal readonly struct MetadataProgressEventArgs {
		/// <summary>
		/// Gets the metadata writer
		/// </summary>
		public Metadata Metadata { get; }
	...
	/// .NET meta data
	/// </summary>
	internal abstract class Metadata : IReuseChunk, ISignatureWriterHelper, ITokenProvider, ICustomAttributeWriterHelper, IPortablePdbCustomDebugInfoWriterHelper, IWriterError2 {
		uint length;
		FileOffset offset;
		RVA rva;
