...
namespace Datadog.Trace.Vendors.dnlib.DotNet.Resources {
	...
	/// </summary>
	[Serializable]
	internal sealed class ResourceReaderException : Exception {
		/// <summary>
		/// Constructor
		/// </summary>
	...
	/// <returns></returns>
	internal delegate IResourceData CreateResourceDataDelegate(ResourceDataFactory resourceDataFactory, UserResourceType type, byte[] serializedData);

	/// <summary>
	/// Reads .NET resources
	/// </summary>
	internal struct ResourceReader {
		DataReader reader;
