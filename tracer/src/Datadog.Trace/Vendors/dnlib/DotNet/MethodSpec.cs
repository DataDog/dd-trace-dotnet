...
namespace Datadog.Trace.Vendors.dnlib.DotNet {
	...
	/// </summary>
	internal abstract class MethodSpec : IHasCustomAttribute, IHasCustomDebugInformation, IMethod, IContainsGenericParameter {
		/// <summary>
	...
	/// </summary>
	internal class MethodSpecUser : MethodSpec {
		/// <summary>
		/// Default constructor
		/// </summary>
