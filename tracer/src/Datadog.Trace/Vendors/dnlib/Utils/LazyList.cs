...
namespace Datadog.Trace.Vendors.dnlib.Utils {
	...
	internal interface IListListener<TListValue> {
		/// <summary>
	...
	internal class LazyList<TValue> : ILazyList<TValue> where TValue : class {
	...
	[DebuggerDisplay("Count = {Count}")]
	[DebuggerTypeProxy(typeof(CollectionDebugView<,>))]
	internal class LazyList<TValue, TContext> : LazyList<TValue>, ILazyList<TValue> where TValue : class {
