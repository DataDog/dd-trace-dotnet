...
{
    internal readonly struct CustomDebugInformationHandleCollection : 
    ...
    IEnumerable
  {
    ...
    #nullable enable
    internal struct Enumerator : IEnumerator<CustomDebugInformationHandle>, IDisposable, IEnumerator
    {
