...
{
    internal readonly struct MethodDebugInformationHandleCollection : 
    ...
    IEnumerable
  {
    ...
    #nullable enable
    internal struct Enumerator : IEnumerator<MethodDebugInformationHandle>, IDisposable, IEnumerator
    {
