// <copyright file="CorrelationIdentifierInternal.cs" company="Datadog">
...
namespace Datadog.Trace
{
    ...
    /// </summary>
    public static class CorrelationIdentifierInternal
    {
        ...
        public static string Service
        {
            get
            {
                ...
                return TracerInternal.Instance.DefaultServiceName ?? string.Empty;
            }
        }
        ...
        public static string Version
        {
            get
            {
                ...
                return TracerInternal.Instance.Settings.ServiceVersionInternal ?? string.Empty;
            }
        }
        ...
        public static string Env
        {
            get
            {
                ...
                return TracerInternal.Instance.Settings.EnvironmentInternal ?? string.Empty;
            }
        }
        ...
        public static ulong TraceId
        {
            get
            {
                ...
                return TracerInternal.Instance.ActiveScope?.Span?.TraceId ?? 0;
            }
        }
        ...
        public static ulong SpanId
        {
            get
            {
                ...
                return TracerInternal.Instance.ActiveScope?.Span?.SpanId ?? 0;
            }
        }
    }
}
