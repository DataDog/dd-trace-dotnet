// <copyright file="InternalTracerSettings.cs" company="Datadog">
...
namespace Datadog.Trace.Internal.Configuration
{
    ...
    /// </summary>
    [GenerateSnapshot]
    public partial class InternalTracerSettings
    {
        private static readonly IDatadogLogger Log = DatadogLogging.GetLoggerFor<InternalTracerSettings>();

        private readonly IConfigurationTelemetry _telemetry;
        private readonly InternalTracerSettingsSnapshot _initialSettings;

        /// <summary>
        /// Initializes a new instance of the <see cref="InternalTracerSettings"/> class with default values.
        /// </summary>
        [PublicApi]
        public InternalTracerSettings()
        ...
        /// </summary>
        /// <param name="useDefaultSources">If <c>true</c>, creates a <see cref="InternalTracerSettings"/> populated from
        /// the default sources such as environment variables etc. If <c>false</c>, uses the default values.</param>
        [PublicApi]
        public InternalTracerSettings(bool useDefaultSources)
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalTracerSettings"/> class
        ...
        internal InternalTracerSettings(IConfigurationSource? source, IConfigurationTelemetry telemetry)
        {
            ...
            IntegrationsInternal = new InternalIntegrationSettingsCollection(source, unusedParamNotToUsePublicApi: false);

            ExporterInternal = new InternalExporterSettings(source, _telemetry);
...
#pragma warning restore 618
            ...
            _initialSettings = new InternalTracerSettingsSnapshot(this);
        }
...
#pragma warning disable SA1624 // Documentation summary should begin with "Gets" - the documentation is primarily for public property
        ...
        internal InternalExporterSettings ExporterInternal { get; private set; }

        /// <summary>
        /// Gets or sets a value indicating whether default Analytics are enabled.
        /// Settings this value is a shortcut for setting
        /// <see cref="InternalIntegrationSettings.AnalyticsEnabled"/> on some predetermined integrations.
...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// Gets a collection of <see cref="InternalIntegrationSettings"/> keyed by integration name.
        /// </summary>
        [GeneratePublicApi(PublicApiUsage.TracerSettings_Integrations_Get)]
        internal InternalIntegrationSettingsCollection IntegrationsInternal { get; }
...
#pragma warning disable SA1624 // Documentation summary should begin with "Gets" - the documentation is primarily for public property
        ...
        public bool DiagnosticSourceEnabled
        {
            get
            {
                ...
                return InternalGlobalSettings.Instance.DiagnosticSourceEnabled;
            }
...
#pragma warning restore SA1624
        ...
        /// <summary>
        /// Create a <see cref="InternalTracerSettings"/> populated from the default sources
        /// returned by <see cref="GlobalConfigurationSource.Instance"/>.
        /// </summary>
        /// <returns>A <see cref="InternalTracerSettings"/> populated from the default sources.</returns>
        [PublicApi]
        public static InternalTracerSettings FromDefaultSources()
        {
        ...
        internal static InternalTracerSettings FromDefaultSourcesInternal()
        ...
        public InternalImmutableTracerSettings Build()
        {
            ...
            return new InternalImmutableTracerSettings(this, true);
        }
        ...
        internal static InternalTracerSettings Create(Dictionary<string, object?> settings)
