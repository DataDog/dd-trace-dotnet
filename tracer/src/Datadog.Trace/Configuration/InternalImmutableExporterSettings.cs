// <copyright file="InternalImmutableExporterSettings.cs" company="Datadog">
...
namespace Datadog.Trace.Internal.Configuration
{
    ...
    /// </summary>
    public partial class InternalImmutableExporterSettings
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalImmutableExporterSettings"/> class
        /// using the specified <see cref="IConfigurationSource"/> to initialize values.
        /// </summary>
        /// <param name="source">The <see cref="IConfigurationSource"/> to use when retrieving configuration values.</param>
        [PublicApi]
        public InternalImmutableExporterSettings(IConfigurationSource source)
            : this(new InternalExporterSettings(source, new ConfigurationTelemetry()), true)
        {
            TelemetryFactory.Metrics.Record(PublicApiUsage.ImmutableExporterSettings_Ctor_Source);
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="InternalImmutableExporterSettings"/> class from
        /// a TracerSettings instance.
        /// </summary>
        /// <param name="settings">The tracer settings to use to populate the immutable tracer settings</param>
        [PublicApi]
        public InternalImmutableExporterSettings(InternalExporterSettings settings)
            : this(settings, true)
        {
            TelemetryFactory.Metrics.Record(PublicApiUsage.ImmutableExporterSettings_Ctor_Settings);
        }

        internal InternalImmutableExporterSettings(InternalExporterSettings settings, bool unused)
        {
