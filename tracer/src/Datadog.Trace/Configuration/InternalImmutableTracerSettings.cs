// <copyright file="InternalImmutableTracerSettings.cs" company="Datadog">
...
namespace Datadog.Trace.Internal.Configuration
{
    ...
    /// </summary>
    public partial record InternalImmutableTracerSettings
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalImmutableTracerSettings"/> class
        /// using the specified <see cref="IConfigurationSource"/> to initialize values.
        /// </summary>
        /// <param name="source">The <see cref="IConfigurationSource"/> to use when retrieving configuration values.</param>
        [PublicApi]
        public InternalImmutableTracerSettings(IConfigurationSource source)
            : this(new InternalTracerSettings(source, new ConfigurationTelemetry()), true)
        {
            TelemetryFactory.Metrics.Record(PublicApiUsage.ImmutableTracerSettings_Ctor_Source);
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="InternalImmutableTracerSettings"/> class from
        /// a TracerSettings instance.
        /// </summary>
        /// <param name="settings">The tracer settings to use to populate the immutable tracer settings</param>
        [PublicApi]
        public InternalImmutableTracerSettings(InternalTracerSettings settings)
            : this(settings, true)
        {
            TelemetryFactory.Metrics.Record(PublicApiUsage.ImmutableTracerSettings_Ctor_Settings);
        }

        internal InternalImmutableTracerSettings(InternalTracerSettings settings, bool unusedParamNotToUsePublicApi)
        {
            ...
            ExporterInternal = new InternalImmutableExporterSettings(settings.ExporterInternal, true);
...
#pragma warning restore 618
            ...
            IntegrationsInternal = new InternalImmutableIntegrationSettingsCollection(settings.IntegrationsInternal, settings.DisabledIntegrationNamesInternal);
        ...
        internal InternalImmutableExporterSettings ExporterInternal { get; }
...
#pragma warning restore CS1574
        ...
        internal InternalImmutableIntegrationSettingsCollection IntegrationsInternal { get; }
        ...
        /// <summary>
        /// Gets the telemetry that was collected from <see cref="InternalTracerSettings"/> when this instance was built
        /// </summary>
        ...
        /// <summary>
        /// Create a <see cref="InternalImmutableTracerSettings"/> populated from the default sources
        /// returned by <see cref="GlobalConfigurationSource.Instance"/>.
        /// </summary>
        /// <returns>A <see cref="InternalImmutableTracerSettings"/> populated from the default sources.</returns>
        [PublicApi]
        public static InternalImmutableTracerSettings FromDefaultSources()
        {
            TelemetryFactory.Metrics.Record(PublicApiUsage.ImmutableTracerSettings_FromDefaultSources);
            return new InternalImmutableTracerSettings(InternalTracerSettings.FromDefaultSourcesInternal(), true);
        }
        ...
        public virtual bool Equals(InternalImmutableTracerSettings? other) => base.Equals(other);
