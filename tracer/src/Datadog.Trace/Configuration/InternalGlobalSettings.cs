// <copyright file="InternalGlobalSettings.cs" company="Datadog">
...
namespace Datadog.Trace.Internal.Configuration
{
    ...
    /// </summary>
    public class InternalGlobalSettings
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalGlobalSettings"/> class
        /// using the specified <see cref="IConfigurationSource"/> to initialize values.
        /// </summary>
        /// <param name="source">The <see cref="IConfigurationSource"/> to use when retrieving configuration values.</param>
        /// <param name="telemetry">Records the origin of telemetry values</param>
        internal InternalGlobalSettings(IConfigurationSource source, IConfigurationTelemetry telemetry)
        {
        ...
        /// </summary>
        internal static InternalGlobalSettings Instance { get; private set; } = CreateFromDefaultSources();
        ...
        /// <summary>
        /// Create a <see cref="InternalGlobalSettings"/> populated from the default sources
        ...
        [PublicApi]
        public static InternalGlobalSettings FromDefaultSources()
        {
            TelemetryFactory.Metrics.Record(PublicApiUsage.GlobalSettings_FromDefaultSources);
            return CreateFromDefaultSources();
        }

        private static InternalGlobalSettings CreateFromDefaultSources()
