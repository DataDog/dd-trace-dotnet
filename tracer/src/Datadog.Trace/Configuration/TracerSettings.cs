...
namespace Datadog.Trace.Configuration
{
    ...
    public partial class TracerSettings
    {
        ...
        internal TracerSettings(IConfigurationSource? source, IConfigurationTelemetry telemetry)
        {
            ...
            ApmEnabledInternal = config
                          .WithKeys(ConfigurationKeys.ApmEnabled)
                          .AsBool(defaultValue: true);
...
#pragma warning disable SA1624 // Documentation summary should begin with "Gets" - the documentation is primarily for public property
        ...
        [GeneratePublicApi(
            PublicApiUsage.TracerSettings_ApmEnabled_Get,
            PublicApiUsage.TracerSettings_ApmEnabled_Set)]
        [ConfigKey(ConfigurationKeys.ApmEnabled)]
        internal bool ApmEnabledInternal { get; private set; }
