// <copyright file="ImmutableExporterSettingsInternal.cs" company="Datadog">
...
namespace Datadog.Trace.Configuration
{
    ...
    /// </summary>
    public partial class ImmutableExporterSettingsInternal
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImmutableExporterSettingsInternal"/> class
        /// using the specified <see cref="IConfigurationSource"/> to initialize values.
        /// </summary>
        /// <param name="source">The <see cref="IConfigurationSource"/> to use when retrieving configuration values.</param>
        [PublicApi]
        public ImmutableExporterSettingsInternal(IConfigurationSource source)
            : this(new ExporterSettingsInternal(source, new ConfigurationTelemetry()), true)
        {
            TelemetryFactory.Metrics.Record(PublicApiUsage.ImmutableExporterSettings_Ctor_Source);
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ImmutableExporterSettingsInternal"/> class from
        /// a TracerSettings instance.
        /// </summary>
        /// <param name="settings">The tracer settings to use to populate the immutable tracer settings</param>
        [PublicApi]
        public ImmutableExporterSettingsInternal(ExporterSettingsInternal settings)
            : this(settings, true)
        {
            TelemetryFactory.Metrics.Record(PublicApiUsage.ImmutableExporterSettings_Ctor_Settings);
        }

        internal ImmutableExporterSettingsInternal(ExporterSettingsInternal settings, bool unused)
        {
