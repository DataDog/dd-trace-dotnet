...
namespace Datadog.Trace.Configuration
{
    ...
    internal static partial class ConfigurationKeys
    {
        ...
        /// <summary>
        /// Configuration key for setting where the tracer libraries are located
        /// </summary>
        public const string TracerHome = "DD_DOTNET_TRACER_HOME";

        /// <summary>
        /// Configuration key for enabling/disabling injection
        /// </summary>
        public const string InjectionEnabled = "DD_INJECTION_ENABLED";

        /// <summary>
        /// Configuration key for forcing injection
        /// </summary>
        public const string InjectForce = "DD_INJECT_FORCE";

        /// <summary>
        /// Configuration key for instrumentation install type
        /// </summary>
