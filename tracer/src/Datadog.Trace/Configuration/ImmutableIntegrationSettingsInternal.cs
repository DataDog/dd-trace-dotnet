// <copyright file="ImmutableIntegrationSettingsInternal.cs" company="Datadog">
...
namespace Datadog.Trace.Configuration
{
    ...
    /// </summary>
    public partial class ImmutableIntegrationSettingsInternal
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImmutableIntegrationSettingsInternal"/> class from an instance of
        /// <see cref="IntegrationSettingsInternal"/>.
        /// </summary>
        /// <param name="settings">The values to use.</param>
        /// <param name="isExplicitlyDisabled">If true forces the setting Enabled = false. Otherwise, uses <see cref="IntegrationSettingsInternal.EnabledInternal"/></param>
        internal ImmutableIntegrationSettingsInternal(IntegrationSettingsInternal settings, bool isExplicitlyDisabled)
        {
        ...
        internal ImmutableIntegrationSettingsInternal(string name)
        {
