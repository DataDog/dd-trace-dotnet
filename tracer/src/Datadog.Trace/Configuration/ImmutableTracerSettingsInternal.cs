// <copyright file="ImmutableTracerSettingsInternal.cs" company="Datadog">
...
namespace Datadog.Trace.Configuration
{
    ...
    /// </summary>
    public partial record ImmutableTracerSettingsInternal
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImmutableTracerSettingsInternal"/> class
        /// using the specified <see cref="IConfigurationSource"/> to initialize values.
        /// </summary>
        /// <param name="source">The <see cref="IConfigurationSource"/> to use when retrieving configuration values.</param>
        [PublicApi]
        public ImmutableTracerSettingsInternal(IConfigurationSource source)
            : this(new TracerSettingsInternal(source, new ConfigurationTelemetry(), new OverrideErrorLog()), true)
        {
            TelemetryFactory.Metrics.Record(PublicApiUsage.ImmutableTracerSettings_Ctor_Source);
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ImmutableTracerSettingsInternal"/> class from
        /// a TracerSettings instance.
        /// </summary>
        /// <param name="settings">The tracer settings to use to populate the immutable tracer settings</param>
        [PublicApi]
        public ImmutableTracerSettingsInternal(TracerSettingsInternal settings)
            : this(settings, true)
        {
            TelemetryFactory.Metrics.Record(PublicApiUsage.ImmutableTracerSettings_Ctor_Settings);
        }

        internal ImmutableTracerSettingsInternal(TracerSettingsInternal settings, bool unusedParamNotToUsePublicApi)
        {
            ...
            ExporterInternal = new ImmutableExporterSettingsInternal(settings.ExporterInternal, true);
...
#pragma warning restore 618
            ...
            IntegrationsInternal = new ImmutableIntegrationSettingsCollectionInternal(settings.IntegrationsInternal, settings.DisabledIntegrationNamesInternal);
        ...
        internal ImmutableExporterSettingsInternal ExporterInternal { get; }
...
#pragma warning restore CS1574
        ...
        internal ImmutableIntegrationSettingsCollectionInternal IntegrationsInternal { get; }
        ...
        /// <summary>
        /// Gets the telemetry that was collected from <see cref="TracerSettingsInternal"/> when this instance was built
        /// </summary>
        internal IConfigurationTelemetry Telemetry { get; }

        /// <summary>
        /// Gets the error logs that were collected from <see cref="TracerSettingsInternal"/> when this instance was built
        /// </summary>
        ...
        /// <summary>
        /// Create a <see cref="ImmutableTracerSettingsInternal"/> populated from the default sources
        /// returned by <see cref="GlobalConfigurationSource.Instance"/>.
        /// </summary>
        /// <returns>A <see cref="ImmutableTracerSettingsInternal"/> populated from the default sources.</returns>
        [PublicApi]
        public static ImmutableTracerSettingsInternal FromDefaultSources()
        {
            TelemetryFactory.Metrics.Record(PublicApiUsage.ImmutableTracerSettings_FromDefaultSources);
            return new ImmutableTracerSettingsInternal(TracerSettingsInternal.FromDefaultSourcesInternal(), true);
        }
        ...
        public virtual bool Equals(ImmutableTracerSettingsInternal? other) => base.Equals(other);
