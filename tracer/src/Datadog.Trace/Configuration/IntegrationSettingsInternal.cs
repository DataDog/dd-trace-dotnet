// <copyright file="IntegrationSettingsInternal.cs" company="Datadog">
...
namespace Datadog.Trace.Configuration
{
    ...
    /// </summary>
    public partial class IntegrationSettingsInternal
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegrationSettingsInternal"/> class.
        /// </summary>
        /// <param name="integrationName">The integration name.</param>
        /// <param name="source">The <see cref="IConfigurationSource"/> to use when retrieving configuration values.</param>
        [PublicApi]
        public IntegrationSettingsInternal(string integrationName, IConfigurationSource? source)
            : this(integrationName, source, false)
        {
            TelemetryFactory.Metrics.Record(PublicApiUsage.IntegrationSettings_Ctor);
        }

        internal IntegrationSettingsInternal(string integrationName, IConfigurationSource? source, bool unusedParamNotToUsePublicApi)
        {
