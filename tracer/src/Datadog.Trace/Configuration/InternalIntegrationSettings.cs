// <copyright file="InternalIntegrationSettings.cs" company="Datadog">
...
namespace Datadog.Trace.Internal.Configuration
{
    ...
    /// </summary>
    public partial class InternalIntegrationSettings
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalIntegrationSettings"/> class.
        /// </summary>
        /// <param name="integrationName">The integration name.</param>
        /// <param name="source">The <see cref="IConfigurationSource"/> to use when retrieving configuration values.</param>
        [PublicApi]
        public InternalIntegrationSettings(string integrationName, IConfigurationSource? source)
            : this(integrationName, source, false)
        {
            TelemetryFactory.Metrics.Record(PublicApiUsage.IntegrationSettings_Ctor);
        }

        internal InternalIntegrationSettings(string integrationName, IConfigurationSource? source, bool unusedParamNotToUsePublicApi)
        {
