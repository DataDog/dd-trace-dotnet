// <copyright file="ImmutableTracerSettings.ITracerSettings.cs" company="Datadog">
...
/// </summary>
public partial record ImmutableTracerSettings // : ITracerSettings
{
    ...
    internal bool TryGetObject(string key, out object? value)
        => key switch
        {
            ...
            ObjectKeys.GlobalTagsKey => Copy(GlobalTagsInternal, out value),
            ObjectKeys.GrpcTags => Copy(GrpcTagsInternal, out value),
            ObjectKeys.HeaderTags => Copy(HeaderTagsInternal, out value),
...
#pragma warning restore CS0618
            ...
            BoolKeys.LogsInjectionEnabledKey => Found(LogsInjectionEnabledInternal, out value),
