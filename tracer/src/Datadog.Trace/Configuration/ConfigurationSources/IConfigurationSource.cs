...
public interface IConfigurationSource
{
    ...
    /// a successfully extracted value to determine if it should be accepted</param>
    /// <returns>The value of the setting, or <c>null</c> if not found.</returns>
    ConfigurationResult<int> GetInt32(string key, Func<int, bool>? validator);
    ...
    /// a successfully extracted value to determine if it should be accepted</param>
    /// <returns>The value of the setting, or <c>null</c> if not found.</returns>
    ConfigurationResult<double> GetDouble(string key, Func<double, bool>? validator);
    ...
    /// a successfully extracted value to determine if it should be accepted</param>
    /// <returns>The value of the setting, or <c>null</c> if not found.</returns>
    ConfigurationResult<bool> GetBool(string key, Func<bool, bool>? validator);
    ...
    /// a successfully extracted value to determine if it should be accepted</param>
    /// <returns>The value of the setting, or <c>null</c> if not found.</returns>
    ConfigurationResult<IDictionary<string, string>> GetDictionary(string key, Func<IDictionary<string, string>, bool>? validator);
    ...
    /// <returns>The value of the setting, or <c>null</c> if not found.</returns>
    ConfigurationResult<IDictionary<string, string>> GetDictionary(string key, Func<IDictionary<string, string>, bool>? validator, bool allowOptionalMappings, char separator);
    ...
    /// <returns>The value of the setting, or <c>null</c> if not found.</returns>
    ConfigurationResult<IDictionary<string, string>> GetDictionary(string key, Func<IDictionary<string, string>, bool>? validator, Func<string, IDictionary<string, string>> parser);
