    ...
    internal class DynamicConfigurationManager : IDynamicConfigurationManager
    {
        ...
        private static void OnConfigurationChanged(IConfigurationSource dynamicConfig)
        {
            ...
            var mutableSettings = manualSource.UseDefaultSources
                                      ...
                                      : MutableSettings.InitialMutableSettings.CreateWithoutDefaultSources(tracerSettings);
        ...
        {
            var newMutableSettings = new MutableSettings.UpdatedMutableSettings(
                dynamicConfig,
                manualConfig,
                initialSettings,
                tracerSettings,
            ...
            // TODO: must make MutableSettings equatable
