// <copyright file="GlobalSettingsInternal.cs" company="Datadog">
...
namespace Datadog.Trace.Configuration
{
    ...
    /// </summary>
    public class GlobalSettingsInternal
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobalSettingsInternal"/> class
        ...
        internal GlobalSettingsInternal(
        ...
        /// </summary>
        internal static GlobalSettingsInternal Instance { get; private set; } = CreateFromDefaultSources();
        ...
        /// <summary>
        /// Create a <see cref="GlobalSettingsInternal"/> populated from the default sources
        ...
        [PublicApi]
        public static GlobalSettingsInternal FromDefaultSources()
        {
            TelemetryFactory.Metrics.Record(PublicApiUsage.GlobalSettings_FromDefaultSources);
            return CreateFromDefaultSources();
        }

        private static GlobalSettingsInternal CreateFromDefaultSources()
