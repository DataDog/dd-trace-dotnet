// <copyright file="TracerSettingsInternal.cs" company="Datadog">
...
namespace Datadog.Trace.Configuration
{
    ...
    /// </summary>
    [GenerateSnapshot]
    public partial class TracerSettingsInternal
    {
        private static readonly IDatadogLogger Log = DatadogLogging.GetLoggerFor<TracerSettingsInternal>();

        private readonly IConfigurationTelemetry _telemetry;
        private readonly TracerSettingsInternalSnapshot _initialSettings;

        /// <summary>
        /// Initializes a new instance of the <see cref="TracerSettingsInternal"/> class with default values.
        /// </summary>
        [PublicApi]
        public TracerSettingsInternal()
        ...
        /// </summary>
        /// <param name="useDefaultSources">If <c>true</c>, creates a <see cref="TracerSettingsInternal"/> populated from
        /// the default sources such as environment variables etc. If <c>false</c>, uses the default values.</param>
        [PublicApi]
        public TracerSettingsInternal(bool useDefaultSources)
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TracerSettingsInternal"/> class
        ...
        /// </remarks>
        [PublicApi]
        public TracerSettingsInternal(IConfigurationSource? source)
        ...
        internal TracerSettingsInternal(IConfigurationSource? source, IConfigurationTelemetry telemetry, OverrideErrorLog errorLog)
        {
            ...
            IntegrationsInternal = new IntegrationSettingsCollectionInternal(source, unusedParamNotToUsePublicApi: false);

            ExporterInternal = new ExporterSettingsInternal(source, _telemetry);
...
#pragma warning restore 618
            ...
            _initialSettings = new TracerSettingsInternalSnapshot(this);
        }
...
#pragma warning disable SA1624 // Documentation summary should begin with "Gets" - the documentation is primarily for public property
        ...
        internal ExporterSettingsInternal ExporterInternal { get; private set; }
...
#pragma warning restore CS0618
        ...
        internal IntegrationSettingsCollectionInternal IntegrationsInternal { get; }
...
#pragma warning disable SA1624 // Documentation summary should begin with "Gets" - the documentation is primarily for public property
        ...
        public bool DiagnosticSourceEnabled
        {
            get
            {
                ...
                return GlobalSettingsInternal.Instance.DiagnosticSourceEnabled;
            }
...
#pragma warning restore SA1624
        ...
        /// <summary>
        /// Create a <see cref="TracerSettingsInternal"/> populated from the default sources
        /// returned by <see cref="GlobalConfigurationSource.Instance"/>.
        /// </summary>
        /// <returns>A <see cref="TracerSettingsInternal"/> populated from the default sources.</returns>
        [PublicApi]
        public static TracerSettingsInternal FromDefaultSources()
        {
        ...
        internal static TracerSettingsInternal FromDefaultSourcesInternal()
        ...
        /// <summary>
        /// Create an instance of <see cref="ImmutableTracerSettingsInternal"/> that can be used to build a <see cref="TracerInternal"/>
        /// </summary>
        /// <returns>The <see cref="ImmutableTracerSettingsInternal"/> that can be passed to a <see cref="TracerInternal"/> instance</returns>
        [PublicApi]
        public ImmutableTracerSettingsInternal Build()
        {
            TelemetryFactory.Metrics.Record(PublicApiUsage.TracerSettings_Build);
            return new ImmutableTracerSettingsInternal(this, true);
        }
        ...
        internal static TracerSettingsInternal Create(Dictionary<string, object?> settings)
