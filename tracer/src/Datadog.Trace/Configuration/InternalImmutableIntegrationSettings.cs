// <copyright file="InternalImmutableIntegrationSettings.cs" company="Datadog">
...
namespace Datadog.Trace.Internal.Configuration
{
    ...
    /// </summary>
    public partial class InternalImmutableIntegrationSettings
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalImmutableIntegrationSettings"/> class from an instance of
        /// <see cref="InternalIntegrationSettings"/>.
        /// </summary>
        /// <param name="settings">The values to use.</param>
        /// <param name="isExplicitlyDisabled">If true forces the setting Enabled = false. Otherwise, uses <see cref="InternalIntegrationSettings.EnabledInternal"/></param>
        internal InternalImmutableIntegrationSettings(InternalIntegrationSettings settings, bool isExplicitlyDisabled)
        {
        ...
        internal InternalImmutableIntegrationSettings(string name)
        {
