// <copyright file="PooledConcurrentDictionary.cs" company="Datadog">
// Unless explicitly stated otherwise all files in this repository are licensed under the Apache 2 License.
// This product includes software developed at Datadog (https://www.datadoghq.com/). Copyright 2017 Datadog, Inc.
// </copyright>

// Based on https://github.com/dotnet/roslyn-analyzers/blob/4512de66bb6e21c548ab0d5a83242b70969ba576/src/Utilities/Compiler/PooledObjects/PooledConcurrentDictionary.cs
        ...
        where K : notnull
    {
        ...
        public static ObjectPool<PooledConcurrentDictionary<K, V>> CreatePool(IEqualityComparer<K>? keyComparer = null)
        {
            ...
            pool = new ObjectPool<PooledConcurrentDictionary<K, V>>(
                () =>
                    keyComparer != null ? new PooledConcurrentDictionary<K, V>(pool, keyComparer) : new PooledConcurrentDictionary<K, V>(pool),
                128);
            return pool;
        }
        ...
        {
            var pool = keyComparer == null ? s_poolInstance : s_poolInstancesByComparer.GetOrAdd(keyComparer, CreatePool);
