// <copyright file="PooledHashSet.cs" company="Datadog">
// Unless explicitly stated otherwise all files in this repository are licensed under the Apache 2 License.
// This product includes software developed at Datadog (https://www.datadoghq.com/). Copyright 2017 Datadog, Inc.
// </copyright>

// based on https://github.com/dotnet/roslyn-analyzers/blob/4512de66bb6e21c548ab0d5a83242b70969ba576/src/Utilities/Compiler/PooledObjects/PooledHashSet.cs
...
namespace Analyzer.Utilities.PooledObjects
{
    ...
    internal sealed class PooledHashSet<T> : HashSet<T>, IDisposable
    {
        ...
        {
            var pool = comparer == null ? s_poolInstance : s_poolInstancesByComparer.GetOrAdd(comparer, CreatePool);
