    ...
    public class DatadogLogger : INodeLogger
    {
        ...
        private void EventSource_BuildStarted(object sender, BuildStartedEventArgs e)
        {
            try
            {
                ...
                _buildSpan = _tracer.StartSpanWithTags(BuildTags.BuildOperationName);
        ...
        private void EventSource_ProjectStarted(object sender, ProjectStartedEventArgs e)
        {
            try
            {
                ...
                Span projectSpan = _tracer.StartSpanWithTags(BuildTags.BuildOperationName, parent: parentSpan.Context, serviceName: projectName);
