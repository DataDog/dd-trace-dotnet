...
namespace Datadog.Trace.Vendors.dnlib.DotNet {
	...
	/// </summary>
	internal sealed class UTF8StringEqualityComparer : IEqualityComparer<UTF8String> {
		/// <summary>
	...
	internal sealed class UTF8String : IEquatable<UTF8String>, IComparable<UTF8String> {
		/// <summary>
