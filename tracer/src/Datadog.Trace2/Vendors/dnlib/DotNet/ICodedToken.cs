...
namespace Datadog.Trace.Vendors.dnlib.DotNet {
	...
	/// </summary>
	internal interface IMDTokenProvider {
		/// <summary>
	...
	/// </summary>
	internal interface IMDTokenProviderMD : IMDTokenProvider {
		/// <summary>
	...
	/// </summary>
	internal interface IAssembly : IFullName {
		/// <summary>
	...
	/// </summary>
	internal interface IManagedEntryPoint : ICodedToken {
	}

	/// <summary>
	/// Interface to access a module def/ref
	/// </summary>
	internal interface IModule : IScope, IFullName {
	}
	...
	/// </summary>
	internal interface IOwnerModule {
		/// <summary>
	...
	/// </summary>
	internal interface IIsTypeOrMethod {
		/// <summary>
	...
	/// </summary>
	internal interface IMemberRef : ICodedToken, IFullName, IOwnerModule, IIsTypeOrMethod {
		/// <summary>
	...
	/// </summary>
	internal interface IMemberDef : IDnlibDef, IMemberRef {
		/// <summary>
		/// Gets the declaring type
		/// </summary>
	...
	/// </summary>
	internal interface IDnlibDef : ICodedToken, IFullName, IHasCustomAttribute {
	}

	/// <summary>
	/// Implemented by types and methods
	/// </summary>
	internal interface IGenericParameterProvider : ICodedToken, IIsTypeOrMethod {
		/// <summary>
	...
	/// </summary>
	internal interface IField : ICodedToken, ITokenOperand, IFullName, IMemberRef {
		/// <summary>
	...
	/// </summary>
	internal interface IMethod : ICodedToken, ITokenOperand, IFullName, IGenericParameterProvider, IMemberRef {
		/// <summary>
		/// Method signature
		/// </summary>
	...
	/// </summary>
	internal interface ITokenOperand : ICodedToken {
	}

	/// <summary>
	/// The table row can be referenced by a coded token
	/// </summary>
	internal interface ICodedToken : IMDTokenProvider {
	}

	/// <summary>
	/// TypeDefOrRef coded token interface
	/// </summary>
	internal interface ITypeDefOrRef : ICodedToken, IHasCustomAttribute, IMemberRefParent, IType, ITokenOperand, IMemberRef {
		/// <summary>
		/// The coded token tag
		/// </summary>
	...
	/// </summary>
	internal interface IHasConstant : ICodedToken, IHasCustomAttribute, IFullName {
		/// <summary>
		/// The coded token tag
		/// </summary>
	...
	/// </summary>
	internal interface IHasCustomAttribute : ICodedToken {
		/// <summary>
		/// The coded token tag
		/// </summary>
	...
	/// </summary>
	internal interface IHasFieldMarshal : ICodedToken, IHasCustomAttribute, IHasConstant, IFullName {
		/// <summary>
		/// The coded token tag
		/// </summary>
	...
	/// </summary>
	internal interface IHasDeclSecurity : ICodedToken, IHasCustomAttribute, IFullName {
		/// <summary>
		/// The coded token tag
		/// </summary>
	...
	/// </summary>
	internal interface IMemberRefParent : ICodedToken, IHasCustomAttribute, IFullName {
		/// <summary>
		/// The coded token tag
		/// </summary>
	...
	/// </summary>
	internal interface IHasSemantic : ICodedToken, IHasCustomAttribute, IFullName, IMemberRef {
		/// <summary>
		/// The coded token tag
		/// </summary>
	...
	/// </summary>
	internal interface IMethodDefOrRef : ICodedToken, IHasCustomAttribute, ICustomAttributeType, IMethod {
		/// <summary>
		/// The coded token tag
		/// </summary>
	...
	/// </summary>
	internal interface IMemberForwarded : ICodedToken, IHasCustomAttribute, IFullName, IMemberRef {
		/// <summary>
		/// The coded token tag
		/// </summary>
	...
	/// </summary>
	internal interface IImplementation : ICodedToken, IHasCustomAttribute, IFullName {
		/// <summary>
		/// The coded token tag
		/// </summary>
	...
	/// </summary>
	internal interface ICustomAttributeType : ICodedToken, IHasCustomAttribute, IMethod {
		/// <summary>
		/// The coded token tag
		/// </summary>
	...
	/// </summary>
	internal interface IResolutionScope : ICodedToken, IHasCustomAttribute, IFullName {
		/// <summary>
		/// The coded token tag
		/// </summary>
	...
	/// </summary>
	internal interface ITypeOrMethodDef : ICodedToken, IHasCustomAttribute, IHasDeclSecurity, IMemberRefParent, IFullName, IMemberRef, IGenericParameterProvider {
		/// <summary>
		/// The coded token tag
		/// </summary>
	...
	/// </summary>
	internal interface IHasCustomDebugInformation {
		/// <summary>
