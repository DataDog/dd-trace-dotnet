...
namespace Datadog.Trace.Vendors.dnlib.DotNet {
	...
	internal abstract class InterfaceImpl : IHasCustomAttribute, IContainsGenericParameter, IHasCustomDebugInformation {
		/// <summary>
	...
	/// </summary>
	internal class InterfaceImplUser : InterfaceImpl {
		/// <summary>
		/// Default constructor
		/// </summary>
