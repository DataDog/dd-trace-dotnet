...
internal unsafe class IAppHostElementSchemaCollection : Datadog.Trace.Tools.dd_dotnet.Checks.Windows.IIS.IAppHostElementSchemaCollection
{
    public static IAppHostElementSchemaCollection Wrap(IntPtr obj) => new IAppHostElementSchemaCollection(obj);

    private readonly IntPtr _implementation;

    public IAppHostElementSchemaCollection(IntPtr implementation)
    {
    ...
    public Datadog.Trace.Tools.dd_dotnet.Checks.Windows.IIS.IAppHostElementSchema GetElementSchema(Datadog.Trace.Tools.dd_dotnet.Checks.Windows.IIS.Variant a0)
    {
