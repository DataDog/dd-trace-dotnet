...
internal unsafe class IAppHostPropertySchemaCollection : Datadog.Trace.Tools.dd_dotnet.Checks.Windows.IIS.IAppHostPropertySchemaCollection
{
    public static IAppHostPropertySchemaCollection Wrap(IntPtr obj) => new IAppHostPropertySchemaCollection(obj);

    private readonly IntPtr _implementation;

    public IAppHostPropertySchemaCollection(IntPtr implementation)
    {
    ...
    public Datadog.Trace.Tools.dd_dotnet.Checks.Windows.IIS.IAppHostPropertySchema GetPropertySchema(Datadog.Trace.Tools.dd_dotnet.Checks.Windows.IIS.Variant a0)
    {
