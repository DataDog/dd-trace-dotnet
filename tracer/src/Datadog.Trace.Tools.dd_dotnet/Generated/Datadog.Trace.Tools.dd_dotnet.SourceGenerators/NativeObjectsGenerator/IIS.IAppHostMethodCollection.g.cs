...
internal unsafe class IAppHostMethodCollection : Datadog.Trace.Tools.dd_dotnet.Checks.Windows.IIS.IAppHostMethodCollection
{
    public static IAppHostMethodCollection Wrap(IntPtr obj) => new IAppHostMethodCollection(obj);

    private readonly IntPtr _implementation;

    public IAppHostMethodCollection(IntPtr implementation)
    {
    ...
    public Datadog.Trace.Tools.dd_dotnet.Checks.Windows.IIS.IAppHostMethod GetMethod(Datadog.Trace.Tools.dd_dotnet.Checks.Windows.IIS.Variant a0)
    {
        ...
        var returnvalue = NativeObjects.IAppHostMethod.Wrap(returnptr);
        if (result != 0)
        {
            throw new System.ComponentModel.Win32Exception(result);
        }
