...
internal unsafe class IAppHostChildElementCollection : Datadog.Trace.Tools.dd_dotnet.Checks.Windows.IIS.IAppHostChildElementCollection
{
    public static IAppHostChildElementCollection Wrap(IntPtr obj) => new IAppHostChildElementCollection(obj);

    private readonly IntPtr _implementation;

    public IAppHostChildElementCollection(IntPtr implementation)
    {
