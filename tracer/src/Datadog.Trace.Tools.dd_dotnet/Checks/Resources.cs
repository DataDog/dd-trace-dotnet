...
namespace Datadog.Trace.Tools.dd_dotnet.Checks
{
    internal static class Resources
    {
        ...
        public const string AzureAppServiceHomeNotSet = "Unable to determine the Azure App Service HOME directory (the HOME environment variable is not set). Assuming C:\\home, but bundle detection may fail if the site is deployed to a different drive.";
