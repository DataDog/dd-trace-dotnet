...
namespace Datadog.Trace.Tools.dd_dotnet.Checks
{
    internal static class Resources
    {
        ...
        public const string AspNetCoreOutOfProcessNotFound = "ASP.NET Core has been detected but no .NET runtime. It could mean that the application is using out-of-process hosting and hasn't received a request to complete the initialization. Please make sure that the site has received at least one web request since the last time it has been restarted.";
