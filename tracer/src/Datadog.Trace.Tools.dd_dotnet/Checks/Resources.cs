...
namespace Datadog.Trace.Tools.dd_dotnet.Checks
{
    internal static class Resources
    {
        ...
        public static string EnableDiagnosticsSet(string key) => $"The environment variable {key} is set to 0, which disables profiling(tracing, profiling nor security data will be collected until is set to 1).";
