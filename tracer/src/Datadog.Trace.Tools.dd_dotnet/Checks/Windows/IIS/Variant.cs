...
// Original code from https://github.com/dotnet/runtime/blob/90042669ef7e2d829aa605cb3751760b6161d12a/src/libraries/Common/src/System/Runtime/InteropServices/Variant.cs
...
internal struct Variant
{
    ...
    {
        _typeUnion._vt = (ushort)VarEnum.VT_I4;
        _typeUnion._unionTypes._i4 = value;
    }

    public Variant(IntPtr ptr)
    {
        _typeUnion._vt = (ushort)VarEnum.VT_UNKNOWN;
        _typeUnion._unionTypes._unknown = ptr;
    }

    public static implicit operator Variant(int value) => new(value);

    public static implicit operator Variant(IntPtr value) => new(value);
