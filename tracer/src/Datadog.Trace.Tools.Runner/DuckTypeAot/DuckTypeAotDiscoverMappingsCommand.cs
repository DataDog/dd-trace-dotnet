...
namespace Datadog.Trace.Tools.Runner.DuckTypeAot
{
    ...
    internal class DuckTypeAotDiscoverMappingsCommand : CommandWithExamples
    {
            ...
            : base("discover-mappings", "Discover mappings from type-level attributes and emit a canonical map file")
        {
            ...
            AddExample("dd-trace ducktype-aot discover-mappings --proxy-assembly Datadog.Trace.DuckTyping.Tests.dll --target-assembly Datadog.Trace.DuckTyping.Tests.dll --output ducktype-aot-bible-mappings.json");
