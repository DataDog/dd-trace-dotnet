...
namespace Datadog.Trace.Tools.Runner.DuckTypeAot
{
    internal class DuckTypeAotVerifyCompatCommand : CommandWithExamples
    {
        ...
        private readonly Option<string?> _knownLimitationsOption = new("--known-limitations", "Optional approved known limitations file. Incompatible mappings must match this allowlist.");
        ...
        private void Execute(InvocationContext context)
        {
            ...
            var options = new DuckTypeAotVerifyCompatOptions(compatReportPath, compatMatrixPath, mappingCatalogPath, manifestPath, scenarioInventoryPath, knownLimitationsPath, strictAssemblyFingerprints);
