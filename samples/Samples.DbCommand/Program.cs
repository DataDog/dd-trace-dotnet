...
namespace Samples.DbCommand
{
    internal class Program
    {
        ...
        private static void ExecuteQueries(DbConnection connection)
        {
            connection.Open();
            ...
            using (var command = connection.CreateCommand())
            {
                // adding parameters is provider-specific
            ...
            using (var command = connection.CreateCommand())
            {
                // adding parameters is provider-specific
                var sqlCommand = (SqlCommand)command;
                sqlCommand.Parameters.AddWithValue("Name", "Name2");
                sqlCommand.Parameters.AddWithValue("Id", 1);
        ...
        private static async Task ExecuteQueriesAsync(DbConnection connection)
        {
